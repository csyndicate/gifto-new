...
if (file_exists('/chroot/home/devtestn/devtestnew.gifto.co/html/aios-bootstrap.php')) {
	include_once('/chroot/home/devtestn/devtestnew.gifto.co/html/aios-bootstrap.php');
}
...
define( 'DB_NAME', 'devtestn_wp' );
define('WP_MAX_MEMORY_LIMIT', '512M');
//define('WP_MEMORY_LIMIT', '256M');
/** Database username */
define( 'DB_USER', 'devtestn_wp' );
