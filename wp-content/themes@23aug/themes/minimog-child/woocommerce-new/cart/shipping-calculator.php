...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<a href="#" class="shipping-calculator-button">%s</a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'minimog' ) ) ); ?>
	...
	<div class="shipping-calculator-form" style="display:none;">
		...
		<p class="form-row-submit form-submit-wrap">
			<button type="submit" name="calc_shipping" value="1"
			        class="button"><?php esc_html_e( 'Update', 'minimog' ); ?></button>
		</p>
