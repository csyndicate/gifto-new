...
<style type="text/css">
	...
	<body style="margin:0;background-color: #ffffff;box-sizing: border-box;padding:0;">
					...
					<td>
										...
										<table>
											...
											<tr class="order_id">
												...
												<td class="document_no">
													<p id="document_id_mobile" style="text-transform: capitalize;font-weight: 600;margin: 10px 0 0 0;color: #a1a1a1;font-size: 12px;padding: 0 0 0 15px">document no.</p>
						...
						<table id="mobile_recharge_details" style="border-top: 2px solid #8585850f;border-bottom: 2px solid #8585850f;padding: 5px 0;margin-top: 18px;margin-bottom: 18px; width:100%;">
							<tr>
								...
								<td style="font-size: 17px;margin: 0px 0 0 0;font-family:'Jost';font-weight: 700; padding:0 20px 0 0;"><?php echo $mobile_recharges_data['total_amountr'] ?></td>
							</tr>
						</table>
						...
						<table id="mobile_recharge_details" style="width: 100%;">
							<tbody>
								<tr>
									<td><p class="get-touch" style="text-transform: capitalize;font-family:'Jost';font-weight: 600;margin:0;color: #000000;font-size: 15px;text-align: center;">Get in touch with <a href="https://gifto.co/">Gifto.co</a></p></td> 
								</tr>
								<tr> <td style="padding:24px 0px;"> <p style="border-radius: 6px;border: 0;color: #8a8a8a;font-size: 12px;line-height: 150%;text-align: center;margin: 0 0 16px;">*Terms & Conditions apply . Please check <a href="http://www.gifto.co" style="color: #15c;">http://www.gifto.co</a> for the respective gift card/brand voucher for usage terms and policies. <br>Gifto: Gifting made better</p> </td> </tr>
								<!--
								<tr>
		...
		<!-- <table style="margin:0px auto;width:600px;max-width: 100%;font-family: 'Jost';"> <tbody>  </tbody> </table> -->
	</body>
