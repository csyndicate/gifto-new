...
$add_to_cart_button_class_custom = 'single_add_to_cart_button custom_click button alt';
	...
	<form class="cart"
		...
		<div class="entry-product-quantity-wrapper">
			...
			<button type="button" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>"
			        class="<?php echo esc_attr( $add_to_cart_button_class_custom ); ?>">
				<span><?php echo esc_html( $product->single_add_to_cart_text() ); ?></span></button>
			
			<button style="display: none;" type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>"
			...
			<?php if ( '1' === Minimog::setting( 'single_product_buy_now_enable' ) ) : ?>
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>"
					...
					<span><?php esc_html_e( 'Buy Now', 'minimog' ); ?></span></button>
			<?php endif; ?>
		</div>
