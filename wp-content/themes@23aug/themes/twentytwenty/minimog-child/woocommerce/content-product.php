...
<div <?php wc_product_class( $item_class, $product ); ?>>
	<div class="product-wrapper">
		...
		<div class="product-thumbnail">
			...
			<div class="thumbnail">
				...
				<div class="product-main-image nmnm">

					<?php
						if( has_post_thumbnail( $product_id ) ){
							echo Minimog_Woo::instance()->get_product_image( $product, $settings['thumbnail_size'] );
						}else{ ?>
							<img src="<?php the_field( 'rwd_product_api_image', $product_id ) ?>?height=300&width=400&compress=none" alt="" class="ll-image ll-init ll-loadstarted ll-loaded no-image">
						<?php }
	...
	<?php if ( in_array( $loop_style, [ '02', '03', '06', '07' ] ) ) : ?>
