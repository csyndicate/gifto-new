		...
		if ($err) {
		  echo "cURL Error #:" . $err;
			...
			foreach ($rwd_prds as $rwdkey => $rwdvalue) {
				...
				// if($rwd_prds[$rwdkey]['productId']!='47058')
				// 	continue;
			...
			$root_path = ABSPATH;
			$inserted_rwd_products_logs = fopen($root_path."add_rwd_prods_logs.txt", "a+");
			...
			echo "Product Insertion log is added to a file in root with name 'add_rwd_prods_logs.txt'";
