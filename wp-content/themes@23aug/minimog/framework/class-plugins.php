		...
		public function register_required_plugins( $plugins ) {
			...
			$new_plugins = array(
				...
				array(
					...
					'source'      => 'https://www.dropbox.com/s/hh8tmyh6tu03f1r/woo-smart-wishlist-premium-460.zip?dl=1',
					'version'     => '4.6.0',
				),
				array(
		...
		public function register_compatible_plugins( $plugins ) {
			...
			$new_plugins = [
				...
				array(
					...
					'slug'        => 'revslider',
					'logo'        => 'revslider',
					'source'      => 'https://www.dropbox.com/s/ojeue9o3d3pt1o8/slider-revolution-6.6.10.zip?dl=1',
					'version'     => '6.6.10',
					'compatible'  => true,
				),
				array(
