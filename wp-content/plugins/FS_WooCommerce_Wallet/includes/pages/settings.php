...
<div class="wrap fsww">
    ...
    <a href="<?php echo admin_url('admin.php?page=fsww-settings&tab=' . 'fees') ?>" class="nav-tab <?php echo ($current_tab=='fees')?'nav-tab-active':'' ?>"><?php echo  __('Fees', 'fsww'); ?></a>
    ...
    <div class="postbox">
        <div class="inside">
            ...
            } elseif(($current_tab == 'fees')) {
                
                require_once(dirname(FSWW_FILE) . '/includes/settings_pages/fees.php');
