...
class WC_Gateway_FSWW extends WC_Payment_Gateway
{
    ...
    /**
     * Checkout page wallet description
     *
     * @return string
     */
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = array(
            ...
            'description' => array(
                ...
                'type' => 'textarea',
                'description' => __('Payment method description that the customer will see on your website.',
                    'woocommerce'),
    ...
    public function process_payment($order_id)
    {
        ...
        foreach ($woocommerce->cart->get_cart() as $cart_item_key => $cart_item) {
            ...
            if (has_term('fsww-wallet-credit', 'product_cat', $cart_item['product_id'])) {
                ...
                wc_add_notice(__('<strong>Payment error:</strong> You can not purchase wallet credit money with wallet credit. Please choose another payment method.',
                    'fsww'), 'error');
        ...
        if (!$this->check_balance()) {
            ...
            wc_add_notice(__('<strong>Payment error:</strong> Insufficient funds. Please purchase more credits or use a different payment method.',
                'fsww'), 'error');
        ...
        $order->update_status(get_option('fsww_order_status', 'completed'),
            __('Order status set to ' . get_option('fsww_order_status', 'completed') . ' by WooCommerce Wallet',
                'fsww'));
    ...
    /**
     * Check if the wallet can be used to checkout
     *
     * @return bool
     */
    ...
    /**
     * Check if the users' wallet is locked
     *
     * @return bool
     */
    ...
    public function get_icon()
    {
        ...
        $icon = '<span class="fsww-wallet-icon fsww-icon-wallet fsww-right fsww-wallet-checkout-icon"></span>';
