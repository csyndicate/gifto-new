	...
	class PluginUpdateChecker_2_1 {
		...
		protected function installHooks() {
			...
			if ( $this->checkPeriod > 0 ) {
				...
				add_action( 'load-plugins.php', [ $this, 'maybeCheckForUpdates' ] );
				add_action( 'load-update.php', [ $this, 'maybeCheckForUpdates' ] );
				//This hook fires after a bulk update is complete.
				add_action( 'upgrader_process_complete', [ $this, 'maybeCheckForUpdates' ], 11, 0 );
		...
		public function maybeCheckForUpdates() {
			...
			if ( in_array( $currentFilter, [ 'load-update-core.php', 'upgrader_process_complete' ] ) ) {
				...
				$timeout = 60;
			} else if ( in_array( $currentFilter, [ 'load-plugins.php', 'load-update.php' ] ) ) {
		...
		protected function isMuPlugin() {
			...
			if ( $cachedResult === null ) {
				...
				$pluginPath  = strval( realpath( $this->pluginAbsolutePath ) );
