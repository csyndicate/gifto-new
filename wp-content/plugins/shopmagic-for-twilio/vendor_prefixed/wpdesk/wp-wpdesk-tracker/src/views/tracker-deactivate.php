...
<h2><?php 
\printf(\esc_html__('You are deactivating %s plugin.', 'shopmagic-for-twilio'), \esc_html($plugin_name));
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\esc_html_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'shopmagic-for-twilio');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\esc_html_e('The plugin suddenly stopped working', 'shopmagic-for-twilio');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\esc_html_e('The plugin broke my site', 'shopmagic-for-twilio');
?></span>
                    </label>
                </li>
				<li class="reason has-input">
					<label>
						...
						<span><?php 
\esc_html_e('I found a better plugin', 'shopmagic-for-twilio');
?></span>
					</label>
					<div id="found_better_plugin" class="reason-input">
						<input type="text" name="better_plugin_name" placeholder="<?php 
\esc_html_e('What\'s the plugin\'s name?', 'shopmagic-for-twilio');
?>">
					</div>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('I only needed the plugin for a short period', 'shopmagic-for-twilio');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('I no longer need the plugin', 'shopmagic-for-twilio');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'shopmagic-for-twilio');
?></span>
					</label>
				</li>
				<li class="reason has-input">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('Other', 'shopmagic-for-twilio');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\esc_attr_e('Kindly tell us the reason so we can improve', 'shopmagic-for-twilio');
?>">
					</div>
				</li>
			</ul>
...
\esc_html_e('Cancel', 'shopmagic-for-twilio');
?></a>
        <a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\esc_html_e('Skip &amp; Deactivate', 'shopmagic-for-twilio');
?></a>
	</div>
</div>
...
\esc_html_e('Submit &amp; Deactivate', 'shopmagic-for-twilio');
?>' );
	})
