...
if (!\interface_exists('ShopMagicTwilioVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('ShopMagicTwilioVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \ShopMagicTwilioVendor\WPDesk_Translatable, \ShopMagicTwilioVendor\WPDesk_Buildable, \ShopMagicTwilioVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
