 ...
 */
class ChainResolver implements \ShopMagicTwilioVendor\WPDesk\View\Resolver\Resolver
{
    /** @var Resolver[] */
    private $resolvers;
    /**
    ...
    public function resolve($name, \ShopMagicTwilioVendor\WPDesk\View\Renderer\Renderer $renderer = null)
    {
        foreach ($this->resolvers as $resolver) {
            ...
            } catch (\ShopMagicTwilioVendor\WPDesk\View\Resolver\Exception\CanNotResolve $e) {
                // not interested
            }
        }
