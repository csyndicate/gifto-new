 ...
 */
class SimplePhpRenderer implements \ShopMagicTwilioVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\ShopMagicTwilioVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
