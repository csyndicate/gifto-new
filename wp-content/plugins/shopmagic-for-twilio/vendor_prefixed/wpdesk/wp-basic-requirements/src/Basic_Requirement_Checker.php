...
if (!\interface_exists('ShopMagicTwilioVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicTwilioVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \ShopMagicTwilioVendor\WPDesk_Requirement_Checker
    {
