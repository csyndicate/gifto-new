...
if (!\class_exists('ShopMagicTwilioVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicTwilioVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \ShopMagicTwilioVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
