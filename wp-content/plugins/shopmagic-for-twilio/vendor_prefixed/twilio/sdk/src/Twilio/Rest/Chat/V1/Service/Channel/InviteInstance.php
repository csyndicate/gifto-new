...
class InviteInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InviteContext
    {
        if (!$this->context) {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InviteInstance
    {
