...
use ShopMagicTwilioVendor\Twilio\Rest\Lookups\V2;
/**
 * @property \Twilio\Rest\Lookups\V1 $v1
 * @property \Twilio\Rest\Lookups\V2 $v2
 */
class LookupsBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v1;
    protected $_v2;
    /**
     ...
     */
    protected function getV1() : \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1
    {
        if (!$this->_v1) {
            $this->_v1 = new \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1($this);
        }
        return $this->_v1;
    }
    /**
     ...
     */
    protected function getV2() : \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V2
    {
        if (!$this->_v2) {
            $this->_v2 = new \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V2($this);
        }
        return $this->_v2;
    }
    /**
