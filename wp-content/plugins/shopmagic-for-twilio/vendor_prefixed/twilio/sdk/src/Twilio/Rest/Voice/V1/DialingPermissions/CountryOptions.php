...
abstract class CountryOptions
{
     ...
     */
    public static function read(string $isoCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $continent = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $countryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $lowRiskNumbersEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $highRiskSpecialNumbersEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $highRiskTollfraudNumbersEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\DialingPermissions\ReadCountryOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\DialingPermissions\ReadCountryOptions($isoCode, $continent, $countryCode, $lowRiskNumbersEnabled, $highRiskSpecialNumbersEnabled, $highRiskTollfraudNumbersEnabled);
    }
}
class ReadCountryOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $isoCode Filter to retrieve the country permissions by specifying the [ISO country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
     * @param string $continent Filter to retrieve the country permissions by specifying the continent
     ...
     * @param bool $highRiskTollfraudNumbersEnabled Filter to retrieve the country permissions with dialing to high-risk [toll fraud](https://www.twilio.com/blog/how-to-protect-your-account-from-toll-fraud-with-voice-dialing-geo-permissions-html) numbers enabled. Can be: `true` or `false`.
     */
    public function __construct(string $isoCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $continent = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $countryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $lowRiskNumbersEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $highRiskSpecialNumbersEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $highRiskTollfraudNumbersEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
