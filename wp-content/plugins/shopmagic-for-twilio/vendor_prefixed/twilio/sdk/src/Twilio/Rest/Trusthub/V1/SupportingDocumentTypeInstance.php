...
class SupportingDocumentTypeInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext($this->version, $this->solution['sid']);
        }
        return $this->context;
    }
    /**
