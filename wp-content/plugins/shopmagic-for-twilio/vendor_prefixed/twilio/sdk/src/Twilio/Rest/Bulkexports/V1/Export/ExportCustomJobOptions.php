...
abstract class ExportCustomJobOptions
{
     ...
     */
    public static function create(string $webhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $webhookMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $email = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\CreateExportCustomJobOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\CreateExportCustomJobOptions($webhookUrl, $webhookMethod, $email);
    }
}
class CreateExportCustomJobOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $email The optional email to send the completion notification to. You can set both webhook, and email, or one or the other. If you set neither, the job will run but you will have to query to determine your job's status.
     */
    public function __construct(string $webhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $webhookMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $email = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
