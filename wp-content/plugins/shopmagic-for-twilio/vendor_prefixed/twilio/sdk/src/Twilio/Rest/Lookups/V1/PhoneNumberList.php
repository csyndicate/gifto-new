...
class PhoneNumberList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function getContext(string $phoneNumber) : \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\PhoneNumberContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\PhoneNumberContext($this->version, $phoneNumber);
    }
    /**
