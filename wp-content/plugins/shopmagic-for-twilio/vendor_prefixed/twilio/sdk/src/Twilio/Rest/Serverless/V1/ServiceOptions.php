...
abstract class ServiceOptions
{
     ...
     */
    public static function create(bool $includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $uiEditable = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\CreateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\CreateServiceOptions($includeCredentials, $uiEditable);
    }
    /**
     ...
     */
    public static function update(bool $includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $uiEditable = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\UpdateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\UpdateServiceOptions($includeCredentials, $friendlyName, $uiEditable);
    }
}
class CreateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $uiEditable Whether the Service's properties and subresources can be edited via the UI. The default value is `false`.
     */
    public function __construct(bool $includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $uiEditable = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class UpdateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $uiEditable Whether the Service resource's properties and subresources can be edited via the UI. The default value is `false`.
     */
    public function __construct(bool $includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $uiEditable = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
        $this->options['includeCredentials'] = $includeCredentials;
