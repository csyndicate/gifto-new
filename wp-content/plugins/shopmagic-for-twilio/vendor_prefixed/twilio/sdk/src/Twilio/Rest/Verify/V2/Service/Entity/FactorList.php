...
class FactorList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\FactorPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\FactorPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return FactorPage Page of FactorInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\FactorPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\FactorContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\FactorContext($this->version, $this->solution['serviceSid'], $this->solution['identity'], $sid);
    }
    /**
