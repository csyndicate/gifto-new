...
abstract class PlayerStreamerOptions
{
     ...
     */
    public static function create(bool $video = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $maxDuration = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\CreatePlayerStreamerOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\CreatePlayerStreamerOptions($video, $statusCallback, $statusCallbackMethod, $maxDuration);
    }
    /**
     ...
     */
    public static function read(string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\ReadPlayerStreamerOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\ReadPlayerStreamerOptions($order, $status);
    }
}
class CreatePlayerStreamerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $video Specifies whether the PlayerStreamer is configured to stream video. Defaults to `true`.
     * @param string $statusCallback The URL to which Twilio will send asynchronous webhook requests for every PlayerStreamer event. See [Status Callbacks](/docs/live/api/status-callbacks) for more details.
     ...
     * @param int $maxDuration The maximum time, in seconds, that the PlayerStreamer is active (`created` or `started`) before automatically ends. The default value is 300 seconds, and the maximum value is 90000 seconds. Once this maximum duration is reached, Twilio will end the PlayerStreamer, regardless of whether media is still streaming.
     */
    public function __construct(bool $video = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $maxDuration = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
...
class ReadPlayerStreamerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $order The sort order of the list by `date_created`. Can be: `asc` (ascending) or `desc` (descending) with `desc` as the default.
     * @param string $status Status to filter by, with possible values `created`, `started`, `ended`, or `failed`.
