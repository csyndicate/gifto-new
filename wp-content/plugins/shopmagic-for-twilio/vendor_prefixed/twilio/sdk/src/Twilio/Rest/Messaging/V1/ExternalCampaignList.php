...
class ExternalCampaignList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $campaignId, string $messagingServiceSid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\ExternalCampaignInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['CampaignId' => $campaignId, 'MessagingServiceSid' => $messagingServiceSid]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\ExternalCampaignInstance($this->version, $payload);
    }
    /**
