...
abstract class AddressConfigurationOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $autoCreationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $autoCreationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationConversationServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $autoCreationWebhookFilters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $autoCreationStudioFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $autoCreationStudioRetryCount = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $addressCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CreateAddressConfigurationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CreateAddressConfigurationOptions($friendlyName, $autoCreationEnabled, $autoCreationType, $autoCreationConversationServiceSid, $autoCreationWebhookUrl, $autoCreationWebhookMethod, $autoCreationWebhookFilters, $autoCreationStudioFlowSid, $autoCreationStudioRetryCount, $addressCountry);
    }
    /**
     ...
     */
    public static function read(string $type = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ReadAddressConfigurationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ReadAddressConfigurationOptions($type);
    }
    /**
     * @param string $friendlyName The human-readable name of this configuration, limited to 256 characters. Optional.
     * @param bool $autoCreationEnabled Enable/Disable auto-creating conversations for messages to this address
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $autoCreationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $autoCreationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationConversationServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $autoCreationWebhookFilters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $autoCreationStudioFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $autoCreationStudioRetryCount = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UpdateAddressConfigurationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UpdateAddressConfigurationOptions($friendlyName, $autoCreationEnabled, $autoCreationType, $autoCreationConversationServiceSid, $autoCreationWebhookUrl, $autoCreationWebhookMethod, $autoCreationWebhookFilters, $autoCreationStudioFlowSid, $autoCreationStudioRetryCount);
    }
}
class CreateAddressConfigurationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName The human-readable name of this configuration, limited to 256 characters. Optional.
     * @param bool $autoCreationEnabled Enable/Disable auto-creating conversations for messages to this address
     ...
     * @param string $addressCountry An ISO 3166-1 alpha-2n country code which the address belongs to. This is currently only applicable to short code addresses.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $autoCreationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $autoCreationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationConversationServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $autoCreationWebhookFilters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $autoCreationStudioFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $autoCreationStudioRetryCount = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $addressCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadAddressConfigurationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $type Filter the address configurations by its type. This value can be one of: `whatsapp`, `sms`.
     */
    public function __construct(string $type = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateAddressConfigurationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName The human-readable name of this configuration, limited to 256 characters. Optional.
     * @param bool $autoCreationEnabled Enable/Disable auto-creating conversations for messages to this address
     ...
     * @param int $autoCreationStudioRetryCount For type `studio`, number of times to retry the webhook request
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $autoCreationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $autoCreationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationConversationServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $autoCreationWebhookMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $autoCreationWebhookFilters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $autoCreationStudioFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $autoCreationStudioRetryCount = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
        $this->options['autoCreationEnabled'] = $autoCreationEnabled;
        $this->options['autoCreationType'] = $autoCreationType;
