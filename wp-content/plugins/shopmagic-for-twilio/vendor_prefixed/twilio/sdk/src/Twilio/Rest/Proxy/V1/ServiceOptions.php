...
abstract class ServiceOptions
{
     ...
     */
    public static function create(int $defaultTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $geoMatchLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $numberSelectionBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $interceptCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $outOfSessionCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chatInstanceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\CreateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\CreateServiceOptions($defaultTtl, $callbackUrl, $geoMatchLevel, $numberSelectionBehavior, $interceptCallbackUrl, $outOfSessionCallbackUrl, $chatInstanceSid);
    }
    /**
     ...
     */
    public static function update(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $defaultTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $geoMatchLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $numberSelectionBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $interceptCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $outOfSessionCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chatInstanceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\UpdateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\UpdateServiceOptions($uniqueName, $defaultTtl, $callbackUrl, $geoMatchLevel, $numberSelectionBehavior, $interceptCallbackUrl, $outOfSessionCallbackUrl, $chatInstanceSid);
    }
}
class CreateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $chatInstanceSid The SID of the Chat Service Instance managed by Proxy Service. The Chat Service enables Proxy to forward SMS and channel messages to this chat instance. This is a one-to-one relationship.
     */
    public function __construct(int $defaultTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $geoMatchLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $numberSelectionBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $interceptCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $outOfSessionCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chatInstanceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $chatInstanceSid The SID of the Chat Service Instance managed by Proxy Service. The Chat Service enables Proxy to forward SMS and channel messages to this chat instance. This is a one-to-one relationship.
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $defaultTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $geoMatchLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $numberSelectionBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $interceptCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $outOfSessionCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chatInstanceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
