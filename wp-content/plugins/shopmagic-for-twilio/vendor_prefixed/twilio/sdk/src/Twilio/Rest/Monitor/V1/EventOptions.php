...
abstract class EventOptions
{
     ...
     */
    public static function read(string $actorSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $resourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceIpAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null) : \ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\ReadEventOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\ReadEventOptions($actorSid, $eventType, $resourceSid, $sourceIpAddress, $startDate, $endDate);
    }
}
class ReadEventOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param \DateTime $endDate Only include events that occurred on or before this date. Specify the date in GMT and [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public function __construct(string $actorSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $resourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceIpAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null)
    {
