...
abstract class UsageRecordOptions
{
     ...
     */
    public static function read(\DateTime $end = null, \DateTime $start = null, string $granularity = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\Sim\ReadUsageRecordOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\Sim\ReadUsageRecordOptions($end, $start, $granularity);
    }
}
class ReadUsageRecordOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $granularity How to summarize the usage by time. Can be: `daily`, `hourly`, or `all`. The default is `all`. A value of `all` returns one Usage Record that describes the usage for the entire period.
     */
    public function __construct(\DateTime $end = null, \DateTime $start = null, string $granularity = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
