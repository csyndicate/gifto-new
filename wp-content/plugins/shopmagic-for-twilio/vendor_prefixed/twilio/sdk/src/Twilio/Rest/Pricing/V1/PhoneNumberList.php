...
use ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\PhoneNumber\CountryList;
/**
...
class PhoneNumberList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    protected function getCountries() : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\PhoneNumber\CountryList
    {
        if (!$this->_countries) {
            $this->_countries = new \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\PhoneNumber\CountryList($this->version);
        }
