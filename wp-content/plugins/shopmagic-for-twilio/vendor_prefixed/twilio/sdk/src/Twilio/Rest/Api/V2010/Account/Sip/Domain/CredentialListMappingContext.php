...
class CredentialListMappingContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\Domain\CredentialListMappingInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\Domain\CredentialListMappingInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['domainSid'], $this->solution['sid']);
    }
    /**
