...
abstract class TaskOptions
{
     ...
     */
    public static function create(int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $virtualStartTime = null) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\CreateTaskOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\CreateTaskOptions($timeout, $priority, $taskChannel, $workflowSid, $attributes, $virtualStartTime);
    }
    /**
     ...
     */
    public static function delete(string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\DeleteTaskOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\DeleteTaskOptions($ifMatch);
    }
    /**
     ...
     */
    public static function read(int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workflowName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $evaluateTaskAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ordering = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $hasAddons = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadTaskOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadTaskOptions($priority, $assignmentStatus, $workflowSid, $workflowName, $taskQueueSid, $taskQueueName, $evaluateTaskAttributes, $ordering, $hasAddons);
    }
    /**
     ...
     */
    public static function update(string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $reason = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $virtualStartTime = null, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\UpdateTaskOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\UpdateTaskOptions($attributes, $assignmentStatus, $reason, $priority, $taskChannel, $virtualStartTime, $ifMatch);
    }
}
class CreateTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param \DateTime $virtualStartTime The virtual start time to assign the new task and override the default. When supplied, the new task will have this virtual start time. When not supplied, the new task will have the virtual start time equal to `date_created`. Value can't be in the future.
     */
    public function __construct(int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $virtualStartTime = null)
    {
...
class DeleteTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $ifMatch If provided, deletes this Task if (and only if) the [ETag](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/ETag) header of the Task matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     */
...
class ReadTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $priority The priority value of the Tasks to read. Returns the list of all Tasks in the Workspace with the specified priority.
     * @param string[] $assignmentStatus The `assignment_status` of the Tasks you want to read. Can be: `pending`, `reserved`, `assigned`, `canceled`, `wrapping`, or `completed`. Returns all Tasks in the Workspace with the specified `assignment_status`.
     ...
     * @param bool $hasAddons Whether to read Tasks with addons. If `true`, returns only Tasks with addons. If `false`, returns only Tasks without addons.
     */
    public function __construct(int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workflowName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $evaluateTaskAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ordering = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $hasAddons = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
        $this->options['priority'] = $priority;
...
class UpdateTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $ifMatch If provided, applies this mutation if (and only if) the [ETag](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/ETag) header of the Task matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     */
    public function __construct(string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $reason = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $virtualStartTime = null, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['attributes'] = $attributes;
        $this->options['assignmentStatus'] = $assignmentStatus;
