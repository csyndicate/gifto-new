...
class FlowRevisionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\FlowRevisionPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\FlowRevisionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return FlowRevisionPage Page of FlowRevisionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\FlowRevisionPage
    {
     ...
     */
    public function getContext(string $revision) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\FlowRevisionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\FlowRevisionContext($this->version, $this->solution['sid'], $revision);
    }
    /**
