...
abstract class ReservationOptions
{
     ...
     */
    public static function read(string $reservationStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Worker\ReadReservationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Worker\ReadReservationOptions($reservationStatus);
    }
    /**
...
class ReadReservationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $reservationStatus Returns the list of reservations for a worker with a specified ReservationStatus. Can be: `pending`, `accepted`, `rejected`, `timeout`, `canceled`, or `rescinded`.
     */
    public function __construct(string $reservationStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
