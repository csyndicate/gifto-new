...
class ConnectionPolicyList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['FriendlyName' => $options['friendlyName']]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ConnectionPolicyPage Page of ConnectionPolicyInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyContext($this->version, $sid);
    }
    /**
