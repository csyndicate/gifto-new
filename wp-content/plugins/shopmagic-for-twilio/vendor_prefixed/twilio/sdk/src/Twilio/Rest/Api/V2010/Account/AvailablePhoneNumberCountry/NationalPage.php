...
class NationalPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\NationalInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\NationalInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['countryCode']);
    }
    /**
