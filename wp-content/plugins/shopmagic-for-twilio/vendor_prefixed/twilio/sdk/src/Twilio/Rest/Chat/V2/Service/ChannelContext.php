...
use ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\MemberList;
use ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteList;
use ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookList;
use ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\MessageList;
/**
...
class ChannelContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\ChannelInstance
    {
        $payload = $this->version->fetch('GET', $this->uri);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\ChannelInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sid']);
    }
    /**
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\ChannelInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
     ...
     * Access the members
     */
    protected function getMembers() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\MemberList
    {
        if (!$this->_members) {
            $this->_members = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\MemberList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
     ...
     * Access the invites
     */
    protected function getInvites() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteList
    {
        if (!$this->_invites) {
            $this->_invites = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
     ...
     * Access the webhooks
     */
    protected function getWebhooks() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookList
    {
        if (!$this->_webhooks) {
            $this->_webhooks = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
     ...
     * Access the messages
     */
    protected function getMessages() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\MessageList
    {
        if (!$this->_messages) {
            $this->_messages = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\MessageList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
