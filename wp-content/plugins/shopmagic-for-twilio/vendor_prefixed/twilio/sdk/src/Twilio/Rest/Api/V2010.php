 ...
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Api;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\InstanceContext;
use ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\AccountInstance;
use ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\AccountList;
use ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\AccountContext;
 ...
 */
class V2010 extends \ShopMagicTwilioVendor\Twilio\Version
{
    protected $_accounts;
    ...
    {
        if (!$this->_accounts) {
            $this->_accounts = new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\AccountList($this);
        }
    ...
    {
        if (!$this->_account) {
            $this->_account = new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\AccountContext($this, $this->domain->getClient()->getAccountSid());
        }
