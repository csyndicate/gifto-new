...
abstract class PhoneNumberOptions
{
     ...
     */
    public static function create(string $sid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $isReserved = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\CreatePhoneNumberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\CreatePhoneNumberOptions($sid, $phoneNumber, $isReserved);
    }
    /**
     ...
     */
    public static function update(bool $isReserved = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\UpdatePhoneNumberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\UpdatePhoneNumberOptions($isReserved);
    }
}
class CreatePhoneNumberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $sid The SID of a Twilio [IncomingPhoneNumber](https://www.twilio.com/docs/phone-numbers/api/incomingphonenumber-resource) resource that represents the Twilio Number you would like to assign to your Proxy Service.
     * @param string $phoneNumber The phone number in [E.164](https://www.twilio.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234.
     * @param bool $isReserved Whether the new phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.twilio.com/docs/proxy/reserved-phone-numbers) for more information.
     */
    public function __construct(string $sid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $isReserved = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class UpdatePhoneNumberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $isReserved Whether the phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.twilio.com/docs/proxy/reserved-phone-numbers) for more information.
     */
    public function __construct(bool $isReserved = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
        $this->options['isReserved'] = $isReserved;
    }
    /**
