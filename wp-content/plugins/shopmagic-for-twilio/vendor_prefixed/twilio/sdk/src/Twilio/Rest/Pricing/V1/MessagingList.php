...
use ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Messaging\CountryList;
/**
 * @property CountryList $countries
 * @method \Twilio\Rest\Pricing\V1\Messaging\CountryContext countries(string $isoCountry)
 */
class MessagingList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    protected function getCountries() : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Messaging\CountryList
    {
        if (!$this->_countries) {
            $this->_countries = new \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Messaging\CountryList($this->version);
        }
