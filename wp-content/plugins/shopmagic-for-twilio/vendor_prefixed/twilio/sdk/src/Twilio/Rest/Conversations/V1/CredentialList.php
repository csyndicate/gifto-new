...
class CredentialList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $type, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return CredentialPage Page of CredentialInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialContext($this->version, $sid);
    }
    /**
