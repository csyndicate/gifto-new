...
abstract class TranscriptOptions
{
     ...
     */
    public static function create(string $customerKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $mediaStartTime = null) : \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\CreateTranscriptOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\CreateTranscriptOptions($customerKey, $mediaStartTime);
    }
    /**
     ...
     */
    public static function read(string $serviceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $beforeStartTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $afterStartTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $beforeDateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $afterDateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $languageCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\ReadTranscriptOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\ReadTranscriptOptions($serviceSid, $beforeStartTime, $afterStartTime, $beforeDateCreated, $afterDateCreated, $status, $languageCode, $sourceSid);
    }
}
class CreateTranscriptOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $customerKey Used to store client provided metadata. Maximum of 64 double-byte UTF8 characters.
     * @param \DateTime $mediaStartTime The date that this Transcript's media was started, given in ISO 8601 format.
     */
    public function __construct(string $customerKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $mediaStartTime = null)
    {
...
class ReadTranscriptOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $serviceSid The unique SID identifier of the Service.
     * @param string $beforeStartTime Filter by before StartTime.
     ...
     * @param string $sourceSid Filter by SourceSid.
     */
    public function __construct(string $serviceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $beforeStartTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $afterStartTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $beforeDateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $afterDateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $languageCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
