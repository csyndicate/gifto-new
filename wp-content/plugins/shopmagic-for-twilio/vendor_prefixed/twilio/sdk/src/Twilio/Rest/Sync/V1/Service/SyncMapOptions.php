...
abstract class SyncMapOptions
{
     ...
     */
    public static function create(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\CreateSyncMapOptions
    {
     ...
     */
    public static function update(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateSyncMapOptions
    {
...
class CreateSyncMapOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync Map expires (time-to-live) and is deleted.
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
...
class UpdateSyncMapOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync Map expires (time-to-live) and is deleted.
     */
    public function __construct(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
        $this->options['ttl'] = $ttl;
        $this->options['collectionTtl'] = $collectionTtl;
    }
