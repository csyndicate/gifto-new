...
class SchemaVersionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $id)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Schema\SchemaVersionPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Schema\SchemaVersionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SchemaVersionPage Page of SchemaVersionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Schema\SchemaVersionPage
    {
     ...
     */
    public function getContext(int $schemaVersion) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Schema\SchemaVersionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Schema\SchemaVersionContext($this->version, $this->solution['id'], $schemaVersion);
    }
    /**
