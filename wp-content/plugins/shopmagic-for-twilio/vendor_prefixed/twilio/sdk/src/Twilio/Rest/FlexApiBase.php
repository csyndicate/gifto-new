 ...
 */
class FlexApiBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v1;
    protected $_v2;
    /**
    ...
    /**
     * @return V1 Version v1 of flex-api
     */
    protected function getV1() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1
    {
        if (!$this->_v1) {
            $this->_v1 = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1($this);
        }
        return $this->_v1;
    }
    /**
     ...
     */
    protected function getV2() : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V2
    {
        if (!$this->_v2) {
            $this->_v2 = new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V2($this);
        }
        return $this->_v2;
    }
    /**
