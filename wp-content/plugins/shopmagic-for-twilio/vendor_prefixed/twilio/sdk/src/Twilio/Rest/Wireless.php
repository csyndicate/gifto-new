...
use ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1;
class Wireless extends \ShopMagicTwilioVendor\Twilio\Rest\WirelessBase
{
    /**
     ...
     */
    protected function contextCommands(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\CommandContext
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRatePlans(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\RatePlanContext
    {
     ...
     */
    protected function contextSims(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\SimContext
    {
