...
abstract class InstalledAddOnOptions
{
     ...
     */
    public static function create(array $configuration = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\CreateInstalledAddOnOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\CreateInstalledAddOnOptions($configuration, $uniqueName);
    }
    /**
     ...
     */
    public static function update(array $configuration = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\UpdateInstalledAddOnOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\UpdateInstalledAddOnOptions($configuration, $uniqueName);
    }
}
class CreateInstalledAddOnOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param array $configuration The JSON object that represents the configuration of the new Add-on being installed.
     * @param string $uniqueName An application-defined string that uniquely identifies the resource. This value must be unique within the Account.
     */
    public function __construct(array $configuration = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateInstalledAddOnOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param array $configuration Valid JSON object that conform to the configuration schema exposed by the associated AvailableAddOn resource. This is only required by Add-ons that need to be configured
     * @param string $uniqueName An application-defined string that uniquely identifies the resource. This value must be unique within the Account.
