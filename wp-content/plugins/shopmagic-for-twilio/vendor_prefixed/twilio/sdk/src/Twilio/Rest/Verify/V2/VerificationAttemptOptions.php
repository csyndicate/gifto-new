...
abstract class VerificationAttemptOptions
{
     ...
     */
    public static function read(\DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $channelDataTo = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $country = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $channel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verifyServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\ReadVerificationAttemptOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\ReadVerificationAttemptOptions($dateCreatedAfter, $dateCreatedBefore, $channelDataTo, $country, $channel, $verifyServiceSid, $verificationSid, $status);
    }
}
class ReadVerificationAttemptOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $dateCreatedAfter Datetime filter used to consider only Verification Attempts created after this datetime on the summary aggregation. Given as GMT in ISO 8601 formatted datetime string: yyyy-MM-dd'T'HH:mm:ss'Z.
     * @param \DateTime $dateCreatedBefore Datetime filter used to consider only Verification Attempts created before this datetime on the summary aggregation. Given as GMT in ISO 8601 formatted datetime string: yyyy-MM-dd'T'HH:mm:ss'Z.
     ...
     * @param string $status Filter used to query Verification Attempts by conversion status. Valid values are `UNCONVERTED`, for attempts that were not converted, and `CONVERTED`, for attempts that were confirmed.
     */
    public function __construct(\DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $channelDataTo = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $country = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $channel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verifyServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
