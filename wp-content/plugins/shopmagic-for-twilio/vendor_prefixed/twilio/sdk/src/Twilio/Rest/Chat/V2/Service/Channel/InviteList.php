...
class InviteList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $identity, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Identity' => $identity, 'RoleSid' => $options['roleSid']]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['channelSid']);
    }
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InvitePage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InvitePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return InvitePage Page of InviteInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InvitePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\InviteContext($this->version, $this->solution['serviceSid'], $this->solution['channelSid'], $sid);
    }
    /**
