 ...
 */
class ContentContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Content\V1\ContentInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Content\V1\ContentInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    protected function getApprovalFetch() : \ShopMagicTwilioVendor\Twilio\Rest\Content\V1\Content\ApprovalFetchList
    {
        if (!$this->_approvalFetch) {
            $this->_approvalFetch = new \ShopMagicTwilioVendor\Twilio\Rest\Content\V1\Content\ApprovalFetchList($this->version, $this->solution['sid']);
        }
