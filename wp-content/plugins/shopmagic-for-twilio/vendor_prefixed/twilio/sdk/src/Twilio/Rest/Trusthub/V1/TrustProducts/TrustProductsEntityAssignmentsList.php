...
class TrustProductsEntityAssignmentsList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $objectSid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['ObjectSid' => $objectSid]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsInstance($this->version, $payload, $this->solution['trustProductSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return TrustProductsEntityAssignmentsPage Page of TrustProductsEntityAssignmentsInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsContext($this->version, $this->solution['trustProductSid'], $sid);
    }
    /**
