...
class LinkshorteningMessagingServiceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function getContext(string $domainSid, string $messagingServiceSid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\LinkshorteningMessagingServiceContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\LinkshorteningMessagingServiceContext($this->version, $domainSid, $messagingServiceSid);
    }
    /**
