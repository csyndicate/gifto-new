...
abstract class HostedNumberOrderOptions
{
     ...
     */
    public static function create(string $accountSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $email = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationDocumentSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\CreateHostedNumberOrderOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\CreateHostedNumberOrderOptions($accountSid, $friendlyName, $uniqueName, $ccEmails, $smsUrl, $smsMethod, $smsFallbackUrl, $smsFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $smsApplicationSid, $addressSid, $email, $verificationType, $verificationDocumentSid);
    }
    /**
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $incomingPhoneNumberSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\ReadHostedNumberOrderOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\ReadHostedNumberOrderOptions($status, $phoneNumber, $incomingPhoneNumberSid, $friendlyName, $uniqueName);
    }
    /**
     * @param string $friendlyName A 64 character string that is a human readable text that describes this resource.
     * @param string $uniqueName Provides a unique and addressable name to be assigned to this HostedNumberOrder, assigned by the developer, to be optionally used in addition to SID.
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $email = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationDocumentSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $extension = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $callDelay = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\UpdateHostedNumberOrderOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\UpdateHostedNumberOrderOptions($friendlyName, $uniqueName, $email, $ccEmails, $status, $verificationCode, $verificationType, $verificationDocumentSid, $extension, $callDelay);
    }
}
class CreateHostedNumberOrderOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $accountSid This defaults to the AccountSid of the authorization the user is using. This can be provided to specify a subaccount to add the HostedNumberOrder to.
     * @param string $friendlyName A 64 character string that is a human readable text that describes this resource.
     ...
     * @param string $verificationDocumentSid Optional. The unique sid identifier of the Identity Document that represents the document for verifying ownership of the number to be hosted. Required when VerificationType is phone-bill.
     */
    public function __construct(string $accountSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $email = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationDocumentSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadHostedNumberOrderOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $status The Status of this HostedNumberOrder. One of `received`, `pending-verification`, `verified`, `pending-loa`, `carrier-processing`, `testing`, `completed`, `failed`, or `action-required`.
     * @param string $phoneNumber An E164 formatted phone number hosted by this HostedNumberOrder.
     ...
     * @param string $uniqueName Provides a unique and addressable name to be assigned to this HostedNumberOrder, assigned by the developer, to be optionally used in addition to SID.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $incomingPhoneNumberSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateHostedNumberOrderOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A 64 character string that is a human readable text that describes this resource.
     * @param string $uniqueName Provides a unique and addressable name to be assigned to this HostedNumberOrder, assigned by the developer, to be optionally used in addition to SID.
     ...
     * @param int $callDelay The number of seconds, between 0 and 60, to delay before initiating the verification call. Defaults to 0.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $email = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $verificationDocumentSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $extension = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $callDelay = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
        $this->options['uniqueName'] = $uniqueName;
        $this->options['email'] = $email;
