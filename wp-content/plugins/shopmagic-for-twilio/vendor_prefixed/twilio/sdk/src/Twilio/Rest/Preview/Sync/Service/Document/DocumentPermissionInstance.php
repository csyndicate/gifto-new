...
class DocumentPermissionInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionContext
    {
        if (!$this->context) {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionInstance
    {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(bool $read, bool $write, bool $manage) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionInstance
    {
