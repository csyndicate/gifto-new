...
class DeliveryReceiptContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $conversationSid, $messageSid, $sid)
    {
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptInstance($this->version, $payload, $this->solution['conversationSid'], $this->solution['messageSid'], $this->solution['sid']);
    }
    /**
