...
abstract class DomainConfigOptions
{
     ...
     */
    public static function update(string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $continueOnFailure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $disableHttps = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\UpdateDomainConfigOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\UpdateDomainConfigOptions($fallbackUrl, $callbackUrl, $continueOnFailure, $disableHttps);
    }
}
class UpdateDomainConfigOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $fallbackUrl Any requests we receive to this domain that do not match an existing shortened message will be redirected to the fallback url. These will likely be either expired messages, random misdirected traffic, or intentional scraping.
     * @param string $callbackUrl URL to receive click events to your webhook whenever the recipients click on the shortened links
     ...
     * @param bool $disableHttps Customer's choice to send links with/without \\\"https://\\\" attached to shortened url. If true, messages will not be sent with https:// at the beginning of the url. If false, messages will be sent with https:// at the beginning of the url. False is the default behavior if it is not specified.
     */
    public function __construct(string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $continueOnFailure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $disableHttps = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
