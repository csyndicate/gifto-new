...
class CredentialList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $accountSid, string $credentialListSid)
    {
     ...
     */
    public function create(string $username, string $password) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Username' => $username, 'Password' => $password]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['credentialListSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return CredentialPage Page of CredentialInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialContext($this->version, $this->solution['accountSid'], $this->solution['credentialListSid'], $sid);
    }
    /**
