...
abstract class SupportingDocumentOptions
{
     ...
     */
    public static function create(array $attributes = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CreateSupportingDocumentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CreateSupportingDocumentOptions($attributes);
    }
    /**
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $attributes = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\UpdateSupportingDocumentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\UpdateSupportingDocumentOptions($friendlyName, $attributes);
    }
}
