...
class SupportingDocumentTypeList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypePage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SupportingDocumentTypePage Page of SupportingDocumentTypeInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext($this->version, $sid);
    }
    /**
