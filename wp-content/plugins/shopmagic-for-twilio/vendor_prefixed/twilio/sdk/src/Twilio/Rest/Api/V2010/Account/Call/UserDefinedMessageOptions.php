...
abstract class UserDefinedMessageOptions
{
     ...
     */
    public static function create(string $idempotencyKey = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateUserDefinedMessageOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateUserDefinedMessageOptions($idempotencyKey);
    }
}
class CreateUserDefinedMessageOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $idempotencyKey A unique string value to identify API call. This should be a unique string value per API call and can be a randomly generated.
     */
    public function __construct(string $idempotencyKey = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
