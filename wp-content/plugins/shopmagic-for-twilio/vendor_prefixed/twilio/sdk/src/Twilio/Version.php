...
use ShopMagicTwilioVendor\Twilio\Exceptions\RestException;
...
abstract class Version
{
     ...
     */
    protected function exception(\ShopMagicTwilioVendor\Twilio\Http\Response $response, string $header) : \ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException
    {
        ...
        if (\is_array($content)) {
            ...
            return new \ShopMagicTwilioVendor\Twilio\Exceptions\RestException($message, $code, $response->getStatusCode(), $moreInfo, $details);
        }
        return new \ShopMagicTwilioVendor\Twilio\Exceptions\RestException($message, $response->getStatusCode(), $response->getStatusCode());
    }
    /**
    ...
    public function readLimits(int $limit = null, int $pageSize = null) : array
    {
        ...
        return ['limit' => $limit ?: \ShopMagicTwilioVendor\Twilio\Values::NONE, 'pageSize' => $pageSize ?: \ShopMagicTwilioVendor\Twilio\Values::NONE, 'pageLimit' => \ShopMagicTwilioVendor\Twilio\Values::NONE];
    }
    public function page(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \ShopMagicTwilioVendor\Twilio\Http\Response
    {
        return $this->request($method, $uri, $params, $data, $headers, $username, $password, $timeout);
    }
    public function stream(\ShopMagicTwilioVendor\Twilio\Page $page, $limit = null, $pageLimit = null) : \ShopMagicTwilioVendor\Twilio\Stream
    {
        return new \ShopMagicTwilioVendor\Twilio\Stream($page, $limit, $pageLimit);
    }
    /**
     * @throws TwilioException
     */
    ...
    public function getDomain() : \ShopMagicTwilioVendor\Twilio\Domain
    {
        return $this->domain;
    }
