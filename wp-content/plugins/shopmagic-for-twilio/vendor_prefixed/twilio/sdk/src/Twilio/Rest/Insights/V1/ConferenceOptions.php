...
abstract class ConferenceOptions
{
     ...
     */
    public static function read(string $conferenceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $createdAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $createdBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $mixerRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $tags = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $subaccount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $detectedIssues = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $endReason = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\ReadConferenceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\ReadConferenceOptions($conferenceSid, $friendlyName, $status, $createdAfter, $createdBefore, $mixerRegion, $tags, $subaccount, $detectedIssues, $endReason);
    }
}
class ReadConferenceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $endReason Conference end reason; e.g. last participant left, modified by API, etc.
     */
    public function __construct(string $conferenceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $createdAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $createdBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $mixerRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $tags = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $subaccount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $detectedIssues = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $endReason = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
