 ...
 */
class SinkValidateInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $sid)
    {
        ...
        $this->properties = ['result' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'result')];
