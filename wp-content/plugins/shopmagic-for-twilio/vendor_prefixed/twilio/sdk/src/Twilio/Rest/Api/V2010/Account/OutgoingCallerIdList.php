...
class OutgoingCallerIdList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdPage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PhoneNumber' => $options['phoneNumber'], 'FriendlyName' => $options['friendlyName'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return OutgoingCallerIdPage Page of OutgoingCallerIdInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
