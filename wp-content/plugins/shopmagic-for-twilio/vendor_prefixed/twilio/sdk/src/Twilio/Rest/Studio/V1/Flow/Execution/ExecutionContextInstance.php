...
class ExecutionContextInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionContextContext
    {
        if (!$this->context) {
     ...
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionContextInstance
    {
