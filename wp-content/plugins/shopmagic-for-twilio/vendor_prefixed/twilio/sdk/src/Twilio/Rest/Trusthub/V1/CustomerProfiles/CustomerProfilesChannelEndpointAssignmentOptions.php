...
abstract class CustomerProfilesChannelEndpointAssignmentOptions
{
     ...
     */
    public static function read(string $channelEndpointSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $channelEndpointSids = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CustomerProfiles\ReadCustomerProfilesChannelEndpointAssignmentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CustomerProfiles\ReadCustomerProfilesChannelEndpointAssignmentOptions($channelEndpointSid, $channelEndpointSids);
    }
}
class ReadCustomerProfilesChannelEndpointAssignmentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $channelEndpointSid The SID of an channel endpoint
     * @param string $channelEndpointSids comma separated list of channel endpoint sids
