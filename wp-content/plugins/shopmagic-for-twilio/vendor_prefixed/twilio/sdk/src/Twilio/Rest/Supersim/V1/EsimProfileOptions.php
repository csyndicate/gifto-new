...
abstract class EsimProfileOptions
{
     ...
     */
    public static function create(string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $generateMatchingId = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $eid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateEsimProfileOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateEsimProfileOptions($callbackUrl, $callbackMethod, $generateMatchingId, $eid);
    }
    /**
     ...
     */
    public static function read(string $eid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $simSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadEsimProfileOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadEsimProfileOptions($eid, $simSid, $status);
    }
}
class CreateEsimProfileOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $callbackUrl The URL we should call using the `callback_method` when the status of the eSIM Profile changes. At this stage of the eSIM Profile pilot, the a request to the URL will only be called when the ESimProfile resource changes from `reserving` to `available`.
     * @param string $callbackMethod The HTTP method we should use to call `callback_url`. Can be: `GET` or `POST` and the default is POST.
     ...
     * @param string $eid Identifier of the eUICC that will claim the eSIM Profile.
     */
    public function __construct(string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $generateMatchingId = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $eid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadEsimProfileOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $eid List the eSIM Profiles that have been associated with an EId.
     * @param string $simSid Find the eSIM Profile resource related to a [Sim](https://www.twilio.com/docs/iot/wireless/api/sim-resource) resource by providing the SIM SID. Will always return an array with either 1 or 0 records.
     * @param string $status List the eSIM Profiles that are in a given status.
     */
    public function __construct(string $eid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $simSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['eid'] = $eid;
