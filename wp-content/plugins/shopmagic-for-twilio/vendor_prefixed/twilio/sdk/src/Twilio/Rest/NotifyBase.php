 ...
 */
class NotifyBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v1;
    /**
     ...
     */
    protected function getV1() : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1
    {
        if (!$this->_v1) {
            $this->_v1 = new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1($this);
        }
        return $this->_v1;
    }
    /**
