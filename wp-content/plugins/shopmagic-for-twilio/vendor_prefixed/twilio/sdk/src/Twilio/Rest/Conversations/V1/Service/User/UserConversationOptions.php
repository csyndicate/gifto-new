...
abstract class UserConversationOptions
{
     ...
     */
    public static function update(string $notificationLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $lastReadTimestamp = null, int $lastReadMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\User\UpdateUserConversationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\User\UpdateUserConversationOptions($notificationLevel, $lastReadTimestamp, $lastReadMessageIndex);
    }
}
