...
use ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptList;
/**
...
class MessageInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\MessageContext
    {
        if (!$this->context) {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\MessageInstance
    {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\MessageInstance
    {
     ...
     */
    protected function getDeliveryReceipts() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptList
    {
