...
class AccountConfigList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $key, string $value) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Key' => $key, 'Value' => $value]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return AccountConfigPage Page of AccountConfigInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigPage
    {
     ...
     * @param string $key The config key; up to 100 characters.
     */
    public function getContext(string $key) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AccountConfigContext($this->version, $key);
    }
    /**
