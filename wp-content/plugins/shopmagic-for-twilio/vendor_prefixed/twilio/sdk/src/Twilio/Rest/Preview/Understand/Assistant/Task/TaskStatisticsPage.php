...
class TaskStatisticsPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\Task\TaskStatisticsInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\Task\TaskStatisticsInstance($this->version, $payload, $this->solution['assistantSid'], $this->solution['taskSid']);
    }
    /**
