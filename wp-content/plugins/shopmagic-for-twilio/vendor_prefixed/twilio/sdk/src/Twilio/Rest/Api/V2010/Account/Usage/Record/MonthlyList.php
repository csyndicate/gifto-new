...
class MonthlyList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\MonthlyPage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\MonthlyPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return MonthlyPage Page of MonthlyInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\MonthlyPage
    {
