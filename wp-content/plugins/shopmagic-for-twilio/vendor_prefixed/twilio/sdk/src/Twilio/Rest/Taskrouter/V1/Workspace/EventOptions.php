...
abstract class EventOptions
{
     ...
     */
    public static function read(\DateTime $endDate = null, string $eventType = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $reservationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, string $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadEventOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadEventOptions($endDate, $eventType, $minutes, $reservationSid, $startDate, $taskQueueSid, $taskSid, $workerSid, $workflowSid, $taskChannel, $sid);
    }
}
class ReadEventOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $sid The SID of the Event resource to read.
     */
    public function __construct(\DateTime $endDate = null, string $eventType = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $reservationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, string $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
