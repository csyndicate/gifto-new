...
class StepList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $flowSid, string $engagementSid)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Engagement\StepPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Engagement\StepPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return StepPage Page of StepInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Engagement\StepPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Engagement\StepContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Engagement\StepContext($this->version, $this->solution['flowSid'], $this->solution['engagementSid'], $sid);
    }
    /**
