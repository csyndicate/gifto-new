...
abstract class WebhookOptions
{
     ...
     */
    public static function update(string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $filters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $preWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $postWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $target = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Configuration\UpdateWebhookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Configuration\UpdateWebhookOptions($method, $filters, $preWebhookUrl, $postWebhookUrl, $target);
    }
}
class UpdateWebhookOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $target
     */
    public function __construct(string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $filters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $preWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $postWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $target = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
