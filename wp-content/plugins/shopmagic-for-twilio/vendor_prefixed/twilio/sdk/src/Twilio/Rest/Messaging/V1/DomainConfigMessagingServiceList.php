...
class DomainConfigMessagingServiceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function getContext(string $messagingServiceSid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\DomainConfigMessagingServiceContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\DomainConfigMessagingServiceContext($this->version, $messagingServiceSid);
    }
    /**
