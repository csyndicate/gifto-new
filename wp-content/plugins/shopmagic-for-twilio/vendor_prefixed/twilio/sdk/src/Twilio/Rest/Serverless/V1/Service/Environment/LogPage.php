...
class LogPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Environment\LogInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Environment\LogInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['environmentSid']);
    }
    /**
