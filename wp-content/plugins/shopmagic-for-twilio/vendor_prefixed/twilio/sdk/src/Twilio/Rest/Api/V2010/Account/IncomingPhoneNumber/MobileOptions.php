...
abstract class MobileOptions
{
     ...
     */
    public static function create(string $apiVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $identitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyAddressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $trunkSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceReceiveMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bundleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\CreateMobileOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\CreateMobileOptions($apiVersion, $friendlyName, $smsApplicationSid, $smsFallbackMethod, $smsFallbackUrl, $smsMethod, $smsUrl, $statusCallback, $statusCallbackMethod, $voiceApplicationSid, $voiceCallerIdLookup, $voiceFallbackMethod, $voiceFallbackUrl, $voiceMethod, $voiceUrl, $identitySid, $addressSid, $emergencyStatus, $emergencyAddressSid, $trunkSid, $voiceReceiveMode, $bundleSid);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\ReadMobileOptions($beta, $friendlyName, $phoneNumber, $origin);
    }
}
class CreateMobileOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $apiVersion The API version to use for incoming calls made to the new phone number. The default is `2010-04-01`.
     * @param string $friendlyName A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, the is a formatted version of the phone number.
     ...
     * @param string $bundleSid The SID of the Bundle resource that you associate with the phone number. Some regions require a Bundle to meet local Regulations.
     */
    public function __construct(string $apiVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $identitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyAddressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $trunkSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceReceiveMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bundleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadMobileOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $beta Whether to include phone numbers new to the Twilio platform. Can be: `true` or `false` and the default is `true`.
     * @param string $friendlyName A string that identifies the resources to read.
