...
class UserList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $identity, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return UserPage Page of UserInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserContext($this->version, $this->solution['serviceSid'], $sid);
    }
    /**
