...
abstract class PhoneNumberOptions
{
     ...
     */
    public static function fetch(string $countryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $type = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $addOns = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $addOnsData = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\FetchPhoneNumberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\FetchPhoneNumberOptions($countryCode, $type, $addOns, $addOnsData);
    }
}
class FetchPhoneNumberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $addOnsData Data specific to the add-on you would like to invoke. The content and format of this value depends on the add-on.
     */
    public function __construct(string $countryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $type = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $addOns = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $addOnsData = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
