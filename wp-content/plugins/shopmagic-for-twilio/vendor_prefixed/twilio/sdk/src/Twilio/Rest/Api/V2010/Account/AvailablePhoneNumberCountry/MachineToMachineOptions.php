...
abstract class MachineToMachineOptions
{
     ...
     */
    public static function read(int $areaCode = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $contains = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $mmsEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $voiceEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $excludeAllAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $excludeLocalAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $excludeForeignAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $beta = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $nearNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $nearLatLong = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $distance = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $inPostalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inRateCenter = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inLata = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inLocality = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $faxEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\ReadMachineToMachineOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\ReadMachineToMachineOptions($areaCode, $contains, $smsEnabled, $mmsEnabled, $voiceEnabled, $excludeAllAddressRequired, $excludeLocalAddressRequired, $excludeForeignAddressRequired, $beta, $nearNumber, $nearLatLong, $distance, $inPostalCode, $inRegion, $inRateCenter, $inLata, $inLocality, $faxEnabled);
    }
}
class ReadMachineToMachineOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $areaCode The area code of the phone numbers to read. Applies to only phone numbers in the US and Canada.
     * @param string $contains The pattern on which to match phone numbers. Valid characters are `*`, `0-9`, `a-z`, and `A-Z`. The `*` character matches any single digit. For examples, see [Example 2](https://www.twilio.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-2) and [Example 3](https://www.twilio.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-3). If specified, this value must have at least two characters.
     ...
     * @param bool $faxEnabled Whether the phone numbers can receive faxes. Can be: `true` or `false`.
     */
    public function __construct(int $areaCode = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $contains = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $mmsEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $voiceEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $excludeAllAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $excludeLocalAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $excludeForeignAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $beta = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $nearNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $nearLatLong = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $distance = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $inPostalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inRateCenter = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inLata = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inLocality = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $faxEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
