...
class Preview extends \ShopMagicTwilioVendor\Twilio\Rest\PreviewBase
{
    /**
     ...
     */
    protected function contextFleets(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\DeployedDevices\FleetContext
    {
     ...
     */
    protected function contextAuthorizationDocuments(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentContext
    {
     ...
     */
    protected function contextHostedNumberOrders(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderContext
    {
     ...
     */
    protected function contextAvailableAddOns(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext
    {
     ...
     */
    protected function contextInstalledAddOns(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\InstalledAddOnContext
    {
     ...
     */
    protected function getServices() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\ServiceContext
    {
     ...
     *                    resource.
     */
    protected function contextAssistants(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\AssistantContext
    {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\CommandContext
    {
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\RatePlanContext
    {
     ...
     * @param string $sid The sid
     */
    protected function contextSims(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\SimContext
    {
