...
class ParticipantContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $serviceSid, $sessionSid, $sid)
    {
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\ParticipantInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\ParticipantInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sessionSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getMessageInteractions() : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\Participant\MessageInteractionList
    {
        if (!$this->_messageInteractions) {
            $this->_messageInteractions = new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\Participant\MessageInteractionList($this->version, $this->solution['serviceSid'], $this->solution['sessionSid'], $this->solution['sid']);
        }
