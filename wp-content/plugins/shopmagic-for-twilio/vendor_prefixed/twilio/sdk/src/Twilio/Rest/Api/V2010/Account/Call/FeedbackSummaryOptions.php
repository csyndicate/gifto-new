...
abstract class FeedbackSummaryOptions
{
     ...
     */
    public static function create(bool $includeSubaccounts = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateFeedbackSummaryOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateFeedbackSummaryOptions($includeSubaccounts, $statusCallback, $statusCallbackMethod);
    }
}
class CreateFeedbackSummaryOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $includeSubaccounts Whether to also include Feedback resources from all subaccounts. `true` includes feedback from all subaccounts and `false`, the default, includes feedback from only the specified account.
     * @param string $statusCallback The URL that we will request when the feedback summary is complete.
     * @param string $statusCallbackMethod The HTTP method (`GET` or `POST`) we use to make the request to the `StatusCallback` URL.
     */
    public function __construct(bool $includeSubaccounts = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
