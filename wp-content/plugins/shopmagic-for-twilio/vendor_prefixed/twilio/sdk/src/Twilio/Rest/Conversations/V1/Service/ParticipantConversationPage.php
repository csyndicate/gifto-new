...
class ParticipantConversationPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\ParticipantConversationInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\ParticipantConversationInstance($this->version, $payload, $this->solution['chatServiceSid']);
    }
    /**
