...
abstract class VerificationAttemptsSummaryOptions
{
     ...
     */
    public static function fetch(string $verifyServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $country = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $channel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $destinationPrefix = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\FetchVerificationAttemptsSummaryOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\FetchVerificationAttemptsSummaryOptions($verifyServiceSid, $dateCreatedAfter, $dateCreatedBefore, $country, $channel, $destinationPrefix);
    }
}
class FetchVerificationAttemptsSummaryOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $verifyServiceSid Filter used to consider only Verification Attempts of the given verify service on the summary aggregation.
     * @param \DateTime $dateCreatedAfter Datetime filter used to consider only Verification Attempts created after this datetime on the summary aggregation. Given as GMT in ISO 8601 formatted datetime string: yyyy-MM-dd'T'HH:mm:ss'Z.
     ...
     * @param string $destinationPrefix Filter the Verification Attempts considered on the summary aggregation by Destination prefix. It is the prefix of a phone number in E.164 format.
     */
    public function __construct(string $verifyServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $country = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $channel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $destinationPrefix = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
