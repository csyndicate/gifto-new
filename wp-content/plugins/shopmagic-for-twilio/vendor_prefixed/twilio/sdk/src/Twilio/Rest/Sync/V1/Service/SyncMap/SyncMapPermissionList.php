...
class SyncMapPermissionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SyncMapPermissionPage Page of SyncMapPermissionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionPage
    {
     ...
     */
    public function getContext(string $identity) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionContext($this->version, $this->solution['serviceSid'], $this->solution['mapSid'], $identity);
    }
    /**
