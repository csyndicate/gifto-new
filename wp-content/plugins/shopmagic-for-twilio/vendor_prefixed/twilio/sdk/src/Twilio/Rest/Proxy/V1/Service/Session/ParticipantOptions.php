...
abstract class ParticipantOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $proxyIdentifier = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $proxyIdentifierSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\CreateParticipantOptions
    {
...
class CreateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $proxyIdentifierSid The SID of the Proxy Identifier to assign to the Participant.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $proxyIdentifier = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $proxyIdentifierSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
