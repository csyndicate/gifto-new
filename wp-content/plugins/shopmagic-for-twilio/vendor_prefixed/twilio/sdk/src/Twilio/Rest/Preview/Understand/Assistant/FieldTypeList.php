...
class FieldTypeList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $uniqueName, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypeInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['UniqueName' => $uniqueName, 'FriendlyName' => $options['friendlyName']]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypeInstance($this->version, $payload, $this->solution['assistantSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypePage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return FieldTypePage Page of FieldTypeInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypePage
    {
     ...
     * @param string $sid 
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypeContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\FieldTypeContext($this->version, $this->solution['assistantSid'], $sid);
    }
    /**
