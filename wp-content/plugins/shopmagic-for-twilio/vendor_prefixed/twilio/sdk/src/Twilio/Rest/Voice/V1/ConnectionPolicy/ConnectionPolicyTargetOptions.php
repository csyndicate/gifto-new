...
abstract class ConnectionPolicyTargetOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $weight = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicy\CreateConnectionPolicyTargetOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicy\CreateConnectionPolicyTargetOptions($friendlyName, $priority, $weight, $enabled);
    }
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $target = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $weight = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicy\UpdateConnectionPolicyTargetOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicy\UpdateConnectionPolicyTargetOptions($friendlyName, $target, $priority, $weight, $enabled);
    }
}
class CreateConnectionPolicyTargetOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     * @param int $priority The relative importance of the target. Can be an integer from 0 to 65535, inclusive, and the default is 10. The lowest number represents the most important target.
     ...
     * @param bool $enabled Whether the Target is enabled. The default is `true`.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $weight = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class UpdateConnectionPolicyTargetOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     * @param string $target The SIP address you want Twilio to route your calls to. This must be a `sip:` schema. `sips` is NOT supported.
     ...
     * @param bool $enabled Whether the Target is enabled.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $target = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $weight = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
