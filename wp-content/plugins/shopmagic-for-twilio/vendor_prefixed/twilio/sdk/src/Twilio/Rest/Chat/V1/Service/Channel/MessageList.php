...
class MessageList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $body, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessageInstance
    {
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessagePage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessagePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return MessagePage Page of MessageInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessagePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessageContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessageContext($this->version, $this->solution['serviceSid'], $this->solution['channelSid'], $sid);
    }
    /**
