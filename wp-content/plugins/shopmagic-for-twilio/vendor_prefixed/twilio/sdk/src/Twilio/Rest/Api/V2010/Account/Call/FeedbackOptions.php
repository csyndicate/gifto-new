...
abstract class FeedbackOptions
{
     ...
     */
    public static function update(int $qualityScore = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $issue = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\UpdateFeedbackOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\UpdateFeedbackOptions($qualityScore, $issue);
    }
}
class UpdateFeedbackOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $issue One or more issues experienced during the call. The issues can be: `imperfect-audio`, `dropped-call`, `incorrect-caller-id`, `post-dial-delay`, `digits-not-captured`, `audio-latency`, `unsolicited-call`, or `one-way-audio`.
     */
    public function __construct(int $qualityScore = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $issue = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE)
    {
