...
class ReplaceItemsList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $fromBundleSid) : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\Bundle\ReplaceItemsInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['FromBundleSid' => $fromBundleSid]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\Bundle\ReplaceItemsInstance($this->version, $payload, $this->solution['bundleSid']);
    }
    /**
