...
class InteractionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sessionSid'], $this->solution['sid']);
    }
    /**
