...
class NumbersBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
     ...
     */
    protected function getV1() : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1
    {
        if (!$this->_v1) {
            $this->_v1 = new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1($this);
        }
        return $this->_v1;
    }
    /**
     ...
     */
    protected function getV2() : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2
    {
        if (!$this->_v2) {
