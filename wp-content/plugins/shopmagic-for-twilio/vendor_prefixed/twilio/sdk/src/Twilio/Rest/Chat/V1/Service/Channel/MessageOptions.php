...
abstract class MessageOptions
{
     ...
     */
    public static function create(string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\CreateMessageOptions
    {
     ...
     */
    public static function read(string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\ReadMessageOptions
    {
     ...
     */
    public static function update(string $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\UpdateMessageOptions
    {
