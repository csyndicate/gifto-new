...
use ShopMagicTwilioVendor\Twilio\Rest\Events\V1;
class Events extends \ShopMagicTwilioVendor\Twilio\Rest\EventsBase
{
    /**
     ...
     */
    protected function contextEventTypes(string $type) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\EventTypeContext
    {
     ...
     */
    protected function contextSchemas(string $id) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SchemaContext
    {
     ...
     */
    protected function contextSinks(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SinkContext
    {
     ...
     */
    protected function contextSubscriptions(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SubscriptionContext
    {
