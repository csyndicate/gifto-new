...
class ParticipantConversationList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ParticipantConversationPage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ParticipantConversationPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ParticipantConversationPage Page of ParticipantConversationInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ParticipantConversationPage
    {
