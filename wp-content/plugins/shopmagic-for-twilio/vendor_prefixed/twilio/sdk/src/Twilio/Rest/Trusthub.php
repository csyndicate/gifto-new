...
use ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1;
class Trusthub extends \ShopMagicTwilioVendor\Twilio\Rest\TrusthubBase
{
    /**
     ...
     */
    protected function contextCustomerProfiles(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\CustomerProfilesContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextEndUsers(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserContext
    {
     ...
     *                    resource
     */
    protected function contextEndUserTypes(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserTypeContext
    {
     ...
     */
    protected function contextPolicies(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\PoliciesContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSupportingDocuments(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentContext
    {
     ...
     *                    Type resource
     */
    protected function contextSupportingDocumentTypes(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext
    {
     ...
     * @param string $sid The unique string that identifies the resource.
     */
    protected function contextTrustProducts(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProductsContext
    {
