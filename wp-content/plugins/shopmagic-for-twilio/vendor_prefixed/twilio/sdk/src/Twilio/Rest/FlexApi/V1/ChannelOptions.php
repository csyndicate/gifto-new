...
abstract class ChannelOptions
{
     ...
     */
    public static function create(string $target = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chatUniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $preEngagementData = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $longLived = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\CreateChannelOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\CreateChannelOptions($target, $chatUniqueName, $preEngagementData, $taskSid, $taskAttributes, $longLived);
    }
}
class CreateChannelOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $longLived Whether to create the channel as long-lived.
     */
    public function __construct(string $target = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chatUniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $preEngagementData = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $longLived = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
