...
class AvailableAddOnList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return AvailableAddOnPage Page of AvailableAddOnInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext($this->version, $sid);
    }
    /**
