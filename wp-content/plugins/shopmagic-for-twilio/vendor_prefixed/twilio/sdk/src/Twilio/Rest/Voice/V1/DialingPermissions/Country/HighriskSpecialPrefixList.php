 ...
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\DialingPermissions\Country;

use ShopMagicTwilioVendor\Twilio\ListResource;
use ShopMagicTwilioVendor\Twilio\Stream;
use ShopMagicTwilioVendor\Twilio\Values;
use ShopMagicTwilioVendor\Twilio\Version;
class HighriskSpecialPrefixList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $isoCode)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\DialingPermissions\Country\HighriskSpecialPrefixPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\DialingPermissions\Country\HighriskSpecialPrefixPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return HighriskSpecialPrefixPage Page of HighriskSpecialPrefixInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\DialingPermissions\Country\HighriskSpecialPrefixPage
    {
