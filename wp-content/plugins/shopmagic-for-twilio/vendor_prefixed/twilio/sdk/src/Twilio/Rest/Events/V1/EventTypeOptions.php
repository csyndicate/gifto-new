...
abstract class EventTypeOptions
{
     ...
     */
    public static function read(string $schemaId = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\ReadEventTypeOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\ReadEventTypeOptions($schemaId);
    }
}
class ReadEventTypeOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $schemaId A string parameter filtering the results to return only the Event Types using a given schema.
     */
    public function __construct(string $schemaId = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
