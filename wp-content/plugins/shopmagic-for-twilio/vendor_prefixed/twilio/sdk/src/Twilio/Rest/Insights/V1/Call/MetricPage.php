...
class MetricPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\Call\MetricInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\Call\MetricInstance($this->version, $payload, $this->solution['callSid']);
    }
    /**
