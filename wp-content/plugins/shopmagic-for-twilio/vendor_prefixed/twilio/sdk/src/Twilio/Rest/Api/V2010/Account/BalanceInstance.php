...
class BalanceInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $accountSid)
    {
        ...
        $this->properties = ['accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'balance' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'balance'), 'currency' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'currency')];
