...
class ServiceContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    {
        if (!$this->_channels) {
            $this->_channels = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\ChannelList($this->version, $this->solution['sid']);
        }
    ...
    {
        if (!$this->_roles) {
            $this->_roles = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\RoleList($this->version, $this->solution['sid']);
        }
        return $this->_roles;
    }
    /**
    ...
    {
        if (!$this->_users) {
            $this->_users = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\UserList($this->version, $this->solution['sid']);
        }
        return $this->_users;
    }
    /**
