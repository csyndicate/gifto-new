...
class SupportingDocumentTypeInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\SupportingDocumentTypeContext
    {
        if (!$this->context) {
     ...
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\SupportingDocumentTypeInstance
    {
