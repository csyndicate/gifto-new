...
abstract class ConversationOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $messagingServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $state = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $timersInactive = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $timersClosed = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bindingsEmailAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bindingsEmailName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CreateConversationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CreateConversationOptions($friendlyName, $uniqueName, $dateCreated, $dateUpdated, $messagingServiceSid, $attributes, $state, $timersInactive, $timersClosed, $bindingsEmailAddress, $bindingsEmailName, $xTwilioWebhookEnabled);
    }
    /**
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     * @return DeleteConversationOptions Options builder
     */
    public static function delete(string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\DeleteConversationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\DeleteConversationOptions($xTwilioWebhookEnabled);
    }
    /**
     ...
     */
    public static function read(string $startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $state = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ReadConversationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ReadConversationOptions($startDate, $endDate, $state);
    }
    /**
     * @param string $friendlyName The human-readable name of this conversation, limited to 256 characters. Optional.
     * @param \DateTime $dateCreated The date that this resource was created.
...
class CreateConversationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $messagingServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $state = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $timersInactive = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $timersClosed = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bindingsEmailAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bindingsEmailName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
