...
class SubscribedTrackList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\Room\Participant\SubscribedTrackPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\Room\Participant\SubscribedTrackPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SubscribedTrackPage Page of SubscribedTrackInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\Room\Participant\SubscribedTrackPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\Room\Participant\SubscribedTrackContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\Room\Participant\SubscribedTrackContext($this->version, $this->solution['roomSid'], $this->solution['participantSid'], $sid);
    }
    /**
