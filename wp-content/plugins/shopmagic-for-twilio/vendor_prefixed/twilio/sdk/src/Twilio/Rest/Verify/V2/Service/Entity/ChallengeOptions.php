...
abstract class ChallengeOptions
{
     ...
     */
    public static function create(\DateTime $expirationDate = null, string $detailsMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $detailsFields = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $hiddenDetails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\CreateChallengeOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\CreateChallengeOptions($expirationDate, $detailsMessage, $detailsFields, $hiddenDetails, $authPayload);
    }
    /**
     ...
     */
    public static function read(string $factorSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\ReadChallengeOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\ReadChallengeOptions($factorSid, $status, $order);
    }
    /**
     ...
     */
    public static function update(string $authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $metadata = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\UpdateChallengeOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\UpdateChallengeOptions($authPayload, $metadata);
    }
}
class CreateChallengeOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $expirationDate The date-time when this Challenge expires, given in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. The default value is five (5) minutes after Challenge creation. The max value is sixty (60) minutes after creation.
     * @param string $detailsMessage Shown to the user when the push notification arrives. Required when `factor_type` is `push`. Can be up to 256 characters in length
     ...
     * @param string $authPayload Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to carry the TOTP code that needs to be verified. For `TOTP` this value must be between 3 and 8 characters long.
     */
    public function __construct(\DateTime $expirationDate = null, string $detailsMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $detailsFields = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $hiddenDetails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadChallengeOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $factorSid The unique SID identifier of the Factor.
     * @param string $status The Status of the Challenges to fetch. One of `pending`, `expired`, `approved` or `denied`.
     * @param string $order The desired sort order of the Challenges list. One of `asc` or `desc` for ascending and descending respectively. Defaults to `asc`.
     */
    public function __construct(string $factorSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateChallengeOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $authPayload The optional payload needed to verify the Challenge. E.g., a TOTP would use the numeric code. For `TOTP` this value must be between 3 and 8 characters long. For `Push` this value can be up to 5456 characters in length
     * @param array $metadata Custom metadata associated with the challenge. This is added by the Device/SDK directly to allow for the inclusion of device information. It must be a stringified JSON with only strings values eg. `{\\\"os\\\": \\\"Android\\\"}`. Can be up to 1024 characters in length.
     */
    public function __construct(string $authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $metadata = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE)
    {
        $this->options['authPayload'] = $authPayload;
