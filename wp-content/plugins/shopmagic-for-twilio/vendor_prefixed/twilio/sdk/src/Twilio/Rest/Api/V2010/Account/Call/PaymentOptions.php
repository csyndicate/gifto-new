...
abstract class PaymentOptions
{
     ...
     */
    public static function create(string $bankAccountType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chargeAmount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $currency = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $description = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $input = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $minPostalCodeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $parameter = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $paymentConnector = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $paymentMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $postalCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $securityCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $tokenType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $validCardTypes = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreatePaymentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreatePaymentOptions($bankAccountType, $chargeAmount, $currency, $description, $input, $minPostalCodeLength, $parameter, $paymentConnector, $paymentMethod, $postalCode, $securityCode, $timeout, $tokenType, $validCardTypes);
    }
    /**
     ...
     */
    public static function update(string $capture = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\UpdatePaymentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\UpdatePaymentOptions($capture, $status);
    }
}
class CreatePaymentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $bankAccountType
     * @param string $chargeAmount A positive decimal value less than 1,000,000 to charge against the credit card or bank account. Default currency can be overwritten with `currency` field. Leave blank or set to 0 to tokenize.
     ...
     * @param string $validCardTypes Credit card types separated by space that Pay should accept. The default value is `visa mastercard amex`
     */
    public function __construct(string $bankAccountType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $chargeAmount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $currency = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $description = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $input = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $minPostalCodeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $parameter = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $paymentConnector = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $paymentMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $postalCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $securityCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $tokenType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $validCardTypes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdatePaymentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $capture
     * @param string $status
     */
    public function __construct(string $capture = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
