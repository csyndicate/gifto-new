...
abstract class ByocTrunkOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $connectionPolicySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fromDomainSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\CreateByocTrunkOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\CreateByocTrunkOptions($friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl, $voiceFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $cnamLookupEnabled, $connectionPolicySid, $fromDomainSid);
    }
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     * @param string $voiceUrl The URL we should call when the BYOC Trunk receives a call.
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $connectionPolicySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fromDomainSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\UpdateByocTrunkOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\UpdateByocTrunkOptions($friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl, $voiceFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $cnamLookupEnabled, $connectionPolicySid, $fromDomainSid);
    }
}
class CreateByocTrunkOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     * @param string $voiceUrl The URL we should call when the BYOC Trunk receives a call.
...
class UpdateByocTrunkOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     * @param string $voiceUrl The URL we should call when the BYOC Trunk receives a call.
