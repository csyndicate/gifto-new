...
abstract class MessageOptions
{
     ...
     */
    public static function create(string $author = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $mediaSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $contentSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $contentVariables = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $subject = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\CreateMessageOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\CreateMessageOptions($author, $body, $dateCreated, $dateUpdated, $attributes, $mediaSid, $contentSid, $contentVariables, $subject, $xTwilioWebhookEnabled);
    }
    /**
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     * @return DeleteMessageOptions Options builder
     */
    public static function delete(string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\DeleteMessageOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\DeleteMessageOptions($xTwilioWebhookEnabled);
    }
    /**
     ...
     */
    public static function read(string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\ReadMessageOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\ReadMessageOptions($order);
    }
    /**
     * @param string $author The channel specific identifier of the message's author. Defaults to `system`.
     * @param string $body The content of the message, can be up to 1,600 characters long.
     ...
     */
    public static function update(string $author = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $subject = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\UpdateMessageOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\UpdateMessageOptions($author, $body, $dateCreated, $dateUpdated, $attributes, $subject, $xTwilioWebhookEnabled);
    }
}
