...
class WebhookList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $target, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\WebhookInstance
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\WebhookPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\WebhookPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return WebhookPage Page of WebhookInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\WebhookPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\WebhookContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\WebhookContext($this->version, $this->solution['conversationSid'], $sid);
    }
    /**
