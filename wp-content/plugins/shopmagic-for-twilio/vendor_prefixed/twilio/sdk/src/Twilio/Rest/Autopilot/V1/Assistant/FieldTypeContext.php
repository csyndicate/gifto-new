...
class FieldTypeContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\FieldTypeInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\FieldTypeInstance($this->version, $payload, $this->solution['assistantSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getFieldValues() : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\FieldType\FieldValueList
    {
        if (!$this->_fieldValues) {
            $this->_fieldValues = new \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\FieldType\FieldValueList($this->version, $this->solution['assistantSid'], $this->solution['sid']);
        }
