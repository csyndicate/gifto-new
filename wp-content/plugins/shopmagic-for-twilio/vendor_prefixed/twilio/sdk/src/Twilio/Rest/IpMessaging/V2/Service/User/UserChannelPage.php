...
class UserChannelPage extends \ShopMagicTwilioVendor\Twilio\Page
{
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\User\UserChannelInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\User\UserChannelInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['userSid']);
    }
    /**
