...
use ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\ServiceList;
use ShopMagicTwilioVendor\Twilio\Version;
/**
 * @property ServiceList $services
 * @method \Twilio\Rest\Preview\Sync\ServiceContext services(string $sid)
 */
class Sync extends \ShopMagicTwilioVendor\Twilio\Version
{
    protected $_services;
    /**
    ...
    {
        if (!$this->_services) {
            $this->_services = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\ServiceList($this);
        }
