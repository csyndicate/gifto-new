...
class SyncListPermissionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['listSid'], $this->solution['identity']);
    }
    /**
