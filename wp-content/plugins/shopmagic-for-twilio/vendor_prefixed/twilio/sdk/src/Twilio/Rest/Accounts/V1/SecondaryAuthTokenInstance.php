 ...
 */
class SecondaryAuthTokenInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\SecondaryAuthTokenContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\SecondaryAuthTokenContext($this->version);
        }
        return $this->context;
    }
    /**
     ...
     */
    public function create() : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\SecondaryAuthTokenInstance
    {
