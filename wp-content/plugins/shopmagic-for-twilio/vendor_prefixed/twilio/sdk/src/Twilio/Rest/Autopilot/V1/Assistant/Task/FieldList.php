...
class FieldList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $fieldType, string $uniqueName) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\Task\FieldInstance
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\Task\FieldPage
    {
     ...
     * @return FieldPage Page of FieldInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\Task\FieldPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\Task\FieldContext
    {
