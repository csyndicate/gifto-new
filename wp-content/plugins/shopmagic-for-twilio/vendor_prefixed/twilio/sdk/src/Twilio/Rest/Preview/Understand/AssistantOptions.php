...
abstract class AssistantOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $fallbackActions = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $initiationActions = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\CreateAssistantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\CreateAssistantOptions($friendlyName, $logQueries, $uniqueName, $callbackUrl, $callbackEvents, $fallbackActions, $initiationActions, $styleSheet);
    }
    /**
     * @param string $friendlyName A text description for the Assistant. It is non-unique and can up to 255 characters long.
     * @param bool $logQueries A boolean that specifies whether queries should be logged for 30 days further training. If false, no queries will be stored, if true, queries will be stored for 30 days and deleted thereafter. Defaults to true if no value is provided.
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $fallbackActions = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $initiationActions = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\UpdateAssistantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\UpdateAssistantOptions($friendlyName, $logQueries, $uniqueName, $callbackUrl, $callbackEvents, $fallbackActions, $initiationActions, $styleSheet);
    }
}
class CreateAssistantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param array $styleSheet The JSON object that holds the style sheet for the assistant
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $fallbackActions = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $initiationActions = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE)
    {
