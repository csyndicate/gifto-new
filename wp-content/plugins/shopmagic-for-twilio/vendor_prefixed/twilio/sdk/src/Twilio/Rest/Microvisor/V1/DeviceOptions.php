...
abstract class DeviceOptions
{
     ...
     */
    public static function update(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $targetApp = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $loggingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $restartApp = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\UpdateDeviceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\UpdateDeviceOptions($uniqueName, $targetApp, $loggingEnabled, $restartApp);
    }
}
class UpdateDeviceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $restartApp Set to true to restart the App running on the Device.
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $targetApp = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $loggingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $restartApp = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
