...
class PublicKeyList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $publicKey, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['PublicKey' => $publicKey, 'FriendlyName' => $options['friendlyName'], 'AccountSid' => $options['accountSid']]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return PublicKeyPage Page of PublicKeyInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyContext($this->version, $sid);
    }
    /**
