 ...
 */
class SchemaContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    protected $_versions;
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $id)
    {
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SchemaInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SchemaInstance($this->version, $payload, $this->solution['id']);
    }
    /**
     * Access the versions
     */
    ...
    {
        if (!$this->_versions) {
            $this->_versions = new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Schema\SchemaVersionList($this->version, $this->solution['id']);
        }
