...
abstract class DeactivationsOptions
{
     ...
     */
    public static function fetch(\DateTime $date = null) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\FetchDeactivationsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\FetchDeactivationsOptions($date);
    }
}
class FetchDeactivationsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $date The request will return a list of all United States Phone Numbers that were deactivated on the day specified by this parameter. This date should be specified in YYYY-MM-DD format.
     */
