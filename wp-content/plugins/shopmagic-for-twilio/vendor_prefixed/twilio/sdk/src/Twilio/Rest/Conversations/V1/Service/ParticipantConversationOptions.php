...
abstract class ParticipantConversationOptions
{
     ...
     */
    public static function read(string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $address = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\ReadParticipantConversationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\ReadParticipantConversationOptions($identity, $address);
    }
}
class ReadParticipantConversationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $identity A unique string identifier for the conversation participant as [Conversation User](https://www.twilio.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversations SDK to communicate. Limited to 256 characters.
     * @param string $address A unique string identifier for the conversation participant who's not a Conversation User. This parameter could be found in messaging_binding.address field of Participant resource. It should be url-encoded.
     */
    public function __construct(string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $address = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
