...
abstract class CommandOptions
{
     ...
     */
    public static function create(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $commandMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $includeSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $deliveryReceiptRequested = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\CreateCommandOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\CreateCommandOptions($sim, $callbackMethod, $callbackUrl, $commandMode, $includeSid, $deliveryReceiptRequested);
    }
    /**
     ...
     */
    public static function read(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $transport = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\ReadCommandOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\ReadCommandOptions($sim, $status, $direction, $transport);
    }
}
class CreateCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $deliveryReceiptRequested Whether to request delivery receipt from the recipient. For Commands that request delivery receipt, the Command state transitions to 'delivered' once the server has received a delivery receipt from the device. The default value is `true`.
     */
    public function __construct(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $commandMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $includeSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $deliveryReceiptRequested = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class ReadCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $transport Only return Commands with this transport value. Can be: `sms` or `ip`.
     */
    public function __construct(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $transport = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['sim'] = $sim;
