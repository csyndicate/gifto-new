...
class SyncListContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncListInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncListInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getSyncListPermissions() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncList\SyncListPermissionList
    {
        if (!$this->_syncListPermissions) {
            $this->_syncListPermissions = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncList\SyncListPermissionList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
    ...
    protected function getSyncListItems() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncList\SyncListItemList
    {
        if (!$this->_syncListItems) {
            $this->_syncListItems = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncList\SyncListItemList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
