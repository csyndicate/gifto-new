...
class MessageInteractionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $serviceSid, $sessionSid, $participantSid, $sid)
    {
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\Participant\MessageInteractionInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\Participant\MessageInteractionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sessionSid'], $this->solution['participantSid'], $this->solution['sid']);
    }
    /**
