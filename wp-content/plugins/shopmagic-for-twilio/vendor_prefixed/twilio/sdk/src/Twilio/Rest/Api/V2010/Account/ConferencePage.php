...
class ConferencePage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ConferenceInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ConferenceInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
