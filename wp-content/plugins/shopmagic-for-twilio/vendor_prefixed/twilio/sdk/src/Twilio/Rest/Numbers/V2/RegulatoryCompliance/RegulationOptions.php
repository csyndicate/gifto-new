...
abstract class RegulationOptions
{
     ...
     */
    public static function read(string $endUserType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $isoCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $numberType = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\ReadRegulationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\ReadRegulationOptions($endUserType, $isoCountry, $numberType);
    }
}
class ReadRegulationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $endUserType The type of End User the regulation requires - can be `individual` or `business`.
     * @param string $isoCountry The ISO country code of the phone number's country.
     * @param string $numberType The type of phone number that the regulatory requiremnt is restricting.
     */
    public function __construct(string $endUserType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $isoCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $numberType = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
