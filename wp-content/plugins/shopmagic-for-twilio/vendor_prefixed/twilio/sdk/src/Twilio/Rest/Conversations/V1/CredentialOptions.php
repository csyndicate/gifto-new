...
abstract class CredentialOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $certificate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $privateKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sandbox = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $apiKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $secret = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CreateCredentialOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CreateCredentialOptions($friendlyName, $certificate, $privateKey, $sandbox, $apiKey, $secret);
    }
    /**
     * @param string $type
     * @param string $friendlyName A descriptive string that you create to describe the new resource. It can be up to 64 characters long.
     ...
     */
    public static function update(string $type = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $certificate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $privateKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sandbox = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $apiKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $secret = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UpdateCredentialOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UpdateCredentialOptions($type, $friendlyName, $certificate, $privateKey, $sandbox, $apiKey, $secret);
    }
}
...
class UpdateCredentialOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $secret [FCM only] The **Server key** of your project from the Firebase console, found under Settings / Cloud messaging.
     */
    public function __construct(string $type = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $certificate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $privateKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sandbox = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $apiKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $secret = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
