...
abstract class DomainOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $emergencyCallingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $byocTrunkSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyCallerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CreateDomainOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CreateDomainOptions($friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl, $voiceFallbackMethod, $voiceStatusCallbackUrl, $voiceStatusCallbackMethod, $sipRegistration, $emergencyCallingEnabled, $secure, $byocTrunkSid, $emergencyCallerSid);
    }
    /**
     * @param string $friendlyName A descriptive string that you created to describe the resource. It can be up to 64 characters long.
     * @param string $voiceFallbackMethod The HTTP method we should use to call `voice_fallback_url`. Can be: `GET` or `POST`.
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $emergencyCallingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $byocTrunkSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyCallerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\UpdateDomainOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\UpdateDomainOptions($friendlyName, $voiceFallbackMethod, $voiceFallbackUrl, $voiceMethod, $voiceStatusCallbackMethod, $voiceStatusCallbackUrl, $voiceUrl, $sipRegistration, $domainName, $emergencyCallingEnabled, $secure, $byocTrunkSid, $emergencyCallerSid);
    }
}
class CreateDomainOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you created to describe the resource. It can be up to 64 characters long.
     * @param string $voiceUrl The URL we should when the domain receives a call.
     ...
     * @param string $emergencyCallerSid Whether an emergency caller sid is configured for the domain. If present, this phone number will be used as the callback for the emergency call.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $emergencyCallingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $byocTrunkSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyCallerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateDomainOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you created to describe the resource. It can be up to 64 characters long.
     * @param string $voiceFallbackMethod The HTTP method we should use to call `voice_fallback_url`. Can be: `GET` or `POST`.
     ...
     * @param string $emergencyCallerSid Whether an emergency caller sid is configured for the domain. If present, this phone number will be used as the callback for the emergency call.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $emergencyCallingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $byocTrunkSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $emergencyCallerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
        $this->options['voiceFallbackMethod'] = $voiceFallbackMethod;
        $this->options['voiceFallbackUrl'] = $voiceFallbackUrl;
