...
abstract class RecordingOptions
{
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $groupingSid = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $mediaType = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadRecordingOptions($status, $sourceSid, $groupingSid, $dateCreatedAfter, $dateCreatedBefore, $mediaType);
    }
}
class ReadRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $mediaType Read only recordings that have this media type. Can be either `audio` or `video`.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $groupingSid = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $mediaType = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
