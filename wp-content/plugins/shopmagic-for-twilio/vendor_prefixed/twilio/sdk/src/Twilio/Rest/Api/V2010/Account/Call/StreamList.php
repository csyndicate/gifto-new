...
class StreamList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\StreamContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\StreamContext($this->version, $this->solution['accountSid'], $this->solution['callSid'], $sid);
    }
    /**
