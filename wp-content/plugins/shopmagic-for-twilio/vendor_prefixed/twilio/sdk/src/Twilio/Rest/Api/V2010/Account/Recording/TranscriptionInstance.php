...
class TranscriptionInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $accountSid, string $recordingSid, string $sid = null)
    {
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionContext
    {
        if (!$this->context) {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance
    {
