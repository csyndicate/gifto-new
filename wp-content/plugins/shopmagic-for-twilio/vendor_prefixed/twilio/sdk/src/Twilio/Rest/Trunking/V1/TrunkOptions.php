...
abstract class TrunkOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $disasterRecoveryUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $disasterRecoveryMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $transferMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $transferCallerId = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\CreateTrunkOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\CreateTrunkOptions($friendlyName, $domainName, $disasterRecoveryUrl, $disasterRecoveryMethod, $transferMode, $secure, $cnamLookupEnabled, $transferCallerId);
    }
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It can be up to 64 characters long.
     * @param string $domainName The unique address you reserve on Twilio to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.twilio.com`. See [Termination Settings](https://www.twilio.com/docs/sip-trunking#termination) for more information.
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $disasterRecoveryUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $disasterRecoveryMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $transferMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $transferCallerId = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\UpdateTrunkOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\UpdateTrunkOptions($friendlyName, $domainName, $disasterRecoveryUrl, $disasterRecoveryMethod, $transferMode, $secure, $cnamLookupEnabled, $transferCallerId);
    }
}
class CreateTrunkOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It can be up to 64 characters long.
     * @param string $domainName The unique address you reserve on Twilio to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.twilio.com`. See [Termination Settings](https://www.twilio.com/docs/sip-trunking#termination) for more information.
     ...
     * @param string $transferCallerId
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $disasterRecoveryUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $disasterRecoveryMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $transferMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $secure = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $transferCallerId = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateTrunkOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It can be up to 64 characters long.
     * @param string $domainName The unique address you reserve on Twilio to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.twilio.com`. See [Termination Settings](https://www.twilio.com/docs/sip-trunking#termination) for more information.
