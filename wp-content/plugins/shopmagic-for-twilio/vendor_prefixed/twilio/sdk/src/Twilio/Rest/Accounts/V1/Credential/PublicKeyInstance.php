 ...
 */
class PublicKeyInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyContext($this->version, $this->solution['sid']);
        }
        return $this->context;
    }
    /**
