...
abstract class ConfigurationOptions
{
     ...
     */
    public static function update(string $defaultConversationCreatorRoleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultConversationRoleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultChatServiceRoleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $reachabilityEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\UpdateConfigurationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\UpdateConfigurationOptions($defaultConversationCreatorRoleSid, $defaultConversationRoleSid, $defaultChatServiceRoleSid, $reachabilityEnabled);
    }
}
class UpdateConfigurationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $defaultConversationCreatorRoleSid The conversation-level role assigned to a conversation creator when they join a new conversation. See [Conversation Role](https://www.twilio.com/docs/conversations/api/role-resource) for more info about roles.
     * @param string $defaultConversationRoleSid The conversation-level role assigned to users when they are added to a conversation. See [Conversation Role](https://www.twilio.com/docs/conversations/api/role-resource) for more info about roles.
     ...
     * @param bool $reachabilityEnabled Whether the [Reachability Indicator](https://www.twilio.com/docs/conversations/reachability) is enabled for this Conversations Service. The default is `false`.
     */
    public function __construct(string $defaultConversationCreatorRoleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultConversationRoleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultChatServiceRoleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $reachabilityEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
