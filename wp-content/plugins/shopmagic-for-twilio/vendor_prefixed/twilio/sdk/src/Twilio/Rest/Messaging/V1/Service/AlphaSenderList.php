...
class AlphaSenderList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $alphaSender) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['AlphaSender' => $alphaSender]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return AlphaSenderPage Page of AlphaSenderInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderContext($this->version, $this->solution['serviceSid'], $sid);
    }
    /**
