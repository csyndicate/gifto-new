...
class BulkCountryUpdateInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload)
    {
        ...
        $this->properties = ['updateCount' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'update_count'), 'updateRequest' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'update_request')];
        $this->solution = [];
    }
    /**
