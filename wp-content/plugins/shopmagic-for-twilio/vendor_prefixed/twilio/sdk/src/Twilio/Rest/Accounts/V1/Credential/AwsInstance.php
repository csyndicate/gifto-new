 ...
 */
class AwsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\AwsContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\AwsContext($this->version, $this->solution['sid']);
        }
        return $this->context;
    }
    /**
