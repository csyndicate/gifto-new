...
abstract class OriginationUrlOptions
{
     ...
     */
    public static function update(int $weight = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\UpdateOriginationUrlOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\UpdateOriginationUrlOptions($weight, $priority, $enabled, $friendlyName, $sipUrl);
    }
}
class UpdateOriginationUrlOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $weight The value that determines the relative share of the load the URI should receive compared to other URIs with the same priority. Can be an integer from 1 to 65535, inclusive, and the default is 10. URLs with higher values receive more load than those with lower ones with the same priority.
     * @param int $priority The relative importance of the URI. Can be an integer from 0 to 65535, inclusive, and the default is 10. The lowest number represents the most important URI.
     ...
     * @param string $sipUrl The SIP address you want Twilio to route your Origination calls to. This must be a `sip:` schema. `sips` is NOT supported.
     */
    public function __construct(int $weight = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $priority = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
