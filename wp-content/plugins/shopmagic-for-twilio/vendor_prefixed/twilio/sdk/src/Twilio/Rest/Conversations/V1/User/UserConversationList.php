...
class UserConversationList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $userSid)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return UserConversationPage Page of UserConversationInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationPage
    {
     ...
     */
    public function getContext(string $conversationSid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationContext($this->version, $this->solution['userSid'], $conversationSid);
    }
    /**
