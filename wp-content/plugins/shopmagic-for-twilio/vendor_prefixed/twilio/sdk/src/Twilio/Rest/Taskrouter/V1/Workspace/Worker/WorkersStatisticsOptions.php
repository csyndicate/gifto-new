...
abstract class WorkersStatisticsOptions
{
     ...
     */
    public static function fetch(int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $startDate = null, \DateTime $endDate = null, string $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Worker\FetchWorkersStatisticsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Worker\FetchWorkersStatisticsOptions($minutes, $startDate, $endDate, $taskQueueSid, $taskQueueName, $friendlyName, $taskChannel);
    }
}
class FetchWorkersStatisticsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $minutes Only calculate statistics since this many minutes in the past. The default 15 minutes. This is helpful for displaying statistics for the last 15 minutes, 240 minutes (4 hours), and 480 minutes (8 hours) to see trends.
     * @param \DateTime $startDate Only calculate statistics from this date and time and later, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     ...
     * @param string $taskChannel Only calculate statistics on this TaskChannel. Can be the TaskChannel's SID or its `unique_name`, such as `voice`, `sms`, or `default`.
     */
    public function __construct(int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $startDate = null, \DateTime $endDate = null, string $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
