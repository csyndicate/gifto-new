...
class SourceIpMappingList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $ipRecordSid, string $sipDomainSid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['IpRecordSid' => $ipRecordSid, 'SipDomainSid' => $sipDomainSid]);
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SourceIpMappingPage Page of SourceIpMappingInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingContext($this->version, $sid);
    }
    /**
