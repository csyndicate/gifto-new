...
class ExecutionStepList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $flowSid, string $executionSid)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionStepPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionStepPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ExecutionStepPage Page of ExecutionStepInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionStepPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionStepContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionStepContext($this->version, $this->solution['flowSid'], $this->solution['executionSid'], $sid);
    }
    /**
