...
class SyncMapContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMapInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMapInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getSyncMapItems() : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapItemList
    {
        if (!$this->_syncMapItems) {
            $this->_syncMapItems = new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapItemList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
    ...
    protected function getSyncMapPermissions() : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionList
    {
        if (!$this->_syncMapPermissions) {
            $this->_syncMapPermissions = new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
