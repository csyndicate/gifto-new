...
class UserContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\UserInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\UserInstance($this->version, $payload, $this->solution['chatServiceSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getUserConversations() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\User\UserConversationList
    {
        if (!$this->_userConversations) {
            $this->_userConversations = new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\User\UserConversationList($this->version, $this->solution['chatServiceSid'], $this->solution['sid']);
        }
