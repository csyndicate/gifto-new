...
class PhoneNumberList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Sid' => $options['sid'], 'PhoneNumber' => $options['phoneNumber'], 'IsReserved' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['isReserved'])]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return PhoneNumberPage Page of PhoneNumberInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\PhoneNumberContext($this->version, $this->solution['serviceSid'], $sid);
    }
    /**
