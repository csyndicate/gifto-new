...
class ServiceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServiceInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServiceInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServicePage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServicePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ServicePage Page of ServiceInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServicePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServiceContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\ServiceContext($this->version, $sid);
    }
    /**
