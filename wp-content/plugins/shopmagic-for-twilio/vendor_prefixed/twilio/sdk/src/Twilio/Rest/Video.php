...
use ShopMagicTwilioVendor\Twilio\Rest\Video\V1;
class Video extends \ShopMagicTwilioVendor\Twilio\Rest\VideoBase
{
    /**
     ...
     */
    protected function contextCompositions(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CompositionContext
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextCompositionHooks(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CompositionHookContext
    {
     ...
     * @deprecated Use v1->compositionSettings() instead.
     */
    protected function contextCompositionSettings() : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CompositionSettingsContext
    {
        echo "compositionSettings() is deprecated. Use v1->compositionSettings() instead.";
        return $this->v1->compositionSettings();
    }
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRecordings(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\RecordingContext
    {
     ...
     * @deprecated Use v1->recordingSettings() instead.
     */
    protected function contextRecordingSettings() : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\RecordingSettingsContext
    {
        echo "recordingSettings() is deprecated. Use v1->recordingSettings() instead.";
        return $this->v1->recordingSettings();
    }
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRooms(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\RoomContext
    {
