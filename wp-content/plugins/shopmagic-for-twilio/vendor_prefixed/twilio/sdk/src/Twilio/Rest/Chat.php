...
class Chat extends \ShopMagicTwilioVendor\Twilio\Rest\ChatBase
{
    /**
     * @deprecated Use v2->credentials instead.
     */
    protected function getCredentials() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\CredentialContext
    {
     ...
     */
    protected function getServices() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\ServiceContext
    {
     ...
     */
    protected function contextChannels(string $serviceSid, string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V3\ChannelContext
    {
