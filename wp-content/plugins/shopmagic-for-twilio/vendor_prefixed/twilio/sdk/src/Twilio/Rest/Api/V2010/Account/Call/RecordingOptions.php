...
abstract class RecordingOptions
{
     ...
     */
    public static function create(array $recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingTrack = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateRecordingOptions($recordingStatusCallbackEvent, $recordingStatusCallback, $recordingStatusCallbackMethod, $trim, $recordingChannels, $recordingTrack);
    }
    /**
     ...
     */
    public static function read(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\ReadRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\ReadRecordingOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter);
    }
    /**
     ...
     */
    public static function update(string $pauseBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\UpdateRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\UpdateRecordingOptions($pauseBehavior);
    }
}
class CreateRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string[] $recordingStatusCallbackEvent The recording status events on which we should call the `recording_status_callback` URL. Can be: `in-progress`, `completed` and `absent` and the default is `completed`. Separate multiple event values with a space.
     * @param string $recordingStatusCallback The URL we should call using the `recording_status_callback_method` on each recording event specified in  `recording_status_callback_event`. For more information, see [RecordingStatusCallback parameters](https://www.twilio.com/docs/voice/api/recording#recordingstatuscallback).
     ...
     * @param string $recordingTrack The audio track to record for the call. Can be: `inbound`, `outbound` or `both`. The default is `both`. `inbound` records the audio that is received by Twilio. `outbound` records the audio that is generated from Twilio. `both` records the audio that is received and generated by Twilio.
     */
    public function __construct(array $recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingTrack = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $dateCreatedBefore The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. You can also specify inequality: `DateCreated<=YYYY-MM-DD` will return recordings generated at or before midnight on a given date, and `DateCreated>=YYYY-MM-DD` returns recordings generated at or after midnight on a date.
     * @param string $dateCreated The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. You can also specify inequality: `DateCreated<=YYYY-MM-DD` will return recordings generated at or before midnight on a given date, and `DateCreated>=YYYY-MM-DD` returns recordings generated at or after midnight on a date.
     * @param string $dateCreatedAfter The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. You can also specify inequality: `DateCreated<=YYYY-MM-DD` will return recordings generated at or before midnight on a given date, and `DateCreated>=YYYY-MM-DD` returns recordings generated at or after midnight on a date.
     */
    public function __construct(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null)
    {
...
class UpdateRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $pauseBehavior Whether to record during a pause. Can be: `skip` or `silence` and the default is `silence`. `skip` does not record during the pause period, while `silence` will replace the actual audio of the call with silence during the pause period. This parameter only applies when setting `status` is set to `paused`.
     */
    public function __construct(string $pauseBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
