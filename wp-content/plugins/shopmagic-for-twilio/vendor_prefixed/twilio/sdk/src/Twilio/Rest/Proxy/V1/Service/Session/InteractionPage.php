...
class InteractionPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sessionSid']);
    }
    /**
