...
class NetworkAccessProfileNetworkContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $networkAccessProfileSid, $sid)
    {
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\NetworkAccessProfile\NetworkAccessProfileNetworkInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\NetworkAccessProfile\NetworkAccessProfileNetworkInstance($this->version, $payload, $this->solution['networkAccessProfileSid'], $this->solution['sid']);
    }
    /**
