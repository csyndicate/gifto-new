...
abstract class ServiceOptions
{
     ...
     */
    public static function create(string $inboundRequestUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inboundMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $stickySender = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $mmsConverter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $smartEncoding = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $scanMessageContent = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $fallbackToLongCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $areaCodeGeomatch = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $validityPeriod = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $synchronousValidation = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $usecase = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\CreateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\CreateServiceOptions($inboundRequestUrl, $inboundMethod, $fallbackUrl, $fallbackMethod, $statusCallback, $stickySender, $mmsConverter, $smartEncoding, $scanMessageContent, $fallbackToLongCode, $areaCodeGeomatch, $validityPeriod, $synchronousValidation, $usecase, $useInboundWebhookOnNumber);
    }
    /**
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inboundRequestUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inboundMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $stickySender = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $mmsConverter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $smartEncoding = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $scanMessageContent = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $fallbackToLongCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $areaCodeGeomatch = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $validityPeriod = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $synchronousValidation = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $usecase = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\UpdateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\UpdateServiceOptions($friendlyName, $inboundRequestUrl, $inboundMethod, $fallbackUrl, $fallbackMethod, $statusCallback, $stickySender, $mmsConverter, $smartEncoding, $scanMessageContent, $fallbackToLongCode, $areaCodeGeomatch, $validityPeriod, $synchronousValidation, $usecase, $useInboundWebhookOnNumber);
    }
}
class CreateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $useInboundWebhookOnNumber A boolean value that indicates either the webhook url configured on the phone number will be used or `inbound_request_url`/`fallback_url` url will be called when a message is received from the phone number. If this field is enabled then the webhook url defined on the phone number will override the `inbound_request_url`/`fallback_url` defined for the Messaging Service.
     */
    public function __construct(string $inboundRequestUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inboundMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $stickySender = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $mmsConverter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $smartEncoding = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $scanMessageContent = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $fallbackToLongCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $areaCodeGeomatch = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $validityPeriod = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $synchronousValidation = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $usecase = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class UpdateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $useInboundWebhookOnNumber A boolean value that indicates either the webhook url configured on the phone number will be used or `inbound_request_url`/`fallback_url` url will be called when a message is received from the phone number. If this field is enabled then the webhook url defined on the phone number will override the `inbound_request_url`/`fallback_url` defined for the Messaging Service.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inboundRequestUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $inboundMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $stickySender = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $mmsConverter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $smartEncoding = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $scanMessageContent = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $fallbackToLongCode = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $areaCodeGeomatch = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $validityPeriod = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $synchronousValidation = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $usecase = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
