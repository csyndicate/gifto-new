...
abstract class NotificationOptions
{
     ...
     */
    public static function read(int $log = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $messageDateBefore = null, string $messageDate = null, string $messageDateAfter = null) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\ReadNotificationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\ReadNotificationOptions($log, $messageDateBefore, $messageDate, $messageDateAfter);
    }
}
