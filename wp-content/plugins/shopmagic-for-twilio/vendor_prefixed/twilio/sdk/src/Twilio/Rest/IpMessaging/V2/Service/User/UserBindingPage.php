...
class UserBindingPage extends \ShopMagicTwilioVendor\Twilio\Page
{
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\User\UserBindingInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\User\UserBindingInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['userSid']);
    }
    /**
