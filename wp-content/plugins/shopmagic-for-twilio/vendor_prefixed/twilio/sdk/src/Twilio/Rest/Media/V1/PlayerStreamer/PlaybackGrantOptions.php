...
abstract class PlaybackGrantOptions
{
     ...
     */
    public static function create(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $accessControlAllowOrigin = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\PlayerStreamer\CreatePlaybackGrantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\PlayerStreamer\CreatePlaybackGrantOptions($ttl, $accessControlAllowOrigin);
    }
}
class CreatePlaybackGrantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $ttl The time to live of the PlaybackGrant. Default value is 15 seconds. Maximum value is 60 seconds.
     * @param string $accessControlAllowOrigin The full origin URL where the livestream can be streamed. If this is not provided, it can be streamed from any domain.
     */
    public function __construct(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $accessControlAllowOrigin = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
