...
class AssetVersionPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Asset\AssetVersionInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Asset\AssetVersionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['assetSid']);
    }
    /**
