...
class ArchivedCallInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, \DateTime $date = null, string $sid = null)
    {
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ArchivedCallContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ArchivedCallContext($this->version, $this->solution['date'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
