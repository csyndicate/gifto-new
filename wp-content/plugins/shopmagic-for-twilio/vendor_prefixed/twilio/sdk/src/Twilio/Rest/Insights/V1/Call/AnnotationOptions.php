...
abstract class AnnotationOptions
{
     ...
     */
    public static function update(string $answeredBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $connectivityIssue = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $qualityIssues = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $spam = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $callScore = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $comment = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $incident = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\Call\UpdateAnnotationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\Call\UpdateAnnotationOptions($answeredBy, $connectivityIssue, $qualityIssues, $spam, $callScore, $comment, $incident);
    }
}
class UpdateAnnotationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $answeredBy
     * @param string $connectivityIssue
     ...
     * @param string $incident Associate this call with an incident or support ticket. The `incident` parameter is of type string with a maximum character limit of 100. Twilio does not treat this field as PII, so no PII should be included in `incident`.
     */
    public function __construct(string $answeredBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $connectivityIssue = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $qualityIssues = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $spam = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $callScore = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $comment = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $incident = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
