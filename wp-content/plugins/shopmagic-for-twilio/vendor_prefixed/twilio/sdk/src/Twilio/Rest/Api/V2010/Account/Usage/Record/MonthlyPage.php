...
class MonthlyPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\MonthlyInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\MonthlyInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
