 ...
 */
class AlphaSenderInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderContext($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\AlphaSenderInstance
    {
