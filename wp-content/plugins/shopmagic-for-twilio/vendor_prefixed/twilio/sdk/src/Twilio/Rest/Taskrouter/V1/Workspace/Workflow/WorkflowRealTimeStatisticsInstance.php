 ...
 */
class WorkflowRealTimeStatisticsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $workspaceSid, string $workflowSid)
    {
        ...
        $this->properties = ['accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'longestTaskWaitingAge' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'longest_task_waiting_age'), 'longestTaskWaitingSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'longest_task_waiting_sid'), 'tasksByPriority' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'tasks_by_priority'), 'tasksByStatus' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'tasks_by_status'), 'totalTasks' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'total_tasks'), 'workflowSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'workflow_sid'), 'workspaceSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'workspace_sid'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Workflow\WorkflowRealTimeStatisticsContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Workflow\WorkflowRealTimeStatisticsContext($this->version, $this->solution['workspaceSid'], $this->solution['workflowSid']);
        }
        return $this->context;
    }
    /**
