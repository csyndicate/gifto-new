...
abstract class ConfigurationOptions
{
     ...
     */
    public static function fetch(string $uiVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\FetchConfigurationOptions
    {
...
class FetchConfigurationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $uiVersion The Pinned UI version of the Configuration resource to fetch.
     */
    public function __construct(string $uiVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
