...
abstract class SyncListOptions
{
     ...
     */
    public static function create(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\CreateSyncListOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\CreateSyncListOptions($uniqueName, $ttl, $collectionTtl);
    }
    /**
     ...
     */
    public static function update(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateSyncListOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateSyncListOptions($ttl, $collectionTtl);
    }
}
...
class UpdateSyncListOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $ttl An alias for `collection_ttl`. If both are provided, this value is ignored.
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync List expires (time-to-live) and is deleted.
