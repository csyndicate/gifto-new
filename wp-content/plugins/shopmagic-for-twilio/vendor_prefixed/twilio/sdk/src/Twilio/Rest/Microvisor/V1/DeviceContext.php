...
class DeviceContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\DeviceInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\DeviceInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\DeviceInstance
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['UniqueName' => $options['uniqueName'], 'TargetApp' => $options['targetApp'], 'LoggingEnabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['loggingEnabled']), 'RestartApp' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['restartApp'])]);
    ...
    protected function getDeviceConfigs() : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\Device\DeviceConfigList
    {
        if (!$this->_deviceConfigs) {
            $this->_deviceConfigs = new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\Device\DeviceConfigList($this->version, $this->solution['sid']);
        }
    ...
    protected function getDeviceSecrets() : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\Device\DeviceSecretList
    {
        if (!$this->_deviceSecrets) {
            $this->_deviceSecrets = new \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\Device\DeviceSecretList($this->version, $this->solution['sid']);
        }
