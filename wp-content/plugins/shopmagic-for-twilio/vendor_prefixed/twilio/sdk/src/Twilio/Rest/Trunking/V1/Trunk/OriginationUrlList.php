...
class OriginationUrlList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(int $weight, int $priority, bool $enabled, string $friendlyName, string $sipUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Weight' => $weight, 'Priority' => $priority, 'Enabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($enabled), 'FriendlyName' => $friendlyName, 'SipUrl' => $sipUrl]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlInstance($this->version, $payload, $this->solution['trunkSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return OriginationUrlPage Page of OriginationUrlInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\OriginationUrlContext($this->version, $this->solution['trunkSid'], $sid);
    }
    /**
