...
class UserConversationPage extends \ShopMagicTwilioVendor\Twilio\Page
{
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\User\UserConversationInstance($this->version, $payload, $this->solution['userSid']);
    }
    /**
