...
abstract class BrandRegistrationOptions
{
     ...
     */
    public static function create(string $brandType = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $mock = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $skipAutomaticSecVet = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\CreateBrandRegistrationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\CreateBrandRegistrationOptions($brandType, $mock, $skipAutomaticSecVet);
    }
}
class CreateBrandRegistrationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $brandType Type of brand being created. One of: \\\"STANDARD\\\", \\\"SOLE_PROPRIETOR\\\". SOLE_PROPRIETOR is for low volume, SOLE_PROPRIETOR use cases. STANDARD is for all other use cases.
     * @param bool $mock A boolean that specifies whether brand should be a mock or not. If true, brand will be registered as a mock brand. Defaults to false if no value is provided.
     * @param bool $skipAutomaticSecVet A flag to disable automatic secondary vetting for brands which it would otherwise be done.
     */
    public function __construct(string $brandType = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $mock = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $skipAutomaticSecVet = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
