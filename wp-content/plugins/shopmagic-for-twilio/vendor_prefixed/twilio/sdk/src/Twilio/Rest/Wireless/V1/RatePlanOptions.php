...
abstract class RatePlanOptions
{
     ...
     */
    public static function create(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $dataEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $dataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $dataMetering = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $messagingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $voiceEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $nationalRoamingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $internationalRoaming = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $nationalRoamingDataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $internationalRoamingDataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\CreateRatePlanOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\CreateRatePlanOptions($uniqueName, $friendlyName, $dataEnabled, $dataLimit, $dataMetering, $messagingEnabled, $voiceEnabled, $nationalRoamingEnabled, $internationalRoaming, $nationalRoamingDataLimit, $internationalRoamingDataLimit);
    }
    /**
     * @param string $uniqueName An application-defined string that uniquely identifies the resource. It can be used in place of the resource's `sid` in the URL to address the resource.
     * @param string $friendlyName A descriptive string that you create to describe the resource. It does not have to be unique.
     ...
     */
    public static function update(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\UpdateRatePlanOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Wireless\V1\UpdateRatePlanOptions($uniqueName, $friendlyName);
    }
}
