 ...
 */
class TrustProductsEntityAssignmentsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $trustProductSid, string $sid = null)
    {
        ...
        $this->properties = ['sid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'sid'), 'trustProductSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'trust_product_sid'), 'accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'objectSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'object_sid'), 'dateCreated' => \ShopMagicTwilioVendor\Twilio\Deserialize::dateTime(\ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'date_created')), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEntityAssignmentsContext($this->version, $this->solution['trustProductSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
