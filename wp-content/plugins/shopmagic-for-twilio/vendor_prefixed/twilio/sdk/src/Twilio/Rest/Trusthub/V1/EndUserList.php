...
class EndUserList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $friendlyName, string $type, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return EndUserPage Page of EndUserInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\EndUserContext($this->version, $sid);
    }
    /**
