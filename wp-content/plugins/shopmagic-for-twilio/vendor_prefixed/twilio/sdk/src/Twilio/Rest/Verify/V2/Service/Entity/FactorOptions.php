...
abstract class FactorOptions
{
     ...
     */
    public static function update(string $authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configNotificationToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configSdkVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $configTimeStep = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $configSkew = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $configCodeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $configAlg = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configNotificationPlatform = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\UpdateFactorOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\Entity\UpdateFactorOptions($authPayload, $friendlyName, $configNotificationToken, $configSdkVersion, $configTimeStep, $configSkew, $configCodeLength, $configAlg, $configNotificationPlatform);
    }
}
class UpdateFactorOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $authPayload The optional payload needed to verify the Factor for the first time. E.g. for a TOTP, the numeric code.
     * @param string $friendlyName The new friendly name of this Factor. It can be up to 64 characters.
     ...
     * @param string $configNotificationPlatform The transport technology used to generate the Notification Token. Can be `apn`, `fcm` or `none`.  Required when `factor_type` is `push`.
     */
    public function __construct(string $authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configNotificationToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configSdkVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $configTimeStep = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $configSkew = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $configCodeLength = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $configAlg = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configNotificationPlatform = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
