...
abstract class CallSummariesOptions
{
     ...
     */
    public static function read(string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fromCarrier = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $toCarrier = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fromCountryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $toCountryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $branded = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $verifiedCaller = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $hasTag = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $startTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $endTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callState = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $processingState = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sortBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $subaccount = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $abnormalSession = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $answeredBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $answeredByAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $connectivityIssueAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $qualityIssueAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $spamAnnotation = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $callScoreAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\ReadCallSummariesOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\ReadCallSummariesOptions($from, $to, $fromCarrier, $toCarrier, $fromCountryCode, $toCountryCode, $branded, $verifiedCaller, $hasTag, $startTime, $endTime, $callType, $callState, $direction, $processingState, $sortBy, $subaccount, $abnormalSession, $answeredBy, $answeredByAnnotation, $connectivityIssueAnnotation, $qualityIssueAnnotation, $spamAnnotation, $callScoreAnnotation);
    }
}
class ReadCallSummariesOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $from A calling party. Could be an E.164 number, a SIP URI, or a Twilio Client registered name.
     * @param string $to A called party. Could be an E.164 number, a SIP URI, or a Twilio Client registered name.
     ...
     * @param string $callScoreAnnotation A Call Score of the calls. Use a range of 1-5 to indicate the call experience score, with the following mapping as a reference for the rated call [5: Excellent, 4: Good, 3 : Fair, 2 : Poor, 1: Bad].
     */
    public function __construct(string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fromCarrier = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $toCarrier = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fromCountryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $toCountryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $branded = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $verifiedCaller = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $hasTag = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $startTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $endTime = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callState = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $processingState = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sortBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $subaccount = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $abnormalSession = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $answeredBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $answeredByAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $connectivityIssueAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $qualityIssueAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $spamAnnotation = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $callScoreAnnotation = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
