...
class InteractionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return InteractionPage Page of InteractionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\Session\InteractionContext($this->version, $this->solution['serviceSid'], $this->solution['sessionSid'], $sid);
    }
    /**
