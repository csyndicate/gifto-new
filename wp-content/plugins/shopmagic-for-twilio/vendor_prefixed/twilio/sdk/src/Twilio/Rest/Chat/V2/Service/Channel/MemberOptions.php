...
abstract class MemberOptions
{
     ...
     */
    public static function create(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $lastConsumedMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $lastConsumptionTimestamp = null, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\CreateMemberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\CreateMemberOptions($roleSid, $lastConsumedMessageIndex, $lastConsumptionTimestamp, $dateCreated, $dateUpdated, $attributes, $xTwilioWebhookEnabled);
    }
    /**
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     * @return DeleteMemberOptions Options builder
     */
    public static function delete(string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\DeleteMemberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\DeleteMemberOptions($xTwilioWebhookEnabled);
    }
    /**
     ...
     */
    public static function read(array $identity = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\ReadMemberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\ReadMemberOptions($identity);
    }
    /**
     * @param string $roleSid The SID of the [Role](https://www.twilio.com/docs/chat/rest/role-resource) to assign to the member. The default roles are those specified on the [Service](https://www.twilio.com/docs/chat/rest/service-resource).
     ...
     */
    public static function update(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $lastConsumedMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $lastConsumptionTimestamp = null, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\UpdateMemberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\UpdateMemberOptions($roleSid, $lastConsumedMessageIndex, $lastConsumptionTimestamp, $dateCreated, $dateUpdated, $attributes, $xTwilioWebhookEnabled);
    }
}
