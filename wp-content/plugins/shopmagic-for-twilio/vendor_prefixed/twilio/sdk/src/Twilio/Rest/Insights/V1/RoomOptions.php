...
abstract class RoomOptions
{
     ...
     */
    public static function read(array $roomType = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $codec = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $roomName = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $createdAfter = null, \DateTime $createdBefore = null) : \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\ReadRoomOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\ReadRoomOptions($roomType, $codec, $roomName, $createdAfter, $createdBefore);
    }
}
class ReadRoomOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param \DateTime $createdBefore Only read rooms that started before this ISO 8601 timestamp.
     */
    public function __construct(array $roomType = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $codec = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $roomName = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $createdAfter = null, \DateTime $createdBefore = null)
    {
