...
abstract class ActivityOptions
{
     ...
     */
    public static function create(bool $available = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\CreateActivityOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\CreateActivityOptions($available);
    }
    /**
     ...
     */
    public static function read(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $available = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadActivityOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadActivityOptions($friendlyName, $available);
    }
    /**
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\UpdateActivityOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\UpdateActivityOptions($friendlyName);
    }
}
class CreateActivityOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $available Whether the Worker should be eligible to receive a Task when it occupies the Activity. A value of `true`, `1`, or `yes` specifies the Activity is available. All other values specify that it is not. The value cannot be changed after the Activity is created.
     */
    public function __construct(bool $available = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class ReadActivityOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName The `friendly_name` of the Activity resources to read.
     * @param string $available Whether return only Activity resources that are available or unavailable. A value of `true` returns only available activities. Values of '1' or `yes` also indicate `true`. All other values represent `false` and return activities that are unavailable.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $available = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateActivityOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName A descriptive string that you create to describe the Activity resource. It can be up to 64 characters long. These names are used to calculate and expose statistics about Workers, and provide visibility into the state of each Worker. Examples of friendly names include: `on-call`, `break`, and `email`.
     */
