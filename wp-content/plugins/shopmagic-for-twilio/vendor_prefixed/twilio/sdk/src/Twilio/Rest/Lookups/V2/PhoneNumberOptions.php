...
abstract class PhoneNumberOptions
{
     ...
     */
    public static function fetch(string $fields = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $countryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $firstName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $lastName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressLine1 = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressLine2 = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $city = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $state = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $postalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressCountryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $nationalId = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dateOfBirth = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $lastVerifiedDate = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V2\FetchPhoneNumberOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V2\FetchPhoneNumberOptions($fields, $countryCode, $firstName, $lastName, $addressLine1, $addressLine2, $city, $state, $postalCode, $addressCountryCode, $nationalId, $dateOfBirth, $lastVerifiedDate);
    }
}
class FetchPhoneNumberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $fields A comma-separated list of fields to return. Possible values are caller_name, sim_swap, call_forwarding, live_activity, line_type_intelligence, identity_match, reassigned_number.
     * @param string $countryCode The [country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) used if the phone number provided is in national format.
     ...
     * @param string $lastVerifiedDate The date you obtained consent to call or text the end-user of the phone number or a date on which you are reasonably certain that the end-user could still be reached at that number. This query parameter is only used (optionally) for reassigned_number package requests.
     */
    public function __construct(string $fields = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $countryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $firstName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $lastName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressLine1 = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressLine2 = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $city = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $state = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $postalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addressCountryCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $nationalId = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dateOfBirth = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $lastVerifiedDate = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
