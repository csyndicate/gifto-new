 ...
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Bulkexports;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\InstanceContext;
use ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\ExportList;
use ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    {
        if (!$this->_exports) {
            $this->_exports = new \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\ExportList($this);
        }
    ...
    protected function getExportConfiguration() : \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationList
    {
        if (!$this->_exportConfiguration) {
            $this->_exportConfiguration = new \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationList($this);
        }
