...
abstract class WorkspaceOptions
{
     ...
     */
    public static function create(string $eventCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventsFilter = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $multiTaskEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $template = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $prioritizeQueueOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\CreateWorkspaceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\CreateWorkspaceOptions($eventCallbackUrl, $eventsFilter, $multiTaskEnabled, $template, $prioritizeQueueOrder);
    }
    /**
     ...
     */
    public static function read(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\ReadWorkspaceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\ReadWorkspaceOptions($friendlyName);
    }
    /**
     ...
     */
    public static function update(string $defaultActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventsFilter = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $multiTaskEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $timeoutActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $prioritizeQueueOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\UpdateWorkspaceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\UpdateWorkspaceOptions($defaultActivitySid, $eventCallbackUrl, $eventsFilter, $friendlyName, $multiTaskEnabled, $timeoutActivitySid, $prioritizeQueueOrder);
    }
}
class CreateWorkspaceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $eventCallbackUrl The URL we should call when an event occurs. If provided, the Workspace will publish events to this URL, for example, to collect data for reporting. See [Workspace Events](https://www.twilio.com/docs/taskrouter/api/event) for more information. This parameter supports Twilio's [Webhooks (HTTP callbacks) Connection Overrides](https://www.twilio.com/docs/usage/webhooks/webhooks-connection-overrides).
     * @param string $eventsFilter The list of Workspace events for which to call event_callback_url. For example, if `EventsFilter=task.created, task.canceled, worker.activity.update`, then TaskRouter will call event_callback_url only when a task is created, canceled, or a Worker activity is updated.
     ...
     * @param string $prioritizeQueueOrder
     */
    public function __construct(string $eventCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventsFilter = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $multiTaskEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $template = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $prioritizeQueueOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadWorkspaceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName The `friendly_name` of the Workspace resources to read. For example `Customer Support` or `2014 Election Campaign`.
     */
...
class UpdateWorkspaceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $defaultActivitySid The SID of the Activity that will be used when new Workers are created in the Workspace.
     * @param string $eventCallbackUrl The URL we should call when an event occurs. See [Workspace Events](https://www.twilio.com/docs/taskrouter/api/event) for more information. This parameter supports Twilio's [Webhooks (HTTP callbacks) Connection Overrides](https://www.twilio.com/docs/usage/webhooks/webhooks-connection-overrides).
     ...
     * @param string $prioritizeQueueOrder
     */
    public function __construct(string $defaultActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $eventsFilter = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $multiTaskEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $timeoutActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $prioritizeQueueOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
