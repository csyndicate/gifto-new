 ...
 */
class SyncMapPermissionInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $serviceSid, string $mapSid, string $identity = null)
    {
        parent::__construct($version);
        // Marshaled Properties
        $this->properties = ['accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'serviceSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'service_sid'), 'mapSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'map_sid'), 'identity' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'identity'), 'read' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'read'), 'write' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'write'), 'manage' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'manage'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapPermissionContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapPermissionContext($this->version, $this->solution['serviceSid'], $this->solution['mapSid'], $this->solution['identity']);
        }
        return $this->context;
    }
    /**
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapPermissionInstance
    {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(bool $read, bool $write, bool $manage) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapPermissionInstance
    {
