...
abstract class AccessTokenOptions
{
     ...
     */
    public static function create(string $factorFriendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\CreateAccessTokenOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\CreateAccessTokenOptions($factorFriendlyName, $ttl);
    }
}
class CreateAccessTokenOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $factorFriendlyName The friendly name of the factor that is going to be created with this access token
     * @param int $ttl How long, in seconds, the access token is valid. Can be an integer between 60 and 300. Default is 60.
     */
    public function __construct(string $factorFriendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
