...
class Dial extends \ShopMagicTwilioVendor\Twilio\TwiML\TwiML
{
    /**
     * Dial constructor.
     *
     ...
     */
    public function client($identity = null, $attributes = []) : \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Client
    {
        return $this->nest(new \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Client($identity, $attributes));
    }
    /**
     ...
     */
    public function conference($name, $attributes = []) : \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Conference
    {
        return $this->nest(new \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Conference($name, $attributes));
    }
    /**
     * Add Number child.
     *
     ...
     */
    public function number($phoneNumber, $attributes = []) : \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Number
    {
        return $this->nest(new \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Number($phoneNumber, $attributes));
    }
    /**
     * Add Queue child.
     *
     ...
     */
    public function sim($simSid) : \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Sim
    {
        return $this->nest(new \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Sim($simSid));
    }
    /**
     * Add Sip child.
     *
     ...
     */
    public function sip($sipUrl, $attributes = []) : \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Sip
    {
        return $this->nest(new \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Sip($sipUrl, $attributes));
    }
    /**
     ...
     */
    public function application($applicationSid = null, $attributes = []) : \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Application
    {
        return $this->nest(new \ShopMagicTwilioVendor\Twilio\TwiML\Voice\Application($applicationSid, $attributes));
    }
    /**
