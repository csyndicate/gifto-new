 ...
 */
class SubscriptionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SubscriptionInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SubscriptionInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\SubscriptionInstance
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Description' => $options['description'], 'SinkSid' => $options['sinkSid']]);
    ...
    protected function getSubscribedEvents() : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Subscription\SubscribedEventList
    {
        if (!$this->_subscribedEvents) {
            $this->_subscribedEvents = new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\Subscription\SubscribedEventList($this->version, $this->solution['sid']);
        }
