...
class PortingPortabilityContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
    ...
    public function fetch(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1\PortingPortabilityInstance
    {
        ...
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['TargetAccountSid' => $options['targetAccountSid']]);
        $payload = $this->version->fetch('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V1\PortingPortabilityInstance($this->version, $payload, $this->solution['phoneNumber']);
    }
    /**
