...
class ChannelSenderList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ChannelSenderPage Page of ChannelSenderInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderContext($this->version, $this->solution['messagingServiceSid'], $sid);
    }
    /**
