...
abstract class TriggerOptions
{
     ...
     */
    public static function create(string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\CreateTriggerOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\CreateTriggerOptions($callbackMethod, $friendlyName, $recurring, $triggerBy);
    }
    /**
     ...
     */
    public static function read(string $recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $usageCategory = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\ReadTriggerOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\ReadTriggerOptions($recurring, $triggerBy, $usageCategory);
    }
    /**
     * @param string $callbackMethod The HTTP method we should use to call `callback_url`. Can be: `GET` or `POST` and the default is `POST`.
     ...
     */
    public static function update(string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\UpdateTriggerOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\UpdateTriggerOptions($callbackMethod, $callbackUrl, $friendlyName);
    }
}
class CreateTriggerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $callbackMethod The HTTP method we should use to call `callback_url`. Can be: `GET` or `POST` and the default is `POST`.
     * @param string $friendlyName A descriptive string that you create to describe the resource. It can be up to 64 characters long.
     ...
     * @param string $triggerBy
     */
    public function __construct(string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadTriggerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $recurring The frequency of recurring UsageTriggers to read. Can be: `daily`, `monthly`, or `yearly` to read recurring UsageTriggers. An empty value or a value of `alltime` reads non-recurring UsageTriggers.
     * @param string $triggerBy The trigger field of the UsageTriggers to read.  Can be: `count`, `usage`, or `price` as described in the [UsageRecords documentation](https://www.twilio.com/docs/usage/api/usage-record#usage-count-price).
     * @param string $usageCategory The usage category of the UsageTriggers to read. Must be a supported [usage categories](https://www.twilio.com/docs/usage/api/usage-record#usage-categories).
     */
    public function __construct(string $recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $usageCategory = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['recurring'] = $recurring;
        $this->options['triggerBy'] = $triggerBy;
...
class UpdateTriggerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $callbackMethod The HTTP method we should use to call `callback_url`. Can be: `GET` or `POST` and the default is `POST`.
     * @param string $callbackUrl The URL we should call using `callback_method` when the trigger fires.
     * @param string $friendlyName A descriptive string that you create to describe the resource. It can be up to 64 characters long.
     */
    public function __construct(string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['callbackMethod'] = $callbackMethod;
