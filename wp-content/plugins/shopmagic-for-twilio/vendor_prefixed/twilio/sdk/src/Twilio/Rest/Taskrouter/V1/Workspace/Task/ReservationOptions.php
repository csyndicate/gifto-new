...
abstract class ReservationOptions
{
     ...
     */
    public static function read(string $reservationStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Task\ReadReservationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Task\ReadReservationOptions($reservationStatus, $workerSid);
    }
    /**
     ...
     */
    public static function update(string $reservationStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workerActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $instruction = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeuePostWorkActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeueFrom = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeueRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $dequeueTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $dequeueTo = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeueStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callFrom = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $callTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $callTo = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $callAccept = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $redirectCallSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $redirectAccept = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $redirectUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $statusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $record = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $beep = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $startConferenceOnEnter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $endConferenceOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $waitUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $earlyMedia = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $conferenceStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $conferenceStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $conferenceRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceTrim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $region = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $dequeueStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $postWorkActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $supervisorMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $supervisor = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $endConferenceOnCustomerExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $beepOnCustomerEntrance = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Task\UpdateReservationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Task\UpdateReservationOptions($reservationStatus, $workerActivitySid, $instruction, $dequeuePostWorkActivitySid, $dequeueFrom, $dequeueRecord, $dequeueTimeout, $dequeueTo, $dequeueStatusCallbackUrl, $callFrom, $callRecord, $callTimeout, $callTo, $callUrl, $callStatusCallbackUrl, $callAccept, $redirectCallSid, $redirectAccept, $redirectUrl, $to, $from, $statusCallback, $statusCallbackMethod, $statusCallbackEvent, $timeout, $record, $muted, $beep, $startConferenceOnEnter, $endConferenceOnExit, $waitUrl, $waitMethod, $earlyMedia, $maxParticipants, $conferenceStatusCallback, $conferenceStatusCallbackMethod, $conferenceStatusCallbackEvent, $conferenceRecord, $conferenceTrim, $recordingChannels, $recordingStatusCallback, $recordingStatusCallbackMethod, $conferenceRecordingStatusCallback, $conferenceRecordingStatusCallbackMethod, $region, $sipAuthUsername, $sipAuthPassword, $dequeueStatusCallbackEvent, $postWorkActivitySid, $supervisorMode, $supervisor, $endConferenceOnCustomerExit, $beepOnCustomerEntrance, $ifMatch);
    }
}
class ReadReservationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $reservationStatus Returns the list of reservations for a task with a specified ReservationStatus.  Can be: `pending`, `accepted`, `rejected`, or `timeout`.
     * @param string $workerSid The SID of the reserved Worker resource to read.
     */
    public function __construct(string $reservationStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateReservationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $reservationStatus
     * @param string $workerActivitySid The new worker activity SID if rejecting a reservation.
     ...
     * @param string $ifMatch The If-Match HTTP request header
     */
    public function __construct(string $reservationStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $workerActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $instruction = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeuePostWorkActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeueFrom = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeueRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $dequeueTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $dequeueTo = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $dequeueStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callFrom = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $callTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $callTo = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $callAccept = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $redirectCallSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $redirectAccept = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $redirectUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $statusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $record = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $beep = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $startConferenceOnEnter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $endConferenceOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $waitUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $earlyMedia = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $conferenceStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $conferenceStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $conferenceRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceTrim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $region = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $dequeueStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $postWorkActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $supervisorMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $supervisor = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $endConferenceOnCustomerExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $beepOnCustomerEntrance = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['reservationStatus'] = $reservationStatus;
