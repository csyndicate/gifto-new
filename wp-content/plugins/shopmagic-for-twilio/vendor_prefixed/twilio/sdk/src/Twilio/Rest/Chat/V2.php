...
use ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\CredentialList;
use ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\ServiceList;
...
class V2 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    protected function getCredentials() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\CredentialList
    {
        if (!$this->_credentials) {
            $this->_credentials = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\CredentialList($this);
        }
    ...
    {
        if (!$this->_services) {
            $this->_services = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\ServiceList($this);
        }
