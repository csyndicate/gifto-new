...
abstract class LogOptions
{
     ...
     */
    public static function read(string $functionSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null) : \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Environment\ReadLogOptions
    {
...
class ReadLogOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param \DateTime $endDate The date/time (in GMT, ISO 8601) before which the Log resources must have been created. Defaults to current date/time.
     */
    public function __construct(string $functionSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null)
    {
