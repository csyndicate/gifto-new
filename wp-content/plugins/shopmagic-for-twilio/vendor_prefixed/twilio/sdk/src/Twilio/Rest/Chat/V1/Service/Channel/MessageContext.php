...
class MessageContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessageInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessageInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['channelSid'], $this->solution['sid']);
    }
    /**
