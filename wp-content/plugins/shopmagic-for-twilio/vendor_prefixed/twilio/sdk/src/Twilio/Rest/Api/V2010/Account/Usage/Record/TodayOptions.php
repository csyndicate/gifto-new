...
abstract class TodayOptions
{
     ...
     */
    public static function read(string $category = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null, bool $includeSubaccounts = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\ReadTodayOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\ReadTodayOptions($category, $startDate, $endDate, $includeSubaccounts);
    }
}
class ReadTodayOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $category The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
     * @param \DateTime $startDate Only include usage that has occurred on or after this date. Specify the date in GMT and format as `YYYY-MM-DD`. You can also specify offsets from the current date, such as: `-30days`, which will set the start date to be 30 days before the current date.
