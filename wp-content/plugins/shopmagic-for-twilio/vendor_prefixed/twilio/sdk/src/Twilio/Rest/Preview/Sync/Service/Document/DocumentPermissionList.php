...
class DocumentPermissionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $serviceSid, string $documentSid)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return DocumentPermissionPage Page of DocumentPermissionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionPage
    {
     ...
     */
    public function getContext(string $identity) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionContext($this->version, $this->solution['serviceSid'], $this->solution['documentSid'], $identity);
    }
    /**
