...
class SyncListPermissionPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncList\SyncListPermissionInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\SyncList\SyncListPermissionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['listSid']);
    }
    /**
