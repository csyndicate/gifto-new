...
class IpAccessControlListList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $ipAccessControlListSid) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\IpAccessControlListInstance
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\IpAccessControlListPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\IpAccessControlListPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return IpAccessControlListPage Page of IpAccessControlListInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\IpAccessControlListPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\IpAccessControlListContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\IpAccessControlListContext($this->version, $this->solution['trunkSid'], $sid);
    }
    /**
