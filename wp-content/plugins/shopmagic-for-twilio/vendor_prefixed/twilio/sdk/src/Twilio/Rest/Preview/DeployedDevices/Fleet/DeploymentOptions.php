...
abstract class DeploymentOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $syncServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\DeployedDevices\Fleet\CreateDeploymentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\DeployedDevices\Fleet\CreateDeploymentOptions($friendlyName, $syncServiceSid);
    }
    /**
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $syncServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\DeployedDevices\Fleet\UpdateDeploymentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\DeployedDevices\Fleet\UpdateDeploymentOptions($friendlyName, $syncServiceSid);
    }
}
class CreateDeploymentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName Provides a human readable descriptive text for this Deployment, up to 256 characters long.
     * @param string $syncServiceSid Provides the unique string identifier of the Twilio Sync service instance that will be linked to and accessible by this Deployment.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $syncServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateDeploymentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $friendlyName Provides a human readable descriptive text for this Deployment, up to 64 characters long
     * @param string $syncServiceSid Provides the unique string identifier of the Twilio Sync service instance that will be linked to and accessible by this Deployment.
