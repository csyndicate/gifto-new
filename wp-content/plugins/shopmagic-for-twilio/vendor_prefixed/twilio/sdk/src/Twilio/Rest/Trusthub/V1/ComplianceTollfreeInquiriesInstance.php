 ...
 */
class ComplianceTollfreeInquiriesInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $tollfreeId = null)
    {
        parent::__construct($version);
        // Marshaled Properties
        $this->properties = ['inquiryId' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'inquiry_id'), 'inquirySessionToken' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'inquiry_session_token'), 'tollfreeId' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'tollfree_id'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\ComplianceTollfreeInquiriesContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\ComplianceTollfreeInquiriesContext($this->version, $this->solution['tollfreeId']);
        }
        return $this->context;
    }
    /**
