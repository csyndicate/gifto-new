...
abstract class RecordingSettingsOptions
{
     ...
     */
    public static function create(string $awsCredentialsSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $encryptionKeySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $awsS3Url = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $awsStorageEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $encryptionEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateRecordingSettingsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateRecordingSettingsOptions($awsCredentialsSid, $encryptionKeySid, $awsS3Url, $awsStorageEnabled, $encryptionEnabled);
    }
}
class CreateRecordingSettingsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $awsCredentialsSid The SID of the stored Credential resource.
     * @param string $encryptionKeySid The SID of the Public Key resource to use for encryption.
