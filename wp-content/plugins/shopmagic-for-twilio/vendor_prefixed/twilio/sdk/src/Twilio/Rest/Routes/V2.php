 ...
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Routes;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\InstanceContext;
use ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\PhoneNumberList;
use ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\SipDomainList;
use ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\TrunkList;
...
class V2 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    protected function getPhoneNumbers() : \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\PhoneNumberList
    {
        if (!$this->_phoneNumbers) {
            $this->_phoneNumbers = new \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\PhoneNumberList($this);
        }
    ...
    {
        if (!$this->_sipDomains) {
            $this->_sipDomains = new \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\SipDomainList($this);
        }
    ...
    {
        if (!$this->_trunks) {
            $this->_trunks = new \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\TrunkList($this);
        }
        return $this->_trunks;
    }
    /**
