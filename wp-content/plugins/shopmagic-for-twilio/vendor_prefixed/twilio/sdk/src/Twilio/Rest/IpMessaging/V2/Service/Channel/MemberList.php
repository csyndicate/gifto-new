...
class MemberList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $identity, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\Channel\MemberInstance
    {
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\Channel\MemberPage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
     ...
     * @return MemberPage Page of MemberInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\Channel\MemberPage
    {
     ...
     * @param string $sid 
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\Channel\MemberContext
    {
