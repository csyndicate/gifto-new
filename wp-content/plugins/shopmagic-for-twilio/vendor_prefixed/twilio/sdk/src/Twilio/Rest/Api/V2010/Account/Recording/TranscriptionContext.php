...
class TranscriptionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $accountSid, $recordingSid, $sid)
    {
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['recordingSid'], $this->solution['sid']);
    }
    /**
