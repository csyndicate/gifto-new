...
class UserChannelList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserChannelPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserChannelPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return UserChannelPage Page of UserChannelInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserChannelPage
    {
     ...
     */
    public function getContext(string $channelSid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserChannelContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserChannelContext($this->version, $this->solution['serviceSid'], $this->solution['userSid'], $channelSid);
    }
    /**
