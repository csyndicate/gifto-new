...
abstract class DocumentOptions
{
     ...
     */
    public static function create(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\CreateDocumentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\CreateDocumentOptions($uniqueName, $data, $ttl);
    }
    /**
     * @param array $data A JSON string that represents an arbitrary, schema-less object that the Sync Document stores. Can be up to 16 KiB in length.
     ...
     */
    public static function update(array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateDocumentOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateDocumentOptions($data, $ttl, $ifMatch);
    }
}
class CreateDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param int $ttl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (the Sync Document's time-to-live).
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
...
class UpdateDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $ifMatch The If-Match HTTP request header
     */
    public function __construct(array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['data'] = $data;
        $this->options['ttl'] = $ttl;
