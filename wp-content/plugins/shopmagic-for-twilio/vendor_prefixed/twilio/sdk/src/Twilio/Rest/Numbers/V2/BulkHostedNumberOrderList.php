...
class BulkHostedNumberOrderList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function getContext(string $bulkHostingSid) : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\BulkHostedNumberOrderContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\BulkHostedNumberOrderContext($this->version, $bulkHostingSid);
    }
    /**
