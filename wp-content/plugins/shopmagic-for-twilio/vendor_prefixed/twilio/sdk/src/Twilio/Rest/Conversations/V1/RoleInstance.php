...
class RoleInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleContext($this->version, $this->solution['sid']);
        }
        return $this->context;
    }
    /**
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleInstance
    {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(array $permission) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleInstance
    {
