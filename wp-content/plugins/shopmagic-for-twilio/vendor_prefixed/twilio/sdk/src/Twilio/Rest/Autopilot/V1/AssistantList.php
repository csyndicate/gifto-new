...
class AssistantList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['FriendlyName' => $options['friendlyName'], 'LogQueries' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['logQueries']), 'UniqueName' => $options['uniqueName'], 'CallbackUrl' => $options['callbackUrl'], 'CallbackEvents' => $options['callbackEvents'], 'StyleSheet' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($options['styleSheet']), 'Defaults' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($options['defaults'])]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return AssistantPage Page of AssistantInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\AssistantContext($this->version, $sid);
    }
    /**
