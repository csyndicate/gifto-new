...
abstract class NotificationOptions
{
     ...
     */
    public static function update(bool $logEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $newMessageEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $newMessageTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $newMessageSound = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $newMessageBadgeCountEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $addedToConversationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $addedToConversationTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addedToConversationSound = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $removedFromConversationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $removedFromConversationTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $removedFromConversationSound = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $newMessageWithMediaEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $newMessageWithMediaTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Configuration\UpdateNotificationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Configuration\UpdateNotificationOptions($logEnabled, $newMessageEnabled, $newMessageTemplate, $newMessageSound, $newMessageBadgeCountEnabled, $addedToConversationEnabled, $addedToConversationTemplate, $addedToConversationSound, $removedFromConversationEnabled, $removedFromConversationTemplate, $removedFromConversationSound, $newMessageWithMediaEnabled, $newMessageWithMediaTemplate);
    }
}
class UpdateNotificationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $logEnabled Weather the notification logging is enabled.
     * @param bool $newMessageEnabled Whether to send a notification when a new message is added to a conversation. The default is `false`.
     ...
     * @param string $newMessageWithMediaTemplate The template to use to create the notification text displayed when a new message with media/file attachments is added to a conversation and `new_message.attachments.enabled` is `true`.
     */
    public function __construct(bool $logEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $newMessageEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $newMessageTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $newMessageSound = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $newMessageBadgeCountEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $addedToConversationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $addedToConversationTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $addedToConversationSound = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $removedFromConversationEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $removedFromConversationTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $removedFromConversationSound = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $newMessageWithMediaEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $newMessageWithMediaTemplate = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
