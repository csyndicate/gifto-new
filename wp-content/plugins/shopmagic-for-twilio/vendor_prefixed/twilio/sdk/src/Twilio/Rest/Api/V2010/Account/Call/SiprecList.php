...
class SiprecList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\SiprecContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\SiprecContext($this->version, $this->solution['accountSid'], $this->solution['callSid'], $sid);
    }
    /**
