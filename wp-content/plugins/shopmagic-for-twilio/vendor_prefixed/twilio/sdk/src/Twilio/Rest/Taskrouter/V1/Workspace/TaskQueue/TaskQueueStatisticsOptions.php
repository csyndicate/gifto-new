...
abstract class TaskQueueStatisticsOptions
{
     ...
     */
    public static function fetch(\DateTime $endDate = null, int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $splitByWaitTime = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\TaskQueue\FetchTaskQueueStatisticsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\TaskQueue\FetchTaskQueueStatisticsOptions($endDate, $minutes, $startDate, $taskChannel, $splitByWaitTime);
    }
}
class FetchTaskQueueStatisticsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $endDate Only calculate statistics from this date and time and earlier, specified in GMT as an [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date-time.
     * @param int $minutes Only calculate statistics since this many minutes in the past. The default is 15 minutes.
