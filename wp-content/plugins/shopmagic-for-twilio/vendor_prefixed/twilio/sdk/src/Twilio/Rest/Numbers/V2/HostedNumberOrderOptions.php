...
abstract class HostedNumberOrderOptions
{
     ...
     */
    public static function create(string $accountSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsCapability = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $contactTitle = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\CreateHostedNumberOrderOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\CreateHostedNumberOrderOptions($accountSid, $friendlyName, $ccEmails, $smsUrl, $smsMethod, $smsFallbackUrl, $smsCapability, $smsFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $smsApplicationSid, $contactTitle);
    }
    /**
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsCapability = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $incomingPhoneNumberSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\ReadHostedNumberOrderOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\ReadHostedNumberOrderOptions($status, $smsCapability, $phoneNumber, $incomingPhoneNumberSid, $friendlyName);
    }
}
class CreateHostedNumberOrderOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $contactTitle The title of the person authorized to sign the Authorization Document for this phone number.
     */
    public function __construct(string $accountSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsCapability = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsApplicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $contactTitle = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadHostedNumberOrderOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $friendlyName A human readable description of this resource, up to 128 characters.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsCapability = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $incomingPhoneNumberSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
