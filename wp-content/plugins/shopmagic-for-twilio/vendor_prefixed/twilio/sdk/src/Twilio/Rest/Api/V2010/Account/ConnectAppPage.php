...
class ConnectAppPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ConnectAppInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ConnectAppInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
