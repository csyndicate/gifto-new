...
class SimContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\SimInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\SimInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    {
        if (!$this->_usage) {
            $this->_usage = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\Sim\UsageList($this->version, $this->solution['sid']);
        }
        return $this->_usage;
    }
    /**
