...
abstract class RecordingOptions
{
     ...
     */
    public static function fetch(bool $includeSoftDeleted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\FetchRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\FetchRecordingOptions($includeSoftDeleted);
    }
    /**
     ...
     */
    public static function read(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null, string $callSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $includeSoftDeleted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ReadRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ReadRecordingOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter, $callSid, $conferenceSid, $includeSoftDeleted);
    }
}
class FetchRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $includeSoftDeleted A boolean parameter indicating whether to retrieve soft deleted recordings or not. Recordings metadata are kept after deletion for a retention period of 40 days.
     */
    public function __construct(bool $includeSoftDeleted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class ReadRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $includeSoftDeleted A boolean parameter indicating whether to retrieve soft deleted recordings or not. Recordings metadata are kept after deletion for a retention period of 40 days.
     */
    public function __construct(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null, string $callSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $includeSoftDeleted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
