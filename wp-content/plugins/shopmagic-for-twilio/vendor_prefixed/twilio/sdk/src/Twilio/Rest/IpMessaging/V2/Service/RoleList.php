...
class RoleList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $friendlyName, string $type, array $permission) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RoleInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RoleInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RolePage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RolePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return RolePage Page of RoleInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RolePage
    {
     ...
     * @param string $sid 
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RoleContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\RoleContext($this->version, $this->solution['serviceSid'], $sid);
    }
    /**
