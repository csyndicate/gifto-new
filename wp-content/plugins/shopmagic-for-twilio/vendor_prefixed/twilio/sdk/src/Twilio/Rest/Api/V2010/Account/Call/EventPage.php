...
class EventPage extends \ShopMagicTwilioVendor\Twilio\Page
{
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\EventInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\EventInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['callSid']);
    }
    /**
