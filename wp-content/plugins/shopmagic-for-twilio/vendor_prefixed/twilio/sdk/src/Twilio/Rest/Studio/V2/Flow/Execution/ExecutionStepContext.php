...
class ExecutionStepContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionStepInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionStepInstance($this->version, $payload, $this->solution['flowSid'], $this->solution['executionSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getStepContext() : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionStep\ExecutionStepContextList
    {
        if (!$this->_stepContext) {
            $this->_stepContext = new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionStep\ExecutionStepContextList($this->version, $this->solution['flowSid'], $this->solution['executionSid'], $this->solution['sid']);
        }
