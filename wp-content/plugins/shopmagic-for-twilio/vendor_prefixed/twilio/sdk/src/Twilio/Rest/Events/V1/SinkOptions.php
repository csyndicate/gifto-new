...
abstract class SinkOptions
{
     ...
     */
    public static function read(bool $inUse = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\ReadSinkOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Events\V1\ReadSinkOptions($inUse, $status);
    }
}
class ReadSinkOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $inUse A boolean query parameter filtering the results to return sinks used/not used by a subscription.
     * @param string $status A String query parameter filtering the results by status `initialized`, `validating`, `active` or `failed`.
     */
    public function __construct(bool $inUse = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
