...
class WebhookList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $type, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookInstance
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return WebhookPage Page of WebhookInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\WebhookContext($this->version, $this->solution['serviceSid'], $this->solution['channelSid'], $sid);
    }
    /**
