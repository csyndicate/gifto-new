...
class NotificationInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $chatServiceSid)
    {
        ...
        $this->properties = ['accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'chatServiceSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'chat_service_sid'), 'newMessage' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'new_message'), 'addedToConversation' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'added_to_conversation'), 'removedFromConversation' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'removed_from_conversation'), 'logEnabled' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'log_enabled'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Configuration\NotificationContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Configuration\NotificationContext($this->version, $this->solution['chatServiceSid']);
        }
        return $this->context;
    }
    /**
