...
class ReservationPage extends \ShopMagicTwilioVendor\Twilio\Page
{
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Task\ReservationInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Task\ReservationInstance($this->version, $payload, $this->solution['workspaceSid'], $this->solution['taskSid']);
    }
    /**
