...
use ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\PhoneNumberList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    protected function getPhoneNumbers() : \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\PhoneNumberList
    {
        if (!$this->_phoneNumbers) {
            $this->_phoneNumbers = new \ShopMagicTwilioVendor\Twilio\Rest\Lookups\V1\PhoneNumberList($this);
        }
