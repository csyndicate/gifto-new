...
abstract class FleetOptions
{
     ...
     */
    public static function create(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $dataEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $dataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ipCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ipCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsCommandsEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $smsCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateFleetOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateFleetOptions($uniqueName, $dataEnabled, $dataLimit, $ipCommandsUrl, $ipCommandsMethod, $smsCommandsEnabled, $smsCommandsUrl, $smsCommandsMethod);
    }
    /**
     ...
     */
    public static function read(string $networkAccessProfile = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadFleetOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadFleetOptions($networkAccessProfile);
    }
    /**
     * @param string $uniqueName An application-defined string that uniquely identifies the resource. It can be used in place of the resource's `sid` in the URL to address the resource.
     ...
     */
    public static function update(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $networkAccessProfile = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ipCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ipCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $dataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\UpdateFleetOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\UpdateFleetOptions($uniqueName, $networkAccessProfile, $ipCommandsUrl, $ipCommandsMethod, $smsCommandsUrl, $smsCommandsMethod, $dataLimit);
    }
}
class CreateFleetOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $smsCommandsMethod A string representing the HTTP method to use when making a request to `sms_commands_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $dataEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $dataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ipCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ipCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $smsCommandsEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $smsCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadFleetOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $networkAccessProfile The SID or unique name of the Network Access Profile that controls which cellular networks the Fleet's SIMs can connect to.
     */
    public function __construct(string $networkAccessProfile = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateFleetOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param int $dataLimit The total data usage (download and upload combined) in Megabytes that each Super SIM assigned to the Fleet can consume during a billing period (normally one month). Value must be between 1MB (1) and 2TB (2,000,000). Defaults to 1GB (1,000).
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $networkAccessProfile = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ipCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $ipCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsCommandsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $smsCommandsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $dataLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
        $this->options['uniqueName'] = $uniqueName;
        $this->options['networkAccessProfile'] = $networkAccessProfile;
        $this->options['ipCommandsUrl'] = $ipCommandsUrl;
