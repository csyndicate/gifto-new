...
class UserList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $identity, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return UserPage Page of UserInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserContext($this->version, $sid);
    }
    /**
