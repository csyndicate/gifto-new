...
namespace ShopMagicTwilioVendor\Twilio\Jwt\Client;
...
class ScopeURI
{
     ...
     */
    public static function parse(string $uri) : \ShopMagicTwilioVendor\Twilio\Jwt\Client\ScopeURI
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Jwt\Client\ScopeURI($service, $privilege, $params);
    }
}
