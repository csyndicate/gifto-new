...
abstract class SentenceOptions
{
     ...
     */
    public static function read(bool $redacted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\ReadSentenceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\ReadSentenceOptions($redacted);
    }
}
class ReadSentenceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $redacted Grant access to PII Redacted/Unredacted Sentences. If redaction is enabled, the default is `true` to access redacted sentences.
     */
