...
class SentenceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\SentencePage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\SentencePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SentencePage Page of SentenceInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\SentencePage
    {
