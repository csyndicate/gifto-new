 ...
 */
class WebChannelsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload)
    {
        ...
        $this->properties = ['conversationSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'conversation_sid'), 'identity' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'identity')];
        $this->solution = [];
    }
    /**
