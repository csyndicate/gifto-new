...
abstract class WorkflowCumulativeStatisticsOptions
{
     ...
     */
    public static function fetch(\DateTime $endDate = null, int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $splitByWaitTime = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Workflow\FetchWorkflowCumulativeStatisticsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\Workflow\FetchWorkflowCumulativeStatisticsOptions($endDate, $minutes, $startDate, $taskChannel, $splitByWaitTime);
    }
}
class FetchWorkflowCumulativeStatisticsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $endDate Only include usage that occurred on or before this date, specified in GMT as an [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date-time.
     * @param int $minutes Only calculate statistics since this many minutes in the past. The default 15 minutes. This is helpful for displaying statistics for the last 15 minutes, 240 minutes (4 hours), and 480 minutes (8 hours) to see trends.
