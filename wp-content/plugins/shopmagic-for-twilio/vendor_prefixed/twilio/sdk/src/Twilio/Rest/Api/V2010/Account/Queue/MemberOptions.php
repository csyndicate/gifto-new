...
abstract class MemberOptions
{
     ...
     */
    public static function update(string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Queue\UpdateMemberOptions
    {
...
class UpdateMemberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $method How to pass the update request data. Can be `GET` or `POST` and the default is `POST`. `POST` sends the data as encoded form data and `GET` sends the data as query parameters.
     */
    public function __construct(string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
