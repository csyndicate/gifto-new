...
class ExecutionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $to, string $from, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ExecutionInstance
    {
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ExecutionPage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ExecutionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ExecutionPage Page of ExecutionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ExecutionPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ExecutionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ExecutionContext($this->version, $this->solution['flowSid'], $sid);
    }
    /**
