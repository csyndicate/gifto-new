...
abstract class WebhookOptions
{
     ...
     */
    public static function create(string $configurationUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configurationMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $configurationFilters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $configurationTriggers = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $configurationFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $configurationRetryCount = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\CreateWebhookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\CreateWebhookOptions($configurationUrl, $configurationMethod, $configurationFilters, $configurationTriggers, $configurationFlowSid, $configurationRetryCount);
    }
    /**
     * @param string $configurationUrl The URL of the webhook to call using the `configuration.method`.
     * @param string $configurationMethod
     ...
     */
    public static function update(string $configurationUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $configurationMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $configurationFilters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $configurationTriggers = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $configurationFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $configurationRetryCount = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\UpdateWebhookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\Channel\UpdateWebhookOptions($configurationUrl, $configurationMethod, $configurationFilters, $configurationTriggers, $configurationFlowSid, $configurationRetryCount);
    }
}
