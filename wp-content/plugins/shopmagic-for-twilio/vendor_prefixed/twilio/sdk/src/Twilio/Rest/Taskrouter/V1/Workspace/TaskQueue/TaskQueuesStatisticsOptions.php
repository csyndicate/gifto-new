...
abstract class TaskQueuesStatisticsOptions
{
     ...
     */
    public static function read(\DateTime $endDate = null, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $splitByWaitTime = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\TaskQueue\ReadTaskQueuesStatisticsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\TaskQueue\ReadTaskQueuesStatisticsOptions($endDate, $friendlyName, $minutes, $startDate, $taskChannel, $splitByWaitTime);
    }
}
class ReadTaskQueuesStatisticsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $endDate Only calculate statistics from this date and time and earlier, specified in GMT as an [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date-time.
     * @param string $friendlyName The `friendly_name` of the TaskQueue statistics to read.
     ...
     * @param string $splitByWaitTime A comma separated list of values that describes the thresholds, in seconds, to calculate statistics on. For each threshold specified, the number of Tasks canceled and reservations accepted above and below the specified thresholds in seconds are computed.
     */
    public function __construct(\DateTime $endDate = null, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $minutes = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $splitByWaitTime = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
