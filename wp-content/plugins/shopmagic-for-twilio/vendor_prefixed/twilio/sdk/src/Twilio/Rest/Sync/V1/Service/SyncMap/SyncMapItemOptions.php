...
abstract class SyncMapItemOptions
{
     ...
     */
    public static function create(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\CreateSyncMapItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\CreateSyncMapItemOptions($ttl, $itemTtl, $collectionTtl);
    }
    /**
     ...
     */
    public static function delete(string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\DeleteSyncMapItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\DeleteSyncMapItemOptions($ifMatch);
    }
    /**
     ...
     */
    public static function read(string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bounds = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\ReadSyncMapItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\ReadSyncMapItemOptions($order, $from, $bounds);
    }
    /**
     ...
     */
    public static function update(array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\UpdateSyncMapItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\UpdateSyncMapItemOptions($data, $ttl, $itemTtl, $collectionTtl, $ifMatch);
    }
}
class CreateSyncMapItemOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $ttl An alias for `item_ttl`. If both parameters are provided, this value is ignored.
     * @param int $itemTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Map Item expires (time-to-live) and is deleted.
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Map Item's parent Sync Map expires (time-to-live) and is deleted.
     */
    public function __construct(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
...
class UpdateSyncMapItemOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $ifMatch If provided, applies this mutation if (and only if) the “revision” field of this [map item] matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     */
    public function __construct(array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
