...
class UserBindingContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserBindingInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserBindingInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['userSid'], $this->solution['sid']);
    }
    /**
