 ...
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\FrontlineApi;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\InstanceContext;
use ShopMagicTwilioVendor\Twilio\Rest\FrontlineApi\V1\UserList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    {
        if (!$this->_users) {
            $this->_users = new \ShopMagicTwilioVendor\Twilio\Rest\FrontlineApi\V1\UserList($this);
        }
        return $this->_users;
    }
    /**
