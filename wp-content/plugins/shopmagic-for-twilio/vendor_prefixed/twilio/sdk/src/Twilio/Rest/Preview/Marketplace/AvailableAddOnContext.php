 ...
 */
class AvailableAddOnContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    {
        if (!$this->_extensions) {
            $this->_extensions = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\AvailableAddOn\AvailableAddOnExtensionList($this->version, $this->solution['sid']);
        }
