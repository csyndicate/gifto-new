...
class MessageContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    protected function getDeliveryReceipts() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptList
    {
        if (!$this->_deliveryReceipts) {
            $this->_deliveryReceipts = new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\Message\DeliveryReceiptList($this->version, $this->solution['conversationSid'], $this->solution['sid']);
        }
