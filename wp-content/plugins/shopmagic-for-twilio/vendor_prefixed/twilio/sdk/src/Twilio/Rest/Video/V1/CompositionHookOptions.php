...
abstract class CompositionHookOptions
{
     ...
     */
    public static function create(bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $videoLayout = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSources = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $trim = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateCompositionHookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateCompositionHookOptions($enabled, $videoLayout, $audioSources, $audioSourcesExcluded, $resolution, $format, $statusCallback, $statusCallbackMethod, $trim);
    }
    /**
     ...
     */
    public static function read(bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadCompositionHookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadCompositionHookOptions($enabled, $dateCreatedAfter, $dateCreatedBefore, $friendlyName);
    }
    /**
     ...
     */
    public static function update(bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $videoLayout = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSources = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $trim = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\UpdateCompositionHookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\UpdateCompositionHookOptions($enabled, $videoLayout, $audioSources, $audioSourcesExcluded, $trim, $format, $resolution, $statusCallback, $statusCallbackMethod);
    }
}
class CreateCompositionHookOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $enabled Whether the composition hook is active. When `true`, the composition hook will be triggered for every completed Group Room in the account. When `false`, the composition hook will never be triggered.
     * @param array $videoLayout An object that describes the video layout of the composition hook in terms of regions. See [Specifying Video Layouts](https://www.twilio.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info.
     ...
     * @param bool $trim Whether to clip the intervals where there is no active media in the Compositions triggered by the composition hook. The default is `true`. Compositions with `trim` enabled are shorter when the Room is created and no Participant joins for a while as well as if all the Participants leave the room and join later, because those gaps will be removed. See [Specifying Video Layouts](https://www.twilio.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info.
     */
    public function __construct(bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $videoLayout = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSources = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $trim = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class ReadCompositionHookOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $enabled Read only CompositionHook resources with an `enabled` value that matches this parameter.
     * @param \DateTime $dateCreatedAfter Read only CompositionHook resources created on or after this [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) datetime with time zone.
     ...
     * @param string $friendlyName Read only CompositionHook resources with friendly names that match this string. The match is not case sensitive and can include asterisk `*` characters as wildcard match.
     */
    public function __construct(bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['enabled'] = $enabled;
...
class UpdateCompositionHookOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $enabled Whether the composition hook is active. When `true`, the composition hook will be triggered for every completed Group Room in the account. When `false`, the composition hook never triggers.
     * @param array $videoLayout A JSON object that describes the video layout of the composition hook in terms of regions. See [Specifying Video Layouts](https://www.twilio.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info.
     ...
     * @param string $statusCallbackMethod The HTTP method we should use to call `status_callback`. Can be: `POST` or `GET` and the default is `POST`.
     */
    public function __construct(bool $enabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $videoLayout = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSources = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $trim = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['enabled'] = $enabled;
        $this->options['videoLayout'] = $videoLayout;
        $this->options['audioSources'] = $audioSources;
