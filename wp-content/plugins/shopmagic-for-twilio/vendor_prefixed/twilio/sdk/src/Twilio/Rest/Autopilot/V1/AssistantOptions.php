...
abstract class AssistantOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $defaults = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\CreateAssistantOptions
    {
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $defaults = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $developmentStage = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\UpdateAssistantOptions
    {
...
class CreateAssistantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param array $defaults A JSON object that defines the Assistant's [default tasks](https://www.twilio.com/docs/autopilot/api/assistant/defaults) for various scenarios, including initiation actions and fallback tasks.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $defaults = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE)
    {
...
class UpdateAssistantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $developmentStage A string describing the state of the assistant.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $logQueries = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackEvents = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $styleSheet = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $defaults = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $developmentStage = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
        $this->options['logQueries'] = $logQueries;
        $this->options['uniqueName'] = $uniqueName;
