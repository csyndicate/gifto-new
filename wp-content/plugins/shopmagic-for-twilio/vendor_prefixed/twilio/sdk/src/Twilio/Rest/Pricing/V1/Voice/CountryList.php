...
class CountryList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Voice\CountryPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Voice\CountryPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return CountryPage Page of CountryInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Voice\CountryPage
    {
     ...
     */
    public function getContext(string $isoCountry) : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Voice\CountryContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1\Voice\CountryContext($this->version, $isoCountry);
    }
    /**
