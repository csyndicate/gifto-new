...
class RoleContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\RoleInstance
    {
        $payload = $this->version->fetch('GET', $this->uri);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\RoleInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sid']);
    }
    /**
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(array $permission) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\RoleInstance
    {
