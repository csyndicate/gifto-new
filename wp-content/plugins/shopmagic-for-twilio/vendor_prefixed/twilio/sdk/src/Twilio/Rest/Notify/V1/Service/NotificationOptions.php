...
abstract class NotificationOptions
{
     ...
     */
    public static function create(array $identity = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $tag = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $title = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sound = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $action = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $apn = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $gcm = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $sms = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $facebookMessenger = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $fcm = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $segment = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $alexa = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $toBinding = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $deliveryCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\Service\CreateNotificationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\Service\CreateNotificationOptions($identity, $tag, $body, $priority, $ttl, $title, $sound, $action, $data, $apn, $gcm, $sms, $facebookMessenger, $fcm, $segment, $alexa, $toBinding, $deliveryCallbackUrl);
    }
}
class CreateNotificationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string[] $identity The `identity` value that uniquely identifies the new resource's [User](https://www.twilio.com/docs/chat/rest/user-resource) within the [Service](https://www.twilio.com/docs/notify/api/service-resource). Delivery will be attempted only to Bindings with an Identity in this list. No more than 20 items are allowed in this list.
     * @param string[] $tag A tag that selects the Bindings to notify. Repeat this parameter to specify more than one tag, up to a total of 5 tags. The implicit tag `all` is available to notify all Bindings in a Service instance. Similarly, the implicit tags `apn`, `fcm`, `gcm`, `sms` and `facebook-messenger` are available to notify all Bindings in a specific channel.
     ...
     * @param string $deliveryCallbackUrl URL to send webhooks.
     */
    public function __construct(array $identity = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $tag = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $title = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sound = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $action = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $apn = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $gcm = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $sms = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $facebookMessenger = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $fcm = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $segment = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $alexa = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $toBinding = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $deliveryCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
