...
class DeliveryReceiptList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $chatServiceSid, string $conversationSid, string $messageSid)
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\Message\DeliveryReceiptPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\Message\DeliveryReceiptPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return DeliveryReceiptPage Page of DeliveryReceiptInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\Message\DeliveryReceiptPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\Message\DeliveryReceiptContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\Message\DeliveryReceiptContext($this->version, $this->solution['chatServiceSid'], $this->solution['conversationSid'], $this->solution['messageSid'], $sid);
    }
    /**
