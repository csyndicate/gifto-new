...
class EvaluationContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    /**
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\Bundle\EvaluationInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Numbers\V2\RegulatoryCompliance\Bundle\EvaluationInstance($this->version, $payload, $this->solution['bundleSid'], $this->solution['sid']);
    }
    /**
