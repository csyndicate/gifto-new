...
class Conversations extends \ShopMagicTwilioVendor\Twilio\Rest\ConversationsBase
{
    /**
     * @deprecated Use v1->configuration instead.
     */
    protected function getConfiguration() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ConfigurationList
    {
     ...
     * @deprecated Use v1->configuration() instead.
     */
    protected function contextConfiguration() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ConfigurationContext
    {
        echo "configuration() is deprecated. Use v1->configuration() instead.";
        return $this->v1->configuration();
    }
     ...
     */
    protected function getAddressConfigurations() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\AddressConfigurationList
    {
     ...
     */
    protected function contextAddressConfigurations(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\AddressConfigurationContext
    {
     ...
     */
    protected function getConversations() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ConversationList
    {
     ...
     *                    resource.
     */
    protected function contextConversations(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ConversationContext
    {
     ...
     */
    protected function getCredentials() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialList
    {
     ...
     *                    resource.
     */
    protected function contextCredentials(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\CredentialContext
    {
     ...
     */
    protected function getParticipantConversations() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ParticipantConversationList
    {
     ...
     */
    protected function getRoles() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleList
    {
     ...
     */
    protected function contextRoles(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleContext
    {
     ...
     */
    protected function getServices() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ServiceList
    {
     ...
     *                    resource.
     */
    protected function contextServices(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\ServiceContext
    {
     ...
     */
    protected function getUsers() : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserList
    {
     ...
     */
    protected function contextUsers(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UserContext
    {
