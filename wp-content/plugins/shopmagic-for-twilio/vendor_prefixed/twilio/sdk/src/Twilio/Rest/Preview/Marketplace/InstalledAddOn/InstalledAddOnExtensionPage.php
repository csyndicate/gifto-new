...
class InstalledAddOnExtensionPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\InstalledAddOn\InstalledAddOnExtensionInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace\InstalledAddOn\InstalledAddOnExtensionInstance($this->version, $payload, $this->solution['installedAddOnSid']);
    }
    /**
