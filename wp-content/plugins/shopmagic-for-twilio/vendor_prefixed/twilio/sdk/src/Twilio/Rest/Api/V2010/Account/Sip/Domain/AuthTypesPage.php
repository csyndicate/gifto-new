...
class AuthTypesPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\Domain\AuthTypesInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\Domain\AuthTypesInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['domainSid']);
    }
    /**
