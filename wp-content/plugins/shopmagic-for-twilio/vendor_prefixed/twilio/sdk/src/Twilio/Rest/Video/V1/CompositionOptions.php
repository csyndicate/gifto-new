...
abstract class CompositionOptions
{
     ...
     */
    public static function create(array $videoLayout = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSources = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $trim = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateCompositionOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateCompositionOptions($videoLayout, $audioSources, $audioSourcesExcluded, $resolution, $format, $statusCallback, $statusCallbackMethod, $trim);
    }
    /**
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $roomSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadCompositionOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadCompositionOptions($status, $dateCreatedAfter, $dateCreatedBefore, $roomSid);
    }
}
class CreateCompositionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param array $videoLayout An object that describes the video layout of the composition in terms of regions. See [Specifying Video Layouts](https://www.twilio.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info. Please, be aware that either video_layout or audio_sources have to be provided to get a valid creation request
     * @param string[] $audioSources An array of track names from the same group room to merge into the new composition. Can include zero or more track names. The new composition includes all audio sources specified in `audio_sources` except for those specified in `audio_sources_excluded`. The track names in this parameter can include an asterisk as a wild card character, which will match zero or more characters in a track name. For example, `student*` includes `student` as well as `studentTeam`. Please, be aware that either video_layout or audio_sources have to be provided to get a valid creation request
     ...
     * @param bool $trim Whether to clip the intervals where there is no active media in the composition. The default is `true`. Compositions with `trim` enabled are shorter when the Room is created and no Participant joins for a while as well as if all the Participants leave the room and join later, because those gaps will be removed. See [Specifying Video Layouts](https://www.twilio.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info.
     */
    public function __construct(array $videoLayout = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSources = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $trim = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class ReadCompositionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $status Read only Composition resources with this status. Can be: `enqueued`, `processing`, `completed`, `deleted`, or `failed`.
     * @param \DateTime $dateCreatedAfter Read only Composition resources created on or after this [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date-time with time zone.
     ...
     * @param string $roomSid Read only Composition resources with this Room SID.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $roomSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
