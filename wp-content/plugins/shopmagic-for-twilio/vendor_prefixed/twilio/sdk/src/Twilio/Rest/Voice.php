...
class Voice extends \ShopMagicTwilioVendor\Twilio\Rest\VoiceBase
{
    /**
     ...
     */
    protected function contextArchivedCalls(\DateTime $date, string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ArchivedCallContext
    {
     ...
     */
    protected function contextByocTrunks(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ByocTrunkContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectionPolicies(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIpRecords(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\IpRecordContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSourceIpMappings(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\SourceIpMappingContext
    {
