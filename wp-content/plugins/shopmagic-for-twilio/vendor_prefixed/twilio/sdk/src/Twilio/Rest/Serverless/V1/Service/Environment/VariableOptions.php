...
abstract class VariableOptions
{
     ...
     */
    public static function update(string $key = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $value = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Environment\UpdateVariableOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\Service\Environment\UpdateVariableOptions($key, $value);
    }
}
class UpdateVariableOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $key A string by which the Variable resource can be referenced. It can be a maximum of 128 characters.
     * @param string $value A string that contains the actual value of the Variable. It can be a maximum of 450 bytes in size.
     */
    public function __construct(string $key = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $value = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
