...
abstract class SmsCommandOptions
{
     ...
     */
    public static function create(string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateSmsCommandOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateSmsCommandOptions($callbackMethod, $callbackUrl);
    }
    /**
     * @param string $sim The SID or unique name of the Sim resource that SMS Command was sent to or from.
     * @param string $status The status of the SMS Command. Can be: `queued`, `sent`, `delivered`, `received` or `failed`. See the [SMS Command Status Values](https://www.twilio.com/docs/iot/supersim/api/smscommand-resource#status-values) for a description of each.
     ...
     */
    public static function read(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadSmsCommandOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadSmsCommandOptions($sim, $status, $direction);
    }
}
class CreateSmsCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $callbackMethod The HTTP method we should use to call `callback_url`. Can be: `GET` or `POST` and the default is POST.
     * @param string $callbackUrl The URL we should call using the `callback_method` after we have sent the command.
     */
    public function __construct(string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadSmsCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $sim The SID or unique name of the Sim resource that SMS Command was sent to or from.
     * @param string $status The status of the SMS Command. Can be: `queued`, `sent`, `delivered`, `received` or `failed`. See the [SMS Command Status Values](https://www.twilio.com/docs/iot/supersim/api/smscommand-resource#status-values) for a description of each.
     * @param string $direction The direction of the SMS Command. Can be `to_sim` or `from_sim`. The value of `to_sim` is synonymous with the term `mobile terminated`, and `from_sim` is synonymous with the term `mobile originated`.
     */
    public function __construct(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
