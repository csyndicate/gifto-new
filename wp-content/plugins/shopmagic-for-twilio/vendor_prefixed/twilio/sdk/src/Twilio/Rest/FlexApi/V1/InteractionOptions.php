...
abstract class InteractionOptions
{
     ...
     */
    public static function create(string $interactionContextSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\CreateInteractionOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\CreateInteractionOptions($interactionContextSid);
    }
}
class CreateInteractionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $interactionContextSid The Interaction context sid is used for adding a context lookup sid
     */
    public function __construct(string $interactionContextSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
