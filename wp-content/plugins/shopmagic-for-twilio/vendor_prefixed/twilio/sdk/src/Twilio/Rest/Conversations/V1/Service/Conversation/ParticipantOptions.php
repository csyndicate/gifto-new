...
abstract class ParticipantOptions
{
     ...
     */
    public static function create(string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\CreateParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\CreateParticipantOptions($identity, $messagingBindingAddress, $messagingBindingProxyAddress, $dateCreated, $dateUpdated, $attributes, $messagingBindingProjectedAddress, $roleSid, $xTwilioWebhookEnabled);
    }
    /**
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     * @return DeleteParticipantOptions Options builder
     */
    public static function delete(string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\DeleteParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\DeleteParticipantOptions($xTwilioWebhookEnabled);
    }
    /**
     * @param \DateTime $dateCreated The date on which this resource was created.
     * @param \DateTime $dateUpdated The date on which this resource was last updated.
     ...
     */
    public static function update(\DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $lastReadMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $lastReadTimestamp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\UpdateParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Conversation\UpdateParticipantOptions($dateCreated, $dateUpdated, $identity, $attributes, $roleSid, $messagingBindingProxyAddress, $messagingBindingProjectedAddress, $lastReadMessageIndex, $lastReadTimestamp, $xTwilioWebhookEnabled);
    }
}
class CreateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     */
    public function __construct(string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class DeleteParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     */
...
class UpdateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     */
    public function __construct(\DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $lastReadMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $lastReadTimestamp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['dateCreated'] = $dateCreated;
        $this->options['dateUpdated'] = $dateUpdated;
        $this->options['identity'] = $identity;
