...
abstract class SimOptions
{
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fleet = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $iccid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadSimOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadSimOptions($status, $fleet, $iccid);
    }
    /**
     ...
     */
    public static function update(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fleet = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $accountSid = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\UpdateSimOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\UpdateSimOptions($uniqueName, $status, $fleet, $callbackUrl, $callbackMethod, $accountSid);
    }
}
class ReadSimOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $iccid The [ICCID](https://en.wikipedia.org/wiki/Subscriber_identity_module#ICCID) associated with a Super SIM to filter the list by. Passing this parameter will always return a list containing zero or one SIMs.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fleet = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $iccid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateSimOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $accountSid The SID of the Account to which the Sim resource should belong. The Account SID can only be that of the requesting Account or that of a Subaccount of the requesting Account. Only valid when the Sim resource's status is new.
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fleet = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $accountSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
