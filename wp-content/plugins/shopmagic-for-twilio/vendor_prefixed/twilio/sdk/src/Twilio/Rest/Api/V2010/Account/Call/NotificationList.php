...
class NotificationList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\NotificationPage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['Log' => $options['log'], 'MessageDate<' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['messageDateBefore']), 'MessageDate' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['messageDate']), 'MessageDate>' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['messageDateAfter']), 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\NotificationPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return NotificationPage Page of NotificationInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\NotificationPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\NotificationContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\NotificationContext($this->version, $this->solution['accountSid'], $this->solution['callSid'], $sid);
    }
    /**
