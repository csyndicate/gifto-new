...
use ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1;
class Microvisor extends \ShopMagicTwilioVendor\Twilio\Rest\MicrovisorBase
{
    /**
     * @deprecated Use v1->apps instead.
     */
    protected function getApps() : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AppList
    {
     ...
     */
    protected function contextApps(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\AppContext
    {
     ...
     */
    protected function getDevices() : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\DeviceList
    {
     ...
     */
    protected function contextDevices(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Microvisor\V1\DeviceContext
    {
