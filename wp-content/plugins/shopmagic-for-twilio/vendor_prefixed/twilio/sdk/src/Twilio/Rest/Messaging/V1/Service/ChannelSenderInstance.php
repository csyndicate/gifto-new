 ...
 */
class ChannelSenderInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $messagingServiceSid, string $sid = null)
    {
        ...
        $this->properties = ['accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'messagingServiceSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'messaging_service_sid'), 'sid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'sid'), 'sender' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'sender'), 'senderType' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'sender_type'), 'countryCode' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'country_code'), 'dateCreated' => \ShopMagicTwilioVendor\Twilio\Deserialize::dateTime(\ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'date_created')), 'dateUpdated' => \ShopMagicTwilioVendor\Twilio\Deserialize::dateTime(\ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'date_updated')), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\ChannelSenderContext($this->version, $this->solution['messagingServiceSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
