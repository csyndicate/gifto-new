...
abstract class UserOptions
{
     ...
     */
    public static function create(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\CreateUserOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\CreateUserOptions($roleSid, $attributes, $friendlyName, $xTwilioWebhookEnabled);
    }
    /**
     ...
     */
    public static function update(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\UpdateUserOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\UpdateUserOptions($roleSid, $attributes, $friendlyName, $xTwilioWebhookEnabled);
    }
}
