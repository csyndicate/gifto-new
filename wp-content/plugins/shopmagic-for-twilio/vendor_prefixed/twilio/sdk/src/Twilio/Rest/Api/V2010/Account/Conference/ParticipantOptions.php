...
abstract class ParticipantOptions
{
     ...
     */
    public static function create(string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $statusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $label = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $record = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $beep = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $startConferenceOnEnter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $endConferenceOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $waitUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $earlyMedia = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $conferenceRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceTrim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $conferenceStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $region = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $conferenceRecordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $coaching = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $callSidToCoach = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $jitterBufferSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $byoc = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callerId = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callReason = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingTrack = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $machineDetection = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $machineDetectionTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSpeechThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSpeechEndThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSilenceTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $amdStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $amdStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callToken = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\CreateParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\CreateParticipantOptions($statusCallback, $statusCallbackMethod, $statusCallbackEvent, $label, $timeout, $record, $muted, $beep, $startConferenceOnEnter, $endConferenceOnExit, $waitUrl, $waitMethod, $earlyMedia, $maxParticipants, $conferenceRecord, $conferenceTrim, $conferenceStatusCallback, $conferenceStatusCallbackMethod, $conferenceStatusCallbackEvent, $recordingChannels, $recordingStatusCallback, $recordingStatusCallbackMethod, $sipAuthUsername, $sipAuthPassword, $region, $conferenceRecordingStatusCallback, $conferenceRecordingStatusCallbackMethod, $recordingStatusCallbackEvent, $conferenceRecordingStatusCallbackEvent, $coaching, $callSidToCoach, $jitterBufferSize, $byoc, $callerId, $callReason, $recordingTrack, $timeLimit, $machineDetection, $machineDetectionTimeout, $machineDetectionSpeechThreshold, $machineDetectionSpeechEndThreshold, $machineDetectionSilenceTimeout, $amdStatusCallback, $amdStatusCallbackMethod, $trim, $callToken);
    }
    /**
     ...
     */
    public static function read(bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $hold = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $coaching = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\ReadParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\ReadParticipantOptions($muted, $hold, $coaching);
    }
    /**
     ...
     */
    public static function update(bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $hold = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $holdUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $holdMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $announceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $announceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $beepOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $endConferenceOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $coaching = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $callSidToCoach = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\UpdateParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\UpdateParticipantOptions($muted, $hold, $holdUrl, $holdMethod, $announceUrl, $announceMethod, $waitUrl, $waitMethod, $beepOnExit, $endConferenceOnExit, $coaching, $callSidToCoach);
    }
}
class CreateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $callToken A token string needed to invoke a forwarded call. A call_token is generated when an incoming call is received on a Twilio number. Pass an incoming call's call_token value to a forwarded call via the call_token parameter when creating a new call. A forwarded call should bear the same CallerID of the original incoming call.
     */
    public function __construct(string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $statusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $label = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $record = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $beep = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $startConferenceOnEnter = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $endConferenceOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $waitUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $earlyMedia = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $conferenceRecord = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceTrim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $conferenceStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $region = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $conferenceRecordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $conferenceRecordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $coaching = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $callSidToCoach = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $jitterBufferSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $byoc = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callerId = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callReason = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingTrack = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $machineDetection = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $machineDetectionTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSpeechThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSpeechEndThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSilenceTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $amdStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $amdStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callToken = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $muted Whether to return only participants that are muted. Can be: `true` or `false`.
     * @param bool $hold Whether to return only participants that are on hold. Can be: `true` or `false`.
     * @param bool $coaching Whether to return only participants who are coaching another call. Can be: `true` or `false`.
     */
    public function __construct(bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $hold = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $coaching = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
        $this->options['muted'] = $muted;
...
class UpdateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $muted Whether the participant should be muted. Can be `true` or `false`. `true` will mute the participant, and `false` will un-mute them. Anything value other than `true` or `false` is interpreted as `false`.
     * @param bool $hold Whether the participant should be on hold. Can be: `true` or `false`. `true` puts the participant on hold, and `false` lets them rejoin the conference.
     ...
     * @param string $callSidToCoach The SID of the participant who is being `coached`. The participant being coached is the only participant who can hear the participant who is `coaching`.
     */
    public function __construct(bool $muted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $hold = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $holdUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $holdMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $announceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $announceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $waitMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $beepOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $endConferenceOnExit = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $coaching = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $callSidToCoach = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['muted'] = $muted;
        $this->options['hold'] = $hold;
