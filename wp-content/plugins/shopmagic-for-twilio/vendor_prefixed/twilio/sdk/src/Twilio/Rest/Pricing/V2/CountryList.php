...
class CountryList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V2\CountryPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V2\CountryPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return CountryPage Page of CountryInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V2\CountryPage
    {
     ...
     */
    public function getContext(string $isoCountry) : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V2\CountryContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V2\CountryContext($this->version, $isoCountry);
    }
    /**
