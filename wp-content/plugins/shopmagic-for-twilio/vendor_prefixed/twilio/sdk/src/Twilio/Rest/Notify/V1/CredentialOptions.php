...
abstract class CredentialOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $certificate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $privateKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sandbox = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $apiKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $secret = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\CreateCredentialOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\CreateCredentialOptions($friendlyName, $certificate, $privateKey, $sandbox, $apiKey, $secret);
    }
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It can be up to 64 characters long.
     * @param string $certificate [APN only] The URL-encoded representation of the certificate. Strip everything outside of the headers, e.g. `-----BEGIN CERTIFICATE-----MIIFnTCCBIWgAwIBAgIIAjy9H849+E8wDQYJKoZIhvcNAQEFBQAwgZYxCzAJBgNV.....A==-----END CERTIFICATE-----`
     ...
     */
    public static function update(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $certificate = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $privateKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $sandbox = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $apiKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $secret = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\UpdateCredentialOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Notify\V1\UpdateCredentialOptions($friendlyName, $certificate, $privateKey, $sandbox, $apiKey, $secret);
    }
}
