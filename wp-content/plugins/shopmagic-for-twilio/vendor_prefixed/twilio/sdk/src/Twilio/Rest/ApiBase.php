 ...
 */
class ApiBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v2010;
    /**
     ...
     */
    protected function getV2010() : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010
    {
        if (!$this->_v2010) {
            $this->_v2010 = new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010($this);
        }
        return $this->_v2010;
    }
    /**
