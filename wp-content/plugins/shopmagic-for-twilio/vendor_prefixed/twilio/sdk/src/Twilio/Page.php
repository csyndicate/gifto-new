...
use ShopMagicTwilioVendor\Twilio\Exceptions\DeserializeException;
...
abstract class Page implements \Iterator
{
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, \ShopMagicTwilioVendor\Twilio\Http\Response $response)
    {
    ...
    protected function processResponse(\ShopMagicTwilioVendor\Twilio\Http\Response $response)
    {
        if ($response->getStatusCode() !== 200 && !$this->isPagingEol($response->getContent())) {
            ...
            throw new \ShopMagicTwilioVendor\Twilio\Exceptions\RestException($message, $code, $response->getStatusCode(), $moreInfo, $details);
        }
    ...
    protected function loadPage() : array
    {
        ...
        throw new \ShopMagicTwilioVendor\Twilio\Exceptions\DeserializeException('Page Records can not be deserialized');
    }
    ...
    public function nextPage() : ?\ShopMagicTwilioVendor\Twilio\Page
    {
    ...
    public function previousPage() : ?\ShopMagicTwilioVendor\Twilio\Page
    {
    ...
    public function getVersion() : \ShopMagicTwilioVendor\Twilio\Version
    {
        return $this->version;
    }
