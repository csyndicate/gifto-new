...
class ShortCodeList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodeInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['Sid' => $sid]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodeInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodePage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ShortCodePage Page of ShortCodeInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodeContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Proxy\V1\Service\ShortCodeContext($this->version, $this->solution['serviceSid'], $sid);
    }
    /**
