...
abstract class RecordingOptions
{
     ...
     */
    public static function read(string $dateCreatedBefore = null, string $dateCreated = null, string $dateCreatedAfter = null) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\ReadRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\ReadRecordingOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter);
    }
    /**
     ...
     */
    public static function update(string $pauseBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\UpdateRecordingOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Conference\UpdateRecordingOptions($pauseBehavior);
    }
}
