...
abstract class RoomOptions
{
     ...
     */
    public static function create(bool $enableTurn = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $type = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $recordParticipantsOnConnect = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $videoCodecs = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $mediaRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $recordingRules = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $audioOnly = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $maxParticipantDuration = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $emptyRoomTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $unusedRoomTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $largeRoom = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateRoomOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateRoomOptions($enableTurn, $type, $uniqueName, $statusCallback, $statusCallbackMethod, $maxParticipants, $recordParticipantsOnConnect, $videoCodecs, $mediaRegion, $recordingRules, $audioOnly, $maxParticipantDuration, $emptyRoomTimeout, $unusedRoomTimeout, $largeRoom);
    }
    /**
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadRoomOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\ReadRoomOptions($status, $uniqueName, $dateCreatedAfter, $dateCreatedBefore);
    }
}
class CreateRoomOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $enableTurn Deprecated, now always considered to be true.
     * @param string $type
     ...
     * @param bool $largeRoom When set to true, indicated that this is the large room.
     */
    public function __construct(bool $enableTurn = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $type = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $recordParticipantsOnConnect = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, array $videoCodecs = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $mediaRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $recordingRules = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, bool $audioOnly = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $maxParticipantDuration = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $emptyRoomTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $unusedRoomTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $largeRoom = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class ReadRoomOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $status Read only the rooms with this status. Can be: `in-progress` (default) or `completed`
     * @param string $uniqueName Read only rooms with the this `unique_name`.
     ...
     * @param \DateTime $dateCreatedBefore Read only rooms that started before this date, given as `YYYY-MM-DD`.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null)
    {
