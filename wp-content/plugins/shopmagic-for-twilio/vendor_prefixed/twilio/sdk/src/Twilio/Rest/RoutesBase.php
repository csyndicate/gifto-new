 ...
 */
class RoutesBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v2;
    /**
     ...
     */
    protected function getV2() : \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2
    {
        if (!$this->_v2) {
            $this->_v2 = new \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2($this);
        }
        return $this->_v2;
    }
    /**
