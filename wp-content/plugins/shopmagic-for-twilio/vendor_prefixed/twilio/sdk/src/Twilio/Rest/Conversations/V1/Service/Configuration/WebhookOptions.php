...
abstract class WebhookOptions
{
     ...
     */
    public static function update(string $preWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $postWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $filters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Configuration\UpdateWebhookOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Service\Configuration\UpdateWebhookOptions($preWebhookUrl, $postWebhookUrl, $filters, $method);
    }
}
class UpdateWebhookOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $method The HTTP method to be used when sending a webhook request. One of `GET` or `POST`.
     */
    public function __construct(string $preWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $postWebhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $filters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
