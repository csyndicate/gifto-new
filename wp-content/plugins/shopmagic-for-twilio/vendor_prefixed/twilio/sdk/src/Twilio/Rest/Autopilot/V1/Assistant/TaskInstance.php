...
class TaskInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\TaskContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\TaskContext($this->version, $this->solution['assistantSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
