...
class TemplateList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\TemplatePage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\TemplatePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return TemplatePage Page of TemplateInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\TemplatePage
    {
