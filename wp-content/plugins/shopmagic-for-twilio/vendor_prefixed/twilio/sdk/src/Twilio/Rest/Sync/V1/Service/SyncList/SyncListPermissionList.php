...
class SyncListPermissionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SyncListPermissionPage Page of SyncListPermissionInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionPage
    {
     ...
     */
    public function getContext(string $identity) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionContext($this->version, $this->solution['serviceSid'], $this->solution['listSid'], $identity);
    }
    /**
