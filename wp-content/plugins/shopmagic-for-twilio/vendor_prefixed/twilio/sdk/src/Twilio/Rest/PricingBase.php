 ...
 */
class PricingBase extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v1;
    protected $_v2;
    /**
     ...
     */
    protected function getV1() : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V1
    {
        if (!$this->_v1) {
     ...
     */
    protected function getV2() : \ShopMagicTwilioVendor\Twilio\Rest\Pricing\V2
    {
        if (!$this->_v2) {
