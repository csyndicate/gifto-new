...
abstract class ParticipantOptions
{
     ...
     */
    public static function create(string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\CreateParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\CreateParticipantOptions($identity, $messagingBindingAddress, $messagingBindingProxyAddress, $dateCreated, $dateUpdated, $attributes, $messagingBindingProjectedAddress, $roleSid, $xTwilioWebhookEnabled);
    }
    /**
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     * @return DeleteParticipantOptions Options builder
     */
    public static function delete(string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\DeleteParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\DeleteParticipantOptions($xTwilioWebhookEnabled);
    }
    /**
     * @param \DateTime $dateCreated The date that this resource was created.
     * @param \DateTime $dateUpdated The date that this resource was last updated.
     ...
     */
    public static function update(\DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $lastReadMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $lastReadTimestamp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\UpdateParticipantOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\UpdateParticipantOptions($dateCreated, $dateUpdated, $attributes, $roleSid, $messagingBindingProxyAddress, $messagingBindingProjectedAddress, $identity, $lastReadMessageIndex, $lastReadTimestamp, $xTwilioWebhookEnabled);
    }
}
...
class UpdateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $xTwilioWebhookEnabled The X-Twilio-Webhook-Enabled HTTP request header
     */
    public function __construct(\DateTime $dateCreated = null, \DateTime $dateUpdated = null, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $lastReadMessageIndex = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $lastReadTimestamp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $xTwilioWebhookEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['dateCreated'] = $dateCreated;
        $this->options['dateUpdated'] = $dateUpdated;
        $this->options['attributes'] = $attributes;
