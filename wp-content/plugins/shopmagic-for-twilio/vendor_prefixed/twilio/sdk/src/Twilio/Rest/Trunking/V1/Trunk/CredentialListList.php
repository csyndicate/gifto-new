...
class CredentialListList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $credentialListSid) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListInstance
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['CredentialListSid' => $credentialListSid]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListInstance($this->version, $payload, $this->solution['trunkSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return CredentialListPage Page of CredentialListInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\CredentialListContext($this->version, $this->solution['trunkSid'], $sid);
    }
    /**
