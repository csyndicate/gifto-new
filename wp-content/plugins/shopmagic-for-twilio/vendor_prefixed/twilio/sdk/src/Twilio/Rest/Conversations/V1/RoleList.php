...
class RoleList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $friendlyName, string $type, array $permission) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RolePage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RolePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return RolePage Page of RoleInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RolePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\RoleContext($this->version, $sid);
    }
    /**
