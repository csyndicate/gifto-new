...
abstract class MetricOptions
{
     ...
     */
    public static function read(string $edge = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Insights\V1\Call\ReadMetricOptions
    {
...
class ReadMetricOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $direction The Direction of this Metric. One of `unknown`, `inbound`, `outbound` or `both`.
     */
    public function __construct(string $edge = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
