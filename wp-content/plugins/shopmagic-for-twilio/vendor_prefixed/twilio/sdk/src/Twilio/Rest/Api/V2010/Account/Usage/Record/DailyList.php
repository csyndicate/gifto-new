...
class DailyList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\DailyPage
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\DailyPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return DailyPage Page of DailyInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Usage\Record\DailyPage
    {
