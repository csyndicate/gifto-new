 ...
 */
class MediaProcessorInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $sid = null)
    {
        ...
        $this->properties = ['accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'sid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'sid'), 'dateCreated' => \ShopMagicTwilioVendor\Twilio\Deserialize::dateTime(\ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'date_created')), 'dateUpdated' => \ShopMagicTwilioVendor\Twilio\Deserialize::dateTime(\ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'date_updated')), 'extension' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'extension'), 'extensionContext' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'extension_context'), 'status' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'status'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url'), 'endedReason' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'ended_reason'), 'statusCallback' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'status_callback'), 'statusCallbackMethod' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'status_callback_method'), 'maxDuration' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'max_duration')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\MediaProcessorContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Media\V1\MediaProcessorContext($this->version, $this->solution['sid']);
        }
        return $this->context;
    }
    /**
