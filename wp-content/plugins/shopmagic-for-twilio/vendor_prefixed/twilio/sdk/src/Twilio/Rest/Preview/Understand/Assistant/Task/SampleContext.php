...
class SampleContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\Task\SampleInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand\Assistant\Task\SampleInstance($this->version, $payload, $this->solution['assistantSid'], $this->solution['taskSid'], $this->solution['sid']);
    }
    /**
