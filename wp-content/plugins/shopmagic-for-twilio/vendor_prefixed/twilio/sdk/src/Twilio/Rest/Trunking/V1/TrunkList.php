...
class TrunkList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return TrunkPage Page of TrunkInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\TrunkContext($this->version, $sid);
    }
    /**
