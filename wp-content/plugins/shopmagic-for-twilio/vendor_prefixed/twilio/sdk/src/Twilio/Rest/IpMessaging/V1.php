 ...
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\IpMessaging;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\InstanceContext;
use ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\CredentialList;
use ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    protected function getCredentials() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\CredentialList
    {
        if (!$this->_credentials) {
            $this->_credentials = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\CredentialList($this);
        }
        return $this->_credentials;
    }
    protected function getServices() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceList
    {
        if (!$this->_services) {
            $this->_services = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceList($this);
        }
