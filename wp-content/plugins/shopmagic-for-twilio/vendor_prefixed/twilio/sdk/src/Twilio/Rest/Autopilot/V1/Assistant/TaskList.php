...
class TaskList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $uniqueName, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\TaskInstance
    {
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\TaskPage
    {
     ...
     * @return TaskPage Page of TaskInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\TaskPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Autopilot\V1\Assistant\TaskContext
    {
