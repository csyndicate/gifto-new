...
abstract class VerificationOptions
{
     ...
     */
    public static function create(string $customFriendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $customMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $locale = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $customCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $rateLimits = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $channelConfiguration = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $appHash = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $templateSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $templateCustomSubstitutions = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $deviceIp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $riskCheck = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\CreateVerificationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\CreateVerificationOptions($customFriendlyName, $customMessage, $sendDigits, $locale, $customCode, $amount, $payee, $rateLimits, $channelConfiguration, $appHash, $templateSid, $templateCustomSubstitutions, $deviceIp, $riskCheck);
    }
}
class CreateVerificationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $customFriendlyName A custom user defined friendly name that overwrites the existing one in the verification message
     * @param string $customMessage The text of a custom message to use for the verification.
     ...
     * @param string $riskCheck
     */
    public function __construct(string $customFriendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $customMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $locale = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $customCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $rateLimits = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, array $channelConfiguration = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $appHash = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $templateSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $templateCustomSubstitutions = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $deviceIp = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $riskCheck = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
