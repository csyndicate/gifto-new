...
abstract class UserDefinedMessageSubscriptionOptions
{
     ...
     */
    public static function create(string $idempotencyKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateUserDefinedMessageSubscriptionOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateUserDefinedMessageSubscriptionOptions($idempotencyKey, $method);
    }
}
class CreateUserDefinedMessageSubscriptionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $idempotencyKey A unique string value to identify API call. This should be a unique string value per API call and can be a randomly generated.
     * @param string $method The HTTP method Twilio will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`.
     */
    public function __construct(string $idempotencyKey = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
