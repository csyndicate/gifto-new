...
abstract class ServiceOptions
{
     ...
     */
    public static function create(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $webhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $reachabilityWebhooksEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $aclEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $reachabilityDebouncingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $reachabilityDebouncingWindow = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $webhooksFromRestEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\CreateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\CreateServiceOptions($friendlyName, $webhookUrl, $reachabilityWebhooksEnabled, $aclEnabled, $reachabilityDebouncingEnabled, $reachabilityDebouncingWindow, $webhooksFromRestEnabled);
    }
    /**
     * @param string $webhookUrl The URL we should call when Sync objects are manipulated.
     * @param string $friendlyName A string that you assign to describe the resource.
     ...
     */
    public static function update(string $webhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $reachabilityWebhooksEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $aclEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $reachabilityDebouncingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $reachabilityDebouncingWindow = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $webhooksFromRestEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\UpdateServiceOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\UpdateServiceOptions($webhookUrl, $friendlyName, $reachabilityWebhooksEnabled, $aclEnabled, $reachabilityDebouncingEnabled, $reachabilityDebouncingWindow, $webhooksFromRestEnabled);
    }
}
class CreateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $webhooksFromRestEnabled Whether the Service instance should call `webhook_url` when the REST API is used to update Sync objects. The default is `false`.
     */
    public function __construct(string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $webhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $reachabilityWebhooksEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $aclEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $reachabilityDebouncingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $reachabilityDebouncingWindow = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $webhooksFromRestEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
...
class UpdateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $webhooksFromRestEnabled Whether the Service instance should call `webhook_url` when the REST API is used to update Sync objects. The default is `false`.
     */
    public function __construct(string $webhookUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, bool $reachabilityWebhooksEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $aclEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, bool $reachabilityDebouncingEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, int $reachabilityDebouncingWindow = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $webhooksFromRestEnabled = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE)
    {
        $this->options['webhookUrl'] = $webhookUrl;
        $this->options['friendlyName'] = $friendlyName;
        $this->options['reachabilityWebhooksEnabled'] = $reachabilityWebhooksEnabled;
