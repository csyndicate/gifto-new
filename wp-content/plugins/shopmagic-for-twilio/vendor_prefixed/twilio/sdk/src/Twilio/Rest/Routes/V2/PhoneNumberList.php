...
class PhoneNumberList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function getContext(string $phoneNumber) : \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\PhoneNumberContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Routes\V2\PhoneNumberContext($this->version, $phoneNumber);
    }
    /**
