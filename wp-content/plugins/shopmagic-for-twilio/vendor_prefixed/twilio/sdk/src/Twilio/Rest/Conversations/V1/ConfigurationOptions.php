...
abstract class ConfigurationOptions
{
     ...
     */
    public static function update(string $defaultChatServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultMessagingServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultInactiveTimer = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultClosedTimer = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UpdateConfigurationOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\UpdateConfigurationOptions($defaultChatServiceSid, $defaultMessagingServiceSid, $defaultInactiveTimer, $defaultClosedTimer);
    }
}
class UpdateConfigurationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $defaultClosedTimer Default ISO8601 duration when conversation will be switched to `closed` state. Minimum value for this timer is 10 minutes.
     */
    public function __construct(string $defaultChatServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultMessagingServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultInactiveTimer = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $defaultClosedTimer = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
