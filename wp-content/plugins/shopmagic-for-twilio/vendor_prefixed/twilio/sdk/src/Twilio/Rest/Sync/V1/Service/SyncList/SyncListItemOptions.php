...
abstract class SyncListItemOptions
{
     ...
     */
    public static function create(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\CreateSyncListItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\CreateSyncListItemOptions($ttl, $itemTtl, $collectionTtl);
    }
    /**
     ...
     */
    public static function delete(string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\DeleteSyncListItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\DeleteSyncListItemOptions($ifMatch);
    }
    /**
     ...
     */
    public static function read(string $order = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $bounds = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\ReadSyncListItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\ReadSyncListItemOptions($order, $from, $bounds);
    }
    /**
     ...
     */
    public static function update(array $data = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $ifMatch = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\UpdateSyncListItemOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\UpdateSyncListItemOptions($data, $ttl, $itemTtl, $collectionTtl, $ifMatch);
    }
}
class CreateSyncListItemOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param int $ttl An alias for `item_ttl`. If both parameters are provided, this value is ignored.
     * @param int $itemTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the List Item expires (time-to-live) and is deleted.
