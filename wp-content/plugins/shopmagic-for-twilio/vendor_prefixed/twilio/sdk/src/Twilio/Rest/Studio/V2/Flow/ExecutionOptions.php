...
abstract class ExecutionOptions
{
     ...
     */
    public static function create(array $parameters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\CreateExecutionOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\CreateExecutionOptions($parameters);
    }
    /**
     ...
     */
    public static function read(\DateTime $dateCreatedFrom = null, \DateTime $dateCreatedTo = null) : \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\ReadExecutionOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V2\Flow\ReadExecutionOptions($dateCreatedFrom, $dateCreatedTo);
    }
}
class CreateExecutionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param array $parameters JSON data that will be added to the Flow's context and that can be accessed as variables inside your Flow. For example, if you pass in `Parameters={\\\"name\\\":\\\"Zeke\\\"}`, a widget in your Flow can reference the variable `{{flow.data.name}}`, which returns \\\"Zeke\\\". Note: the JSON value must explicitly be passed as a string, not as a hash object. Depending on your particular HTTP library, you may need to add quotes or URL encode the JSON string.
     */
    public function __construct(array $parameters = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE)
    {
