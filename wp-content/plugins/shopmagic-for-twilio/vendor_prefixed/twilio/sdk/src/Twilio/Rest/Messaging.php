...
class Messaging extends \ShopMagicTwilioVendor\Twilio\Rest\MessagingBase
{
    /**
     * @deprecated
     */
     ...
     */
    protected function contextBrandRegistrations(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\BrandRegistrationContext
    {
     ...
     */
    protected function contextDeactivations() : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\DeactivationsContext
    {
        echo "deactivations() is deprecated. Use v1->deactivations() instead.";
        return $this->v1->deactivations();
    }
     ...
     */
    protected function contextDomainCerts(string $domainSid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\DomainCertsContext
    {
     ...
     */
    protected function contextDomainConfig(string $domainSid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\DomainConfigContext
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextServices(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\ServiceContext
    {
     ...
     */
    protected function contextTollfreeVerifications(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationContext
    {
