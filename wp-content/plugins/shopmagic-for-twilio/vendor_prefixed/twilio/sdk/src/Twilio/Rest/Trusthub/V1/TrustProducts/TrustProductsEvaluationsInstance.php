 ...
 */
class TrustProductsEvaluationsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, string $trustProductSid, string $sid = null)
    {
        ...
        $this->properties = ['sid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'sid'), 'accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'policySid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'policy_sid'), 'trustProductSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'trust_product_sid'), 'status' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'status'), 'results' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'results'), 'dateCreated' => \ShopMagicTwilioVendor\Twilio\Deserialize::dateTime(\ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'date_created')), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url')];
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEvaluationsContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Trusthub\V1\TrustProducts\TrustProductsEvaluationsContext($this->version, $this->solution['trustProductSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
