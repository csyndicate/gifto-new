...
class SyncListPermissionPage extends \ShopMagicTwilioVendor\Twilio\Page
{
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['listSid']);
    }
    /**
