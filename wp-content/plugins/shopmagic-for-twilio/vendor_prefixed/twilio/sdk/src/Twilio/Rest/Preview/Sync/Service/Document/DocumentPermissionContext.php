...
class DocumentPermissionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync\Service\Document\DocumentPermissionInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['documentSid'], $this->solution['identity']);
    }
    /**
