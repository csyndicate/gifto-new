...
abstract class RoomRecordingOptions
{
     ...
     */
    public static function read(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null) : \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\Room\ReadRoomRecordingOptions
    {
...
class ReadRoomRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param \DateTime $dateCreatedBefore Read only Recordings that started before this [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) datetime with time zone.
     */
    public function __construct(string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sourceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null)
    {
