...
abstract class UsageRecordOptions
{
     ...
     */
    public static function read(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fleet = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $network = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $isoCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $group = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $granularity = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startTime = null, \DateTime $endTime = null) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadUsageRecordOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadUsageRecordOptions($sim, $fleet, $network, $isoCountry, $group, $granularity, $startTime, $endTime);
    }
}
class ReadUsageRecordOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param \DateTime $endTime Only include usage that occurred before this time (exclusive), specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. Default is the current time.
     */
    public function __construct(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fleet = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $network = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $isoCountry = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $group = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $granularity = \ShopMagicTwilioVendor\Twilio\Values::NONE, \DateTime $startTime = null, \DateTime $endTime = null)
    {
