...
abstract class SyncStreamOptions
{
     ...
     */
    public static function create(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\CreateSyncStreamOptions
    {
     ...
     */
    public static function update(int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateSyncStreamOptions
    {
...
class CreateSyncStreamOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param int $ttl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Stream expires and is deleted (time-to-live).
     */
    public function __construct(string $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $ttl = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
