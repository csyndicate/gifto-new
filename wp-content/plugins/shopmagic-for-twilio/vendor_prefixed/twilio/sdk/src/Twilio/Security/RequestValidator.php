...
class RequestValidator
{
    ...
    public function validate(string $expectedSignature, string $url, $data = []) : bool
    {
         ...
         */
        $validSignatureWithPort = self::compare($expectedSignature, $this->computeSignature($urlWithPort, $data));
        $validSignatureWithoutPort = self::compare($expectedSignature, $this->computeSignature($urlWithoutPort, $data));
