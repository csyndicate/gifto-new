...
class TollfreeVerificationList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $businessName, string $businessWebsite, string $notificationEmail, array $useCaseCategories, string $useCaseSummary, string $productionMessageSample, array $optInImageUrls, string $optInType, string $messageVolume, string $tollfreePhoneNumberSid, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['BusinessName' => $businessName, 'BusinessWebsite' => $businessWebsite, 'NotificationEmail' => $notificationEmail, 'UseCaseCategories' => \ShopMagicTwilioVendor\Twilio\Serialize::map($useCaseCategories, function ($e) {
            return $e;
        }), 'UseCaseSummary' => $useCaseSummary, 'ProductionMessageSample' => $productionMessageSample, 'OptInImageUrls' => \ShopMagicTwilioVendor\Twilio\Serialize::map($optInImageUrls, function ($e) {
            return $e;
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationInstance($this->version, $payload);
    }
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationPage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['TollfreePhoneNumberSid' => $options['tollfreePhoneNumberSid'], 'Status' => $options['status'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return TollfreeVerificationPage Page of TollfreeVerificationInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\TollfreeVerificationContext($this->version, $sid);
    }
    /**
