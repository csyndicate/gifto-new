...
use ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\AwsList;
use ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyList;
/**
...
class CredentialList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     * Access the aws
     */
    protected function getAws() : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\AwsList
    {
        if (!$this->_aws) {
            $this->_aws = new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\AwsList($this->version);
        }
        return $this->_aws;
    }
    /**
     ...
     */
    protected function getPublicKey() : \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyList
    {
        if (!$this->_publicKey) {
            $this->_publicKey = new \ShopMagicTwilioVendor\Twilio\Rest\Accounts\V1\Credential\PublicKeyList($this->version);
        }
