...
class SyncStreamList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncStreamInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['UniqueName' => $options['uniqueName'], 'Ttl' => $options['ttl']]);
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncStreamPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncStreamPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return SyncStreamPage Page of SyncStreamInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncStreamPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncStreamContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncStreamContext($this->version, $this->solution['serviceSid'], $sid);
    }
    /**
