...
class ExportCustomJobList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, string $resourceType)
    {
     ...
     */
    public function create(string $startDay, string $endDay, string $friendlyName, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\ExportCustomJobInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['StartDay' => $startDay, 'EndDay' => $endDay, 'FriendlyName' => $friendlyName, 'WebhookUrl' => $options['webhookUrl'], 'WebhookMethod' => $options['webhookMethod'], 'Email' => $options['email']]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\ExportCustomJobInstance($this->version, $payload, $this->solution['resourceType']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\ExportCustomJobPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\ExportCustomJobPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ExportCustomJobPage Page of ExportCustomJobInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Bulkexports\V1\Export\ExportCustomJobPage
    {
