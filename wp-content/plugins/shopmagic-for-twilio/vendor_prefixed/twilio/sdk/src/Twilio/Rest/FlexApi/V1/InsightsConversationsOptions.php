...
abstract class InsightsConversationsOptions
{
     ...
     */
    public static function read(string $segmentId = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $authorization = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\ReadInsightsConversationsOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\FlexApi\V1\ReadInsightsConversationsOptions($segmentId, $authorization);
    }
}
class ReadInsightsConversationsOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $segmentId Unique Id of the segment for which conversation details needs to be fetched
     * @param string $authorization The Authorization HTTP request header
