...
use ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\ChannelList;
use ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\RoleList;
use ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\UserList;
/**
...
class ServiceInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceContext
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceContext($this->version, $this->solution['sid']);
        }
        return $this->context;
    }
    /**
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceInstance
    {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function update(array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\ServiceInstance
    {
     ...
     * Access the channels
     */
    protected function getChannels() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\ChannelList
    {
     ...
     * Access the roles
     */
    protected function getRoles() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\RoleList
    {
     ...
     * Access the users
     */
    protected function getUsers() : \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V1\Service\UserList
    {
