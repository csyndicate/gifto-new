...
abstract class IpCommandOptions
{
     ...
     */
    public static function create(string $payloadType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateIpCommandOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\CreateIpCommandOptions($payloadType, $callbackUrl, $callbackMethod);
    }
    /**
     ...
     */
    public static function read(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $simIccid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadIpCommandOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Supersim\V1\ReadIpCommandOptions($sim, $simIccid, $status, $direction);
    }
}
class CreateIpCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $payloadType
     * @param string $callbackUrl The URL we should call using the `callback_method` after we have sent the IP Command.
     * @param string $callbackMethod The HTTP method we should use to call `callback_url`. Can be `GET` or `POST`, and the default is `POST`.
     */
    public function __construct(string $payloadType = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadIpCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $sim The SID or unique name of the Sim resource that IP Command was sent to or from.
     * @param string $simIccid The ICCID of the Sim resource that IP Command was sent to or from.
     ...
     * @param string $direction The direction of the IP Command. Can be `to_sim` or `from_sim`. The value of `to_sim` is synonymous with the term `mobile terminated`, and `from_sim` is synonymous with the term `mobile originated`.
     */
    public function __construct(string $sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $simIccid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
