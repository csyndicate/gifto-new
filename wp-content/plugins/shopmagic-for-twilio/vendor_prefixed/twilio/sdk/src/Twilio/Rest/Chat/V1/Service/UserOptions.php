...
abstract class UserOptions
{
     ...
     */
    public static function create(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\CreateUserOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\CreateUserOptions($roleSid, $attributes, $friendlyName);
    }
    /**
     ...
     */
    public static function update(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UpdateUserOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UpdateUserOptions($roleSid, $attributes, $friendlyName);
    }
}
class CreateUserOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $friendlyName A descriptive string that you create to describe the new resource. This value is often used for display purposes.
     */
    public function __construct(string $roleSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
