...
class InviteList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function create(string $identity, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InviteInstance
    {
     ...
     */
    public function page(array $options = [], $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InvitePage
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InvitePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return InvitePage Page of InviteInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InvitePage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InviteContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\InviteContext($this->version, $this->solution['serviceSid'], $this->solution['channelSid'], $sid);
    }
    /**
