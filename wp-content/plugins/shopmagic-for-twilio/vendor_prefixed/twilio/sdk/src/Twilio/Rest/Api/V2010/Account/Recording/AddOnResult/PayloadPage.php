...
class PayloadPage extends \ShopMagicTwilioVendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadInstance
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['referenceSid'], $this->solution['addOnResultSid']);
    }
    /**
