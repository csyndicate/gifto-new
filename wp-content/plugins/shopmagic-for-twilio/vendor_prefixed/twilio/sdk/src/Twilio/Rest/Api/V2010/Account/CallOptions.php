...
abstract class CallOptions
{
     ...
     */
    public static function create(string $url = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $twiml = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $applicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $statusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $record = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $machineDetection = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $machineDetectionTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callerId = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $machineDetectionSpeechThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSpeechEndThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSilenceTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $asyncAmd = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $asyncAmdStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $asyncAmdStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $byoc = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callReason = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingTrack = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\CreateCallOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\CreateCallOptions($url, $twiml, $applicationSid, $method, $fallbackUrl, $fallbackMethod, $statusCallback, $statusCallbackEvent, $statusCallbackMethod, $sendDigits, $timeout, $record, $recordingChannels, $recordingStatusCallback, $recordingStatusCallbackMethod, $sipAuthUsername, $sipAuthPassword, $machineDetection, $machineDetectionTimeout, $recordingStatusCallbackEvent, $trim, $callerId, $machineDetectionSpeechThreshold, $machineDetectionSpeechEndThreshold, $machineDetectionSilenceTimeout, $asyncAmd, $asyncAmdStatusCallback, $asyncAmdStatusCallbackMethod, $byoc, $callReason, $callToken, $recordingTrack, $timeLimit);
    }
    /**
     ...
     */
    public static function read(string $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $parentCallSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $startTimeBefore = null, string $startTime = null, string $startTimeAfter = null, string $endTimeBefore = null, string $endTime = null, string $endTimeAfter = null) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ReadCallOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ReadCallOptions($to, $from, $parentCallSid, $status, $startTimeBefore, $startTime, $startTimeAfter, $endTimeBefore, $endTime, $endTimeAfter);
    }
    /**
     * @param string $url The absolute URL that returns the TwiML instructions for the call. We will call this URL using the `method` when the call connects. For more information, see the [Url Parameter](https://www.twilio.com/docs/voice/make-calls#specify-a-url-parameter) section in [Making Calls](https://www.twilio.com/docs/voice/make-calls).
     ...
     */
    public static function update(string $url = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $twiml = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\UpdateCallOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\UpdateCallOptions($url, $method, $status, $fallbackUrl, $fallbackMethod, $statusCallback, $statusCallbackMethod, $twiml, $timeLimit);
    }
}
class CreateCallOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $url The absolute URL that returns the TwiML instructions for the call. We will call this URL using the `method` when the call connects. For more information, see the [Url Parameter](https://www.twilio.com/docs/voice/make-calls#specify-a-url-parameter) section in [Making Calls](https://www.twilio.com/docs/voice/make-calls).
     * @param string $twiml TwiML instructions for the call Twilio will use without fetching Twiml from url parameter. If both `twiml` and `url` are provided then `twiml` parameter will be ignored. Max 4000 characters.
     ...
     * @param int $timeLimit The maximum duration of the call in seconds. Constraints depend on account and configuration.
     */
    public function __construct(string $url = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $twiml = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $applicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, array $statusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, bool $record = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE, string $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $machineDetection = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $machineDetectionTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, array $recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::ARRAY_NONE, string $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callerId = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $machineDetectionSpeechThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSpeechEndThreshold = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, int $machineDetectionSilenceTimeout = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE, string $asyncAmd = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $asyncAmdStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $asyncAmdStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $byoc = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callReason = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $callToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $recordingTrack = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
...
class ReadCallOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $to Only show calls made to this phone number, SIP address, Client identifier or SIM SID.
     * @param string $from Only include calls from this phone number, SIP address, Client identifier or SIM SID.
     ...
     * @param string $endTimeAfter Only include calls that ended on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read only calls that ended on this date. You can also specify an inequality, such as `EndTime<=YYYY-MM-DD`, to read calls that ended on or before midnight of this date, and `EndTime>=YYYY-MM-DD` to read calls that ended on or after midnight of this date.
     */
    public function __construct(string $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $parentCallSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $startTimeBefore = null, string $startTime = null, string $startTimeAfter = null, string $endTimeBefore = null, string $endTime = null, string $endTimeAfter = null)
    {
        $this->options['to'] = $to;
...
class UpdateCallOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $url The absolute URL that returns the TwiML instructions for the call. We will call this URL using the `method` when the call connects. For more information, see the [Url Parameter](https://www.twilio.com/docs/voice/make-calls#specify-a-url-parameter) section in [Making Calls](https://www.twilio.com/docs/voice/make-calls).
     * @param string $method The HTTP method we should use when calling the `url`. Can be: `GET` or `POST` and the default is `POST`. If an `application_sid` parameter is present, this parameter is ignored.
     ...
     * @param int $timeLimit The maximum duration of the call in seconds. Constraints depend on account and configuration.
     */
    public function __construct(string $url = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $method = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $fallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $twiml = \ShopMagicTwilioVendor\Twilio\Values::NONE, int $timeLimit = \ShopMagicTwilioVendor\Twilio\Values::INT_NONE)
    {
        $this->options['url'] = $url;
        $this->options['method'] = $method;
        $this->options['status'] = $status;
