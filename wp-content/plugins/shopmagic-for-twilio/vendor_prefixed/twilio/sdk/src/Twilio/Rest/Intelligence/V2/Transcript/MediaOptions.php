...
abstract class MediaOptions
{
     ...
     */
    public static function fetch(bool $redacted = \ShopMagicTwilioVendor\Twilio\Values::BOOL_NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\FetchMediaOptions
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Intelligence\V2\Transcript\FetchMediaOptions($redacted);
    }
}
class FetchMediaOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param bool $redacted Grant access to PII Redacted/Unredacted Media. If redaction is enabled, the default is `true` to access redacted media.
     */
