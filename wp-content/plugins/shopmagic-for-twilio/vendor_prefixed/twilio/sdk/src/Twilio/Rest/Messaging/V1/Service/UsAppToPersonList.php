...
class UsAppToPersonList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
     ...
     */
    public function create(string $brandRegistrationSid, string $description, string $messageFlow, array $messageSamples, string $usAppToPersonUsecase, bool $hasEmbeddedLinks, bool $hasEmbeddedPhone, array $options = []) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonInstance
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(['BrandRegistrationSid' => $brandRegistrationSid, 'Description' => $description, 'MessageFlow' => $messageFlow, 'MessageSamples' => \ShopMagicTwilioVendor\Twilio\Serialize::map($messageSamples, function ($e) {
            return $e;
        }), 'UsAppToPersonUsecase' => $usAppToPersonUsecase, 'HasEmbeddedLinks' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($hasEmbeddedLinks), 'HasEmbeddedPhone' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($hasEmbeddedPhone), 'OptInMessage' => $options['optInMessage'], 'OptOutMessage' => $options['optOutMessage'], 'HelpMessage' => $options['helpMessage'], 'OptInKeywords' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['optInKeywords'], function ($e) {
            return $e;
        }), 'OptOutKeywords' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['optOutKeywords'], function ($e) {
            return $e;
        }), 'HelpKeywords' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['helpKeywords'], function ($e) {
            return $e;
        })]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonInstance($this->version, $payload, $this->solution['messagingServiceSid']);
    }
    /**
     ...
     */
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, string $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonPage
    {
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return UsAppToPersonPage Page of UsAppToPersonInstance
     */
    public function getPage(string $targetUrl) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonPage
    {
     ...
     */
    public function getContext(string $sid) : \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonContext
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Service\UsAppToPersonContext($this->version, $this->solution['messagingServiceSid'], $sid);
    }
    /**
