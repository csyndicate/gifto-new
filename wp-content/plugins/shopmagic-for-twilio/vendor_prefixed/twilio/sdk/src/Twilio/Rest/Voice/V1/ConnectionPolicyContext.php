 ...
 */
class ConnectionPolicyContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    protected $_targets;
    /**
    ...
    public function fetch() : \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyInstance
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicyInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    {
        if (!$this->_targets) {
            $this->_targets = new \ShopMagicTwilioVendor\Twilio\Rest\Voice\V1\ConnectionPolicy\ConnectionPolicyTargetList($this->version, $this->solution['sid']);
        }
