...
<div class="options_group wt_sc_normal_coupon_giveaway_tab_content">
    <p class="form-field"><label><?php _e('Free Product', 'wt-smart-coupons-for-woocommerce' ); ?></label>
        ...
        <table style="background:#FFF4E8; width:calc(100% - 30px); margin: 70px 0px 0px 10px; padding:10px 15px; box-sizing:border-box; border-left:solid 3px #E97900; color:#575757; margin-bottom:20px; border-spacing:0px; border-collapse:collapse;">
            <tr>
