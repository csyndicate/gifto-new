<div class="wt_sc_single_coupon wt-single-coupon default_style [wt_sc_single_coupon_class]" data-id="[wt_sc_coupon_id]" title="[wt_sc_single_coupon_title]" style="background:[wt_sc_color_0]; color:[wt_sc_color_2]; border:2px dashed [wt_sc_color_1]; box-shadow:0 0 0 4px [wt_sc_color_0], 2px 1px 6px 4px rgba(10, 10, 0, 0);">
