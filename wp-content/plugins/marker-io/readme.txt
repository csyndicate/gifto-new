...
= 1.1.8 =
* Updating marketplace listing tags

= 1.1.7 =
* Security update

= 1.1.6 =
* Improved error handling when connecting projects
* Now show connected project's display name instead of integration name
