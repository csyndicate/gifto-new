jQuery(document).ready(function($) {
	...
	$( 'body' ).on( 'submit', '#epkb-ml-search-form', function( e ) {
		...
		$.ajax({
			...
			{
				//Loading Spinner
				$( '.epkbfa-ml-loading-icon').css( 'display','block');
				$( '.epkbfa-ml-search-icon').css( 'display','none');
				$( '.epkb-ml-search-box__text').css( 'display','none');
				$( '#epkb-ajax-in-progress' ).show();
			}
		...
		}).done(function (response)
		{
			...
			//Hide Spinner
			$( '.epkbfa-ml-loading-icon').css( 'display','none');
			$( '.epkbfa-ml-search-icon').css( 'display','block');
			$( '.epkb-ml-search-box__text').css( 'display','block');
	...
	$( document ).on( 'click', '#epkb-ml-classic-layout .epkb-ml-articles-show-more', function() {
		$( this ).parent().parent().find( '.epkb-category-section__body' ).slideDown();
		$( this ).parent().parent().find( '.epkb-category-section__footer' ).hide();
	} );

	// Show Level 2 Category Articles and Level 3 Categories
	$( document ).on( 'click', '#epkb-ml-classic-layout .epkb-ml-2-lvl-category-container', function() {
		$( this ).find( '.epkb-ml-2-lvl-article-list' ).slideDown();
		$( this ).find( '.epkb-ml-3-lvl-categories' ).slideDown();
		$( this ).find( '.epkb-ml-2-lvl-category__show-more' ).hide();
		$( this ).addClass( 'epkb-ml-2-lvl-category--active' );
	} );

	// Show Level 3 Category Articles and Level 4 Categories
	$( document ).on( 'click', '#epkb-ml-classic-layout .epkb-ml-3-lvl-category-container', function() {
		$( this ).find( '.epkb-ml-3-lvl-article-list' ).slideDown();
		$( this ).find( '.epkb-ml-4-lvl-categories' ).slideDown();
		$( this ).find( '.epkb-ml-3-lvl-category__show-more' ).hide();
		$( this ).addClass( 'epkb-ml-3-lvl-category--active' );
	} );

	// Show Level 4 Category Articles and Level 5 Categories
	$( document ).on( 'click', '#epkb-ml-classic-layout .epkb-ml-4-lvl-category-container', function() {
		$( this ).find( '.epkb-ml-4-lvl-article-list' ).slideDown();
		$( this ).find( '.epkb-ml-5-lvl-categories' ).slideDown();
		$( this ).find( '.epkb-ml-4-lvl-category__show-more' ).hide();
		$( this ).addClass( 'epkb-ml-4-lvl-category--active' );
	} );

	// Show Level 5 Category Articles
	$( document ).on( 'click', '#epkb-ml-classic-layout .epkb-ml-5-lvl-category-container', function() {
		$( this ).find( '.epkb-ml-5-lvl-article-list' ).slideDown();
		$( this ).find( '.epkb-ml-5-lvl-category__show-more' ).hide();
		$( this ).addClass( 'epkb-ml-5-lvl-category--active' );
	} );
	...
	const $level_1_CategoryButton 		= $( '.epkb-ml-1-lvl__cat-button' );
	const $level_2_CategoryButton 		= $( '.epkb-ml-2-lvl__cat-button' );
	...
	const $level_1_CategoryButtonActiveClass 	= 'epkb-ml-1-lvl__cat-button--active';
	const $level_2_CategoryButtonActiveClass 	= 'epkb-ml-2-lvl__cat-button--active';
	...
	// Level 1 Show more
	$( '#epkb-ml-product-layout .epkb-ml-1-lvl__cat-content .epkb-ml-articles-show-more' ).on( 'click',function( e ) {
	...
	$level_2_CategoryButton.on('click', function() {
		...
		if ($(this).hasClass('epkb-ml-2-lvl__cat-button--active')) {
	...
	// Level 2 Show more
	$( '#epkb-ml-product-layout .epkb-ml-2-lvl__cat-content .epkb-ml-articles-show-more' ).on( 'click',function( e ) {
