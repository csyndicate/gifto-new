...
class EPKB_KB_Config_Category {
	...
	public function display_category_fields( $category ) {
		...
		if ( $main_page_layout == EPKB_KB_Config_Specs::GRID_LAYOUT ) {
	...
	private function get_on_off_icons_link( $main_page_layout ) {  // TODO remove
		return admin_url( 'edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $this->kb_id ) . '&page=epkb-kb-configuration#settings__main-page__category_icon' );
	}
