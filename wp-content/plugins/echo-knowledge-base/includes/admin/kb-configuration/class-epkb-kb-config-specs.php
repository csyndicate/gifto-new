...
class EPKB_KB_Config_Specs {
	...
	public static function get_fields_specification( $kb_id ) {
		...
		$config_specification = array(
			...
			'kb_main_page_layout' => array(
				...
				'options'     => [
					...
					'Modular'                       => __( 'Modular', 'echo-knowledge-base' ),
			...
			'kb_article_page_layout' => array( // DEPRECATED
		...
		$config_specification = array_merge( $config_specification, EPKB_KB_Config_Layout_Modular::get_fields_specification() );
