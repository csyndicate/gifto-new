...
class EPKB_Need_Help_Features {
	...
	private static function get_feature_box( $feature ) {
		...
		<div class="epkb-kbnh__feature-container__col epkb-kbnh__feature__content-col">
			<h3 class="epkb-kbnh__feature-name<?php echo $feature['plugin'] != 'core' && $feature['plugin'] != 'crel' && $feature['plugin'] != 'ep'.'hd' ? ' epkb-kbnh__feature-name--pro' : ''; ?>"><?php echo esc_html( $feature['name'] ); ?> <?php
	...
	private static function get_features_config() {
		...
		return [
			...
			[
				...
				'category'  => 'design',
				'icon'      => '',
				'name'      => __( 'Layouts: Basic, Tabs, Categories and Modular', 'echo-knowledge-base' ),
				'desc'      => __( 'Basic layout shows categories and articles in groups. Tabs layout has top-level tabs. Categories layout shows main categories and count of articles it contains. Modular layout has greater flexibility.', 'echo-knowledge-base' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'various' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'toc' ),
			...
			[
				...
				'custom'    => '<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_settings_link( $kb_id, 'settings', 'sidebar', 'left_sidebar' ) ) . '" target="_blank"><span>' . esc_html__( 'Left Sidebar', 'echo-knowledge-base' ) . '</span></a>' .
				               '<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_settings_link( $kb_id, 'settings', 'sidebar', 'right_sidebar' ) ) . '" target="_blank"><span>' . esc_html__( 'Right Sidebar', 'echo-knowledge-base' ) . '</span></a>',
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'article-page', 'breadcrumb' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'sidebar' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'article-page', 'article_views_counter' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'article-page', 'prev_next_navigation' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'article-page', 'back_navigation' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'ratings' ),
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'search-box', 'advanced_search_mp' ),
				'docs'      => '',
				'video'     => '',
				'min_capability'   => EPKB_Admin_UI_Access::get_context_required_capability( 'admin_eckb_access_frontend_editor_write' ),
			],
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'search-box', 'advanced_search_ap' ),
				'docs'      => '',
				'video'     => '',
				'min_capability'   => EPKB_Admin_UI_Access::get_context_required_capability( 'admin_eckb_access_frontend_editor_write' ),
			],
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'search-box' ),
				'docs'      => '',
				'video'     => '',
				'min_capability'   => EPKB_Admin_UI_Access::get_context_required_capability( 'admin_eckb_access_frontend_editor_write' ),
			],
			...
			[
				...
				'config'    => self::get_settings_link( $kb_id, 'settings', 'search-box', 'advanced_search_results_page' ),
				'docs'      => '',
				'video'     => '',
				'min_capability'   => EPKB_Admin_UI_Access::get_context_required_capability( 'admin_eckb_access_frontend_editor_write' ),
			],
	...
	private static function get_settings_link( $kb_id, $config_page='', $config_tab='', $config_box='' ) {
        $url = '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#' . $config_page;
		$url .= empty( $config_tab ) ? '' : '__' .$config_tab;
