					...
					<div class="epkb-wizard-header">
						<div class="epkb-wizard-header__info">
							<h1 class="epkb-wizard-header__info__title">
								<?php esc_html_e( 'Setup Your Knowledge Base', 'echo-knowledge-base' ); ?>
							</h1>
						</div>
						<div class="epkb-setup-wizard-theme-header">
							<h2 class="epkb-setup-wizard-theme-header__info__title" data-title-id="1">
								<?php esc_html_e( 'Set your Knowledge Base nickname, slug and add it to menu.', 'echo-knowledge-base' ); ?>
							</h2>
							<h2 class="epkb-setup-wizard-theme-header__info__title hidden" data-title-id="2">
								<?php esc_html_e( 'Choose an initial Knowledge Base design. You can easily adjust colors and other elements later.', 'echo-knowledge-base' ); ?>
							</h2>
							<h2 class="epkb-setup-wizard-theme-header__info__title hidden" data-title-id="3">
								<?php esc_html_e( 'Article pages can have navigation links in the left sidebar or in the right sidebar.', 'echo-knowledge-base' ); ?>
							</h2>
						</div>
					</div>
				...
				<div class="epkb-wizard-row-form-input">
					<div class="epkb-wizard-col2">
						...
						if ( current_user_can( EPKB_Admin_UI_Access::get_admin_capability() ) ) {   ?>
							<p class="epkb-wizard-input-desc"><a href="https://www.echoknowledgebase.com/documentation/changing-permalinks-urls-and-slugs/' ); ?>" target="_blank"><?php esc_html_e( 'Need to change KB URL?', 'echo-knowledge-base' ); ?></a></p>    <?php
						}   ?>
					</div>
				</div>				<?php
			}
					...
					foreach ( $preset_options as $title => $group ) {
						...
						switch ( $title ) {
							...
							case 'Categories':
								...
								break;
							case 'Modular':
								$theme_title = __( 'Modular Layout', 'echo-knowledge-base' );
								break;
							case 'Grid':
