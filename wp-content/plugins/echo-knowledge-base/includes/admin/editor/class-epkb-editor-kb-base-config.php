...
class EPKB_Editor_KB_Base_Config extends EPKB_Editor_Config_Base {
	...
	protected $is_modular_main_page = false;
	...
	function load_config() {
		...
		$this->config = epkb_get_instance()->kb_config_obj->get_kb_config_or_default( $eckb_kb_id );
		...
		$this->is_modular_main_page = $this->config['kb_main_page_layout'] == 'Modular';
