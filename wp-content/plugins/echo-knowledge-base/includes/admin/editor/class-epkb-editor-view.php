...
class EPKB_Editor_View {
	...
	public function __construct() {
		...
		if ( EPKB_Utilities::get( 'enable_editor_frontend_mode' ) ) {
			...
			$editor_backend_mode = EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' );
		}
	...
	public static function get_error_form_html() {
		...
		<div class="epkb-editor-error--form-wrap">
			...
			<form id="epkb-editor-error--form" method="post">				<?php
				...
				<input type="hidden" name="editor_type" value="<?php echo EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' ) ? 'backend' : 'frontend'; ?>">
				<div id="epkb-editor-error--form-body">
					...
					<div class="epkb-editor-error--form-btn-wrap">
						...
						if ( EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' ) ) {       ?>
	...
	public static function get_editor_settings_html( $kb_config ) {
		...
		<div class="epkb-editor-settings-panel-container"  id="epkb-editor-settings-layouts">
			...
			<div class="epkb-editor-settings-control-container epkb-editor-settings-control-type-image-select">
				...
				<label class="epkb-editor-settings-control-image-select" data-name="kb_main_page_layout">
					<input type="radio" name="kb_main_page_layout" value="Modular">

					<div class="epkb-editor-settings-control-image-select--label">
						<img src="<?php echo Echo_Knowledge_Base::$plugin_url . 'img/editor/modular-layout.jpg'; ?>">
						<span><?php esc_html_e( 'Modular', 'echo-knowledge-base' ); ?></span>
					</div>
				</label>    <?php
				...
				<div class="epkb-editor-settings-menu__group-container">
					...
					<div class="epkb-editor-settings-menu__group-items-container"><?php
						foreach ( $pages_data as $page ) { ?>
							<a href="<?php echo $page['url']; ?>" class="epkb-editor-settings-menu__group-item-container" target="<?php echo EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' ) ? '_self' : '_blank'; ?>">
	...
	private static function frontend_editor_page( ) {
		...
		$body_class = EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' ) ? 'epkb-editor-backend-mode' : '';  ?>
	...
	private function backend_main_page_content() {
		...
		echo do_shortcode( '[' . EPKB_KB_Handler::KB_MAIN_PAGE_SHORTCODE_NAME . ' id=' . $eckb_kb_id . ']');
	}
