...
class EPKB_Icons {
	...
	public static function is_theme_with_image_icons( $kb_config ) {
		return ! empty($kb_config['theme_name']) && in_array($kb_config['theme_name'], array(
				...
				'ml_articles_list_product_layout_faqs',
			));
	}
	...
	/**
	 * Return set of image URLs by theme name
	 *
	 * @param $theme_name
	 * @return string[]
	 */
	public static function get_theme_icons( $theme_name ) {
		...
		$theme_icons = array(
			...
			'ml_articles_list_product_layout_faqs' => array(
				'image_1'                               => 'img/demo-icons/icons/FAQs2.png',
				'image_2'                               => 'img/demo-icons/icons/tool-icons.png',
				'image_3'                               => 'img/demo-icons/icons/reports-and-analytics.png',
			),
	...
	public static function get_demo_category_icons( $kb_config, $theme_name ) {
		...
		$ix = 0;
		$categories_data = EPKB_KB_Config_Category::get_category_data_option( $kb_config['id'] );
		...
		foreach( $all_kb_terms as $term ) {
			...
			if ( get_term_meta( $term->term_id, EPKB_Icons::CATEGORY_ICON_USER_CHANGED_FLAG, true ) == '1' ) {
				continue;
			}
			...
			if ( $use_default ) {
				...
				$categories_data[$term->term_id] = $image_icon;
				continue;
			}
