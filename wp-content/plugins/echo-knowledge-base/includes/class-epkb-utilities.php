	...
	public static function get_single_article_link( $kb_config, $title, $article_id, $type, $seq_no='' ) {
		...
		switch( $type ) {
			...
			case 'Article_Sidebar':
				...
				$outer_span = self::get_css_class( 'eckb-article-title', $kb_config );
		...
		<a href="<?php echo esc_url( $link ); ?>" class="<?php echo $a_tag_class; ?>" data-kb-article-id="<?php echo esc_attr( $article_id ); ?>">
