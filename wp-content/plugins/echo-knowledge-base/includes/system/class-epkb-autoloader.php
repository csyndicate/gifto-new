	...
	public static function autoload( $class ) {
		...
		if ( $classes === null ) {
			$classes = array(
				...
				'epkb_layout_modular'               =>  'includes/features/layouts/class-epkb-layout-modular.php',
				...
				// MODULAR MAIN PAGE
				'epkb_ml_categories_articles'       =>  'includes/features/layouts/modular-layout/class-epkb-ml-categories-articles.php',
				'epkb_ml_search'                    =>  'includes/features/layouts/modular-layout/class-epkb-ml-search.php',
				'epkb_ml_new_recent_articles_list'  =>  'includes/features/layouts/modular-layout/class-epkb-ml-new-recent-articles-list.php',
				'epkb_ml_faqs'                      =>  'includes/features/layouts/modular-layout/class-epkb-ml-faqs.php',
