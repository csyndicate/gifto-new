 ...
 */
class aiowps_cb_Gallery_List_Table 
{
	/**
	...
	public function ajax_user_can() {
		die( 'function aiowps_cb_Seller_List_Table::ajax_user_can() must be over-ridden in a sub-class.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 * @uses aiowps_cb_Seller_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
	...
	public function prepare_items() {
		die( 'function aiowps_cb_Seller_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	protected function get_columns() {
		die( 'function aiowps_cb_Seller_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
