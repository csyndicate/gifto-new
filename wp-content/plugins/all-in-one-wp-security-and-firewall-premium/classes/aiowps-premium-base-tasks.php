...
class AIOWPS_Premium_Base_Tasks {
	 ...
	 *
	 * @param $user_ip string user IP address.
	...
	protected function get_country_code_from_ip($user_ip) {
		...
		if (class_exists('WC_Geolocation')) {
			$country_code = $this->get_woocommerce_geolocate_country_code();
	 ...
	 */
	private function get_woocommerce_geolocate_country_code() {
		$gelocation = new WC_Geolocation(); // Get WC_Geolocation instance object
		$user_geo = $gelocation->geolocate_ip('', true, true); // Get geolocated user data.
