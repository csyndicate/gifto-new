...
class AIOWPS_CB_General_Init_Tasks {
	...
	public function do_head_tasks() {
		...
		if ('1' == $aio_wp_security_premium->configs->get_value('aiowps_cb_ajax_enabled') 
			&& ('1' == $aio_wp_security_premium->configs->get_value('aiowps_cb_enable_country_blocking') || '1' == $aio_wp_security_premium->configs->get_value('aiowps_cb_enable_secondary_country_blocking'))) {
