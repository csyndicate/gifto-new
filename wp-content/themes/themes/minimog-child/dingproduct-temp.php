		...
		if ($err) {
		  echo "cURL Error #:" . $err;
			...
			foreach ($products_IDs as $id_prd) {
			 ...
			 echo "</pre>"; */
			$root_path = ABSPATH;
			$inserted_rwd_products_logs = fopen($root_path."add_ding_products.txt", "a+");
			...
			echo "Product Insertion log is added to a file in root with name 'add_ding_products.txt'";
