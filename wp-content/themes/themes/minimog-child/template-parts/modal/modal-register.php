					...
					<form id="minimog-register-form" class="minimog-register-form" method="post">
						...
						<div class="form-group">
							...
							<input type="text" id="ip_reg_fullname" class="form-control form-input"
							       name="fname" placeholder="<?php esc_attr_e( 'Your Name', 'minimog' ); ?>"
							       required>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input-group form-input-password">
								<input type="password" id="ip_reg_password" class="form-control form-input"  
								       name="password" placeholder="<?php esc_attr_e( 'Password', 'minimog' ); ?>" required/>
									 <!-- <input type="password" id="ip_reg_password" class="form-control form-input"  
								       name="password" placeholder="<?php //esc_attr_e( 'Password', 'minimog' ); ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required autocomplete="off">-->
