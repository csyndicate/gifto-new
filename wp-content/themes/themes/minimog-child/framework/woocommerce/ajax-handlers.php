...
class Ajax_Handlers {
	...
	public function initialize() {
		/**
		 * Used wc_ajax instead of minimog_ajax to compatible with 3rd plugins.
		 */
		add_action( 'wc_ajax_minimog_add_to_cart', [ $this, 'add_to_cart_variable' ] );

		add_action( 'woocommerce_ajax_added_to_cart', [ $this, 'add_to_cart_message' ], 10, 1 );

		add_action( 'minimog_ajax_minimog_search_products', [ $this, 'search_products' ] );
