	...
	public static function get_attachment_by_id( $args = array() ) {
		...
		if ( empty( $attachment_cropped_info['file'] ) ) {
			...
			if ( 'attachment' === $attachment->post_type ) {
				 ...
				 */
				if (
					( function_exists( 'leopard_offload_media_is_attachment_served_by_provider' ) && leopard_offload_media_is_attachment_served_by_provider( $attachment_id ) )
					|| defined( 'MEDIA_CLOUD_VERSION' )
