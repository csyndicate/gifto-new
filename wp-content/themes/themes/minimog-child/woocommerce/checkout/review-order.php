...
?>
<table id="woocommerce-checkout-review-order-table" class="woocommerce-checkout-review-order-table">

	<?php wc_get_template( 'checkout/review-order-content.php' ); ?>
	...
	<tr>
		<td colspan="2">
			<!--<div class="cart-footer-actions">-->
				<?php if ( apply_filters( 'woocommerce_enable_order_notes_field', 'yes' === get_option( 'woocommerce_enable_order_comments', 'yes' ) ) ) : ?>
					...
					>
						...
						<span><?php //esc_html_e( 'Note (optional)', 'minimog' ); ?></span>
					</a>
				<?php endif; ?>
			...
			<?php wc_get_template( 'checkout/review-order-totals-table.php' ); ?>
		</td>
	</tr>
	</tfoot>
</table>
