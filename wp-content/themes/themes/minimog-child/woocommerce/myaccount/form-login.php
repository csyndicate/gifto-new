...
<div class="row" id="customer_login">
	...
	<div class="col-lg-5 col-md-6">
		...
		<div class="woocommerce-form-wrap woocommerce-form-has-background woocommerce-form-login-wrap">
			...
			<h2><?php esc_html_e( 'Sign In', 'minimog' ); ?></h2>
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide woocommerce-form-password">
					<label for="password"><?php esc_html_e( 'Password', 'minimog' ); ?>&nbsp;<span
							class="required">*</span></label>
				...
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login"
				        value="<?php esc_attr_e( 'Log in', 'minimog' ); ?>"><?php esc_html_e( 'Log in', 'minimog' ); ?></button>
	...
	<div class="col-lg-6 col-md-6 col-lg-push-1">
		...
		<div class="woocommerce-form-wrap woocommerce-form-register-wrap">
			...
			<h2><?php esc_html_e( 'Sign Up', 'minimog' ); ?></h2>
			...
			<form method="post"
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="reg_username"><?php esc_html_e( 'Username', 'minimog' ); ?>&nbsp;<span
								class="required">*</span></label>
						<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username"
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="reg_email"><?php esc_html_e( 'Email address', 'minimog' ); ?>&nbsp;<span
							class="required">*</span></label>
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="reg_password"><?php esc_html_e( 'Password', 'minimog' ); ?>&nbsp;<span
								class="required">*</span></label>
				...
				<?php else : ?>
					...
					<p><?php esc_html_e( 'A password will be sent to your email address.', 'minimog' ); ?></p>
				...
				<p class="woocommerce-form-row form-row">
					...
					<button type="submit"
					        ...
					        name="register"
					        value="<?php esc_attr_e( 'Register', 'minimog' ); ?>"><?php esc_html_e( 'Register', 'minimog' ); ?></button>
				</p>
