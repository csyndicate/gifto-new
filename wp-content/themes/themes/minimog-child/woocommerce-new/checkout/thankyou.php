		...
		<div class="row">
			<div class="col-lg-7 left-box">
				...
				<?php else : ?>
					...
					<p>Please check your  recipient's inbox and mobile number for updates and gift voucher redemption code<br>
		Just in case check spam/bulk mail folder.Else please contact us </p>
