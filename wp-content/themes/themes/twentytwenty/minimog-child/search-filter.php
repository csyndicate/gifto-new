...
<div class="country-no-details">
	<p>Top-up over 6 billion mobile numbers, in 150 countries & 600+ mobile networks now, in seconds!</p>
	<label>Please enter your or the recipient's mobile number</label>
	<p>(Prepaid numbers only)</p>
...
<div id="payment_breakup_bx">
    ...
    <div class="form-row">
		...
		<label for="email">Email <span>(To get your receipt/any, cashback, for customer support & special offers)</span></label>
		<input type="email" name="user_email"  required>
		<label for="email">Friend's Email <span>(To get your receipt/any, cashback, for customer support & special offers)</span></label>
...
/* $('body').on('click','.mobile_operator',function(event){
...
// Create a Stripe client.
    var stripe = Stripe('pk_live_51LD3yKEVe25IQ0qQkWqKldZDADcu7Zj7xjhGcSWA9X5PtbHAvGEUBesMgIHbDwDj4v3ArjvpgCzU9QcNRTfJEgNC00xRpQDU7o');       
   /*   var stripe = Stripe('pk_test_KpSfeunszRWLzFzqXPHtc627');     */
...
var submit_payment_bt = document.getElementById('submit_payment');
...
/* 	submit_payment_bt.addEventListener('click', function(event) {  */
		   ...
		   var json = $.parseJSON(resp);
			 if(json.success == 200){
				  hide_preloader();
					...
					card.clear();	
					window.location.href = "<?php echo site_url() . '/thank-you-for-recharge/'; ?>";
					/* 
					swal({title: "Good job", text: json.message, type: 
