...
/* if (!(jQuery('.woocommerce-shop .header-left #page-navigation nav#menu ul#menu-primary').hasClass('menu__container'))){
	jQuery(function() {
            jQuery.ajax({
                type:"GET",
				url:"https://43523f7b3b.nxcli.net/",
                dataType:"html",
                success:function(data) {
					
						var data_nav = jQuery(data).find(".header-center #page-navigation nav#menu ");	
						var data_nav_mob = jQuery(data).find("ul#mobile-menu-primary");
						
						console.log(data_nav_mob);
						jQuery(".woocommerce-shop .header-left #page-navigation nav#menu").html(data_nav);
						jQuery(".woocommerce-shop .page-mobile-menu-content").html(data_nav_mob);
