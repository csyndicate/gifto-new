...
if ( have_posts() ) : ?>
	...
	<div class="minimog-grid-pagination">
		...
		<?php
		echo do_shortcode('[ajax_load_more post_type="product"  posts_per_page="12" search="'. $_GET['s'] .'" orderby="relevance" scroll="true" offset="0" no_results_text="<div class="no-results">Sorry, nothing found in this query</div>" css_classes="plain-text" button_label="Load More"]');  ?>
	</div>
