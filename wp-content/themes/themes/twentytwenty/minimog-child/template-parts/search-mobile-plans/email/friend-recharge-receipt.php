...
<body style="margin:0;background-color: #ffffff;box-sizing: border-box;padding:0;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin:0px auto;width:600px;max-width: 100%;font-family: 'Montserrat', sans-serif; background-color:#fff;background-image: url(https://43523f7b3b.nxcli.net/wp-content/uploads/2022/10/newdesign.png);background-size: 35%;background-position: top right;background-repeat: no-repeat;" >
        <tr>
            <td>
                ...
                <table id="Recharge_for" style="text-align:center;width: 100%;margin-top: 30px;background-color: #8080803d;padding: 15px 0px;">
                    <tr>
                        <td style="width:80%;">
							...
							<a id="Click_here" href="https://43523f7b3b.nxcli.net/search-filter/" style="background: #ff2e3d;border: transparent;color: #fff;padding: 6px 30px;border-radius: 7px;font-weight: 500;font-size: 18px;text-decoration: none;">Click here!</a></td>
                        <td style="width:20%;"><img style="width: 73%;margin-left: 0;margin-top: 2px;margin-bottom: -3px;" src="https://43523f7b3b.nxcli.net/wp-content/uploads/2022/10/gift.png" alt="gift"></td>
                    </tr>
