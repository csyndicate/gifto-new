...
Minimog – The High Converting eCommerce WordPress Theme
...
Improvement Arabic language translation. Big thank to abdullahsaadeddin.
Add support Social Login for Resister Form Popup
WPC Smart Wishlist for WooCommerce v.4.7.9
WPC Smart Compare for WooCommerce v.6.1.6
- Fixed:
Tab title image style
Tested up with Elementor 3.18.0

= 2.9.8 - November 30, 2023 =
- Updated:
Twitter X icon
Sales Countdown Timer plugin 1.1.2.1
Multi Currency for WooCommerce plugin 2.3.1.1
...
= 2.9.7 - November 15, 2023 =
- Updated:
Optimized code.
Compatible with Fish and Ships Pro plugin

= 2.9.6 - November 09, 2023 =
- Updated:
Thememove Addons For Elementor plugin v.1.3.1
Revolution Slider plugin v.6.6.18
- Fixed:
Fixed search ajax not running.
Compatible with WP Offload Media Lite plugin

= 2.9.5 - October 05, 2023 =
- Added:
new demo Dexons.
new demo Babymart.
- Updated:
Insight Swatches: HPOS compatibility.
Product brand can custom ordering now.
Optimized HTML DOM used in Icon List widget.
Optimized HTML DOM used in Marque List widget.
- Fixed:
Fix Elementor column collapsible broken when Elementor dom optimization feature on.
Separate line not showing in Marque List widget.
Compatible with Woocommerce Payments plugin ver 6.5.1.
Page transition feature in Elementor Pro make header link reload page.

= 2.9.4 - September 30, 2023 =
- Fixed:
Fix deprecated Elementor code.
Fix Dokan vendor role in register popup login.
Fix missing font weight options for custom fonts in Theme options.

= 2.9.3 - September 25, 2023 =
- Updated:
Insight Core plugin v.2.6.5
Sales Countdown Timer plugin 1.1.1.1
Make theme options text can be translatable by Polylang
- Fixed:
Out-date WooCommerce v.8.1.0 templates

= 2.9.2 - August 15, 2023 =
- Updated:
Add new theme setting that allow show light gallery popup on Quick View modal.
- Fixed:
Fix price filter not compatible with Multi Currency
Fix styling of Google Pay button in single product.

= 2.9.1 - August 07, 2023 =
- Updated:
Add new theme setting that control breadcrumb visibility.
- Fixed:
Blog loop ajax pagination SEO issue.
Shop loop ajax pagination SEO issue.

= 2.9.0 - July 25, 2023 =
- Fixed:
Cart shipping info not showing after invalid coupon input.

= 2.8.8 - July 20, 2023 =
- Updated:
Out-date WC templates
- Fixed:
Avatar upload button not showing with role "customer" in My account page.

= 2.8.7 - July 13, 2023 =
- Updated:
Multi Currency for WooCommerce plugin 2.2.5.1
Sales Countdown Timer plugin 1.0.9.1
WPC Smart Wishlist for WooCommerce v.4.7.1
WPC Smart Compare for WooCommerce v.6.0.1
WPC Product Bundles for WooCommerce v.7.2.4
WPC Frequently Bought Together for WooCommerce v.6.1.3
WPC Product Tabs for WooCommerce v.3.0.2
WPC Smart Notification for WooCommerce v.2.3.2
Improvement Price range filter widget. Show filtered price range with current query.

= 2.8.6 - July 05, 2023 =
- Fixed:
Some issues related to Product bought together plugin.
Register popup nonce verification & first name verification failed with Dokan.

= 2.8.5 - June 15, 2023 =
- Fixed:
Some issues related to Woocommerce Payments plugin.

= 2.8.4 - June 14, 2023 =
- Fixed:
Cart fragments issue with WC 7.8.0

= 2.8.3 - June 14, 2023 =
- Updated:
support display currency switcher on header + topbar by Woocommerce Payments plugin.
improvement store notice style.
- Fixed:
Prevent currency switcher by Curcy plugin showing when it's not enabled.
out-date templates WC 7.8.0

= 2.8.2 - June 08, 2023 =
- Updated:
Add my account icons for points and rewards link
Tested up version 5.4.6 of Compare plugin.
- Fixed:
Product variation swatches out of stock not show in quick view.
Size chart button text
Polylang language switcher refresh page on click on mobile devices.

= 2.8.1 - June 07, 2023 =
- Updated:
Allowed using CURCY currency together with WCML plugin
- Fixed:
minor style of currency switcher by WCML
minor style of Header 07

= 2.8.0 - May 29, 2023 =
- Added:
new filter 'minimog/quantity_discount/info_html' allow change HTML output of quantity discount
- Updated:
Refactor user register system, respect account settings by Woocommerce.
Split Full Name field to First Name field and Last Name field in registration form.
Add setting allows input First name field and Last name field in Woocommerce register form.
- Fixed:
Tested up with hCaptcha ver 2.8.0

= 2.7.5 - May 16, 2023 =
- Updated:
Update icons for payment methods link, PayPal link, gift card link in my account navigation.
- Fixed:
Prevent cart update if quantity input enter valid value.

= 2.7.4 - May 16, 2023 =
- Added:
new theme setting allows disabled ajax search feature.
- Fixed:
Dropdown menu not working after ver 2.7.3

= 2.7.3 - May 16, 2023 =
- Fixed:
Product bundle widget not working properly.
Product images changes when bundle item variation changed.
Improvement my account UI.

= 2.7.2 - May 11, 2023 =
- Fixed:
Remove duplicate h1 tag on single blog.
Reduce DOM used.
Out-date WC templates.
Bought together product add to cart issue.

= 2.7.1 - May 09, 2023 =
- Fixed:
variation images not changed after ver 2.7.0

= 2.7.0 - May 08, 2023 =
- Updated:
WPC Smart Wishlist for WooCommerce v.4.6.6
WPC Smart Compare for WooCommerce v.5.4.4
WPC Product Bundles for WooCommerce v.7.1.3
WPC Frequently Bought Together for WooCommerce v4.3.6
WPC Product Tabs for WooCommerce v.2.0.8
WPC Smart Notification for WooCommerce v.2.2.4
Sales Countdown Timer v.1.0.8.1
- Fixed:
Compatible with FunnelKit Checkout plugin.
Remove unnecessary placeholder text of checkout input fields.
Free shipping goal bar not showing after recent update.
Minor css style issue of bundle product price on catalog page.

= 2.6.1 - April 28, 2023 =
- Fixed:
coupon modal on checkout page not open because conflict with Klarna checkout.

= 2.6.0 - April 25, 2023 =
- Updated:
improvement UI/UX for my account page.
improvement invalid messages for email field and phone number field on checkout page.
- Fixed:
issue with ajax add to cart conflict Snap pixel for Woocommerce plugin.
Cart subtotal value not properly with Woocommerce Subscription plugin.
...
Insight Swatches term link can't be selected with non-english case.
