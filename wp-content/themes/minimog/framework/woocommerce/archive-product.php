...
class Archive_Product {
	...
	public function sidebar1_off_canvas_text( $text ) {
		if ( \Minimog_Woo::instance()->is_product_archive() ) {
			$new_text = pll__( \Minimog::setting( 'product_archive_page_sidebar_1_off_canvas_toggle_text' ) );
	...
	function shop_toolbars() {
		...
		if ( 'toolbar_right' === \Minimog::setting( 'shop_archive_filtering' ) && '1' === \Minimog::setting( 'product_archive_off_sidebar' ) && is_active_sidebar( self::SIDEBAR_FILTERS ) ) {
	...
	public function output_open_off_sidebar() {
		if ( 'toolbar_left' === \Minimog::setting( 'shop_archive_filtering' ) && '1' === \Minimog::setting( 'product_archive_off_sidebar' ) && is_active_sidebar( self::SIDEBAR_FILTERS ) ) {
