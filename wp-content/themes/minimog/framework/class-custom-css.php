...
if ( ! class_exists( 'Minimog_Custom_Css' ) ) {
	class Minimog_Custom_Css {
		...
		public function get_root_css() {
			...
			$box_white_border_02    = '#e9e9e9';
			$box_white_border_03    = '#e6e6e6';
			$box_white_bg           = '#fff';
			$box_grey_bg            = '#f8f8f8';
			...
			$header_typography = Minimog::setting( 'header_style_navigation_typography' );
			$header_nav_font   = '';
			if ( ! empty( $header_typography['font-size'] ) && $header_typography['font-family'] ) {
				$header_nav_font .= $header_typography['font-weight'] ?? '';
				$header_nav_font .= " {$header_typography['font-size']}/{$header_typography['line-height']} ";
				$header_nav_font .= " {$header_typography['font-family']}";
			}
			...
			$css = ":root {
				...
				--minimog-color-box-white-border-02: {$box_white_border_02};
				--minimog-color-box-white-border-03: {$box_white_border_03};
				...
				--minimog-header-nav-font: {$header_nav_font};
			}";
