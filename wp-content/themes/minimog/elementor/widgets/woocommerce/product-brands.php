...
class Widget_Product_Brands extends Grid_Base {
	...
	private function add_query_section() {
		...
		$this->add_control( 'show_name', [
			'label'        => esc_html__( 'Show Name', 'minimog' ),
	...
	private function update_controls() {
		...
		$this->update_responsive_control( 'grid_content_position', [
			'default'   => 'middle',
			'selectors' => [
				'{{WRAPPER}} .item' => 'align-items: {{VALUE}}',
			],
		] );
		...
		$this->update_responsive_control( 'grid_content_alignment', [
			'default'   => 'center',
			'selectors' => [
				'{{WRAPPER}} .item' => 'justify-content: {{VALUE}}',
			],
		] );

		$this->update_responsive_control( 'grid_content_padding', [
			'selectors' => [
				'body:not(.rtl) {{WRAPPER}} .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				'body.rtl {{WRAPPER}} .item'       => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
			],
		] );
	}
