...
<table class="cart-totals-table">
	...
	if ( ! empty( $html_string ) ) {
		/**
		 * 3rd plugins hooked and render wrong table row format that break layout.
		 *
		 * @package Fish and Ships Pro
		 * @author  wpcentrics
		 * @author_uri https://www.wp-centrics.com/
		 */
		if ( ! Minimog_Helper::has_html_tag( $html_string, 'tr' ) ) {
			$html_string = '<tr class="cart-totals-row__no-style"><td colspan="2">' . $html_string . '</td></tr>';
		}
		echo $html_string;
	}
	?>
