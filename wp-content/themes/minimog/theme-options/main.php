	...
	class Minimog_Redux {
		...
		public function register_sections() {
			...
			Redux::set_section( Minimog_Redux::OPTION_NAME, [
				'title'            => __( 'Theme Styling', 'minimog' ),
				'id'               => 'theme_styling',
			...
			minimog_require_file_once( MINIMOG_REDUX_SECTION_DIR . '/header/section-style-11.php' );
			minimog_require_file_once( MINIMOG_REDUX_SECTION_DIR . '/header/section-style-12.php' );

			Redux::set_section( Minimog_Redux::OPTION_NAME, [
				'title'            => __( 'Navigation', 'minimog' ),
				'id'               => 'navigation',
				'customizer_width' => '400px',
				'icon'             => 'eicon-menu-bar',
			] );
			...
			Redux::set_section( Minimog_Redux::OPTION_NAME, [
				'title'            => __( 'Title Bar & Breadcrumb', 'minimog' ),
		...
		public function get_registered_widgets_options( $default_option = false, $empty_option = true ) {
			...
			if ( $empty_option === true ) {
				$extra_options['none'] = __( 'No Sidebar', 'minimog' );
			}
			if ( $default_option === true ) {
				$extra_options['default'] = __( 'Default', 'minimog' );
			}
		...
		public function get_presets() {
			$presets = [
				...
				'site_settings_preset' => [
					...
					'dexons'    => Minimog_Redux_Presets::get_settings( 'dexons' ),
					'babymart'  => Minimog_Redux_Presets::get_settings( 'babymart' ),
		...
		public function set_default_settings() {
			$default_settings = [
				 ...
				 * Title Bar
				 */
				'breadcrumb_visibility'                            => '1',
				'title_bar_layout'                                 => Minimog_Title_Bar::DEFAULT_TYPE,
				'title_bar_search_title'                           => __( 'Search results for: ', 'minimog' ),
				'title_bar_home_title'                             => __( 'Blog', 'minimog' ),
				'title_bar_archive_category_title'                 => __( 'Category: ', 'minimog' ),
				'title_bar_archive_tag_title'                      => __( 'Tag: ', 'minimog' ),
				'title_bar_archive_author_title'                   => __( 'Author: ', 'minimog' ),
				'title_bar_archive_year_title'                     => __( 'Year: ', 'minimog' ),
				'title_bar_archive_month_title'                    => __( 'Month: ', 'minimog' ),
				'title_bar_archive_day_title'                      => __( 'Day: ', 'minimog' ),
				'title_bar_single_blog_title'                      => __( 'Blog', 'minimog' ),
				 ...
				 * Footer
				 */
				'footer_copyright_text'                            => __( 'Copyright &copy; 2022. All rights reserved.', 'minimog' ),
				...
				'shop_badge_new'                                   => '1',
				'shop_badge_hot'                                   => '0',
				'shop_badge_best_selling'                          => '0',
				'shop_badge_new_range'                             => '7',
				 ...
				 * Shop Archive.
				 */
				'product_archive_title_bar_title'                  => __( 'Shop', 'minimog' ),
				...
				'error404_page_title'                                   => __( 'Oops!', 'minimog' ),
				'error404_page_sub_title'                               => __( 'Page not found!', 'minimog' ),
		...
		public static function get_all_font_variants() {
			return [
				'100'       => 'Thin 100',
				'200'       => 'Extra Light 200',
				'300'       => 'Light 300',
