...
class VI_SCT_SALES_COUNTDOWN_TIMER_Frontend_Shortcode {
	...
	public function register_shortcode( $atts ) {
		...
		switch ( $type ) {
			...
			case 'product':
				...
				if ( $sale_from > $now ) {
					...
					$text               = $message ?: $this->settings->get_current_countdown_language( 'sale_countdown_message', '_' . $language, $index );
				}
				...
				if ( $product = wc_get_product( $product_id ) ) {
					...
					$countdown_data_change = array(
						...
						'message'            => $message ?: $this->settings->get_current_countdown_language( 'sale_countdown_message', '_' . $language, $index ),
		...
		$datetime_format_custom_date   = $datetime_format_custom_date ?: $this->settings->get_current_countdown_language( 'sale_countdown_datetime_format_custom_date', '_' . $language, $index );
		$datetime_format_custom_hour   = $datetime_format_custom_hour ?: $this->settings->get_current_countdown_language( 'sale_countdown_datetime_format_custom_hour', '_' . $language, $index );
		$datetime_format_custom_minute = $datetime_format_custom_minute ?: $this->settings->get_current_countdown_language( 'sale_countdown_datetime_format_custom_minute', '_' . $language, $index );
		$datetime_format_custom_second = $datetime_format_custom_second ?: $this->settings->get_current_countdown_language( 'sale_countdown_datetime_format_custom_second', '_' . $language, $index );
