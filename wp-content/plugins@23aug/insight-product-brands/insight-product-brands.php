...
define( 'INSIGHT_PRODUCT_BRANDS_VERSION', '1.0.0' );
...
class Insight_Product_Brands {
	...
	public function register_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'Brands', 'taxonomy general name', 'insight-product-brands' ),
			'singular_name'              => _x( 'Brand', 'taxonomy singular name', 'insight-product-brands' ),
			'search_items'               => esc_html__( 'Search Brand', 'insight-product-brands' ),
			'popular_items'              => esc_html__( 'Popular Brands', 'insight-product-brands' ),
			'all_items'                  => esc_html__( 'All Brands', 'insight-product-brands' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => esc_html__( 'Edit Brand', 'insight-product-brands' ),
			'update_item'                => esc_html__( 'Update Brand', 'insight-product-brands' ),
			'add_new_item'               => esc_html__( 'Add New Brand', 'insight-product-brands' ),
			'new_item_name'              => esc_html__( 'New Brand Name', 'insight-product-brands' ),
			'separate_items_with_commas' => esc_html__( 'Separate brands with commas', 'insight-product-brands' ),
			'add_or_remove_items'        => esc_html__( 'Add or remove brands', 'insight-product-brands' ),
			'choose_from_most_used'      => esc_html__( 'Choose from the most used brands', 'insight-product-brands' ),
			'not_found'                  => esc_html__( 'No brands found.', 'insight-product-brands' ),
			'menu_name'                  => esc_html__( 'Product brands', 'insight-product-brands' ),
			'back_to_items'              => esc_html__( 'Back to brands', 'insight-product-brands' ),
		);
	...
	public function add_brand_fields() {
		...
		<div class="form-field term-url-wrap">
			<label><?php esc_html_e( 'Url', 'insight-product-brands' ); ?></label>
			<input type="text" name="product_brand_url"/>
	...
	public function edit_brand_fields( $term ) {
		...
		if ( $thumbnail_id ) {
			...
			$thumbnail = insight_product_brand_placeholder_img_src();
		}
