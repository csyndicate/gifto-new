...
class CredentialList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $accountSid, $credentialListSid)
    {
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Username' => $username, 'Password' => $password));
