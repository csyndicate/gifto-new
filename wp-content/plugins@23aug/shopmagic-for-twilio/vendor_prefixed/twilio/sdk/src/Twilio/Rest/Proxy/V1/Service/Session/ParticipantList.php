...
class ParticipantList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $serviceSid, $sessionSid)
    {
    ...
    public function create($identifier, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Identifier' => $identifier, 'FriendlyName' => $options['friendlyName'], 'ProxyIdentifier' => $options['proxyIdentifier'], 'ProxyIdentifierSid' => $options['proxyIdentifierSid']));
