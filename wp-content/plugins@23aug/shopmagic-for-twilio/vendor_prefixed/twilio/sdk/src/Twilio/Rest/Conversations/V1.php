...
use ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\WebhookList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    {
        if (!$this->_webhooks) {
            $this->_webhooks = new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\WebhookList($this);
        }
