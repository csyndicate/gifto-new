...
class EndUserList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($friendlyName, $type, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('FriendlyName' => $friendlyName, 'Type' => $type, 'Attributes' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($options['attributes'])));
