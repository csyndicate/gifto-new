...
class SyncMapItemList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($key, $data, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Key' => $key, 'Data' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($data), 'Ttl' => $options['ttl'], 'ItemTtl' => $options['itemTtl'], 'CollectionTtl' => $options['collectionTtl']));
