...
class WebhookList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\WebhookPage($this->version, $response, $this->solution);
    }
    /**
    ...
    public function create($target, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Target' => $target, 'Configuration.Url' => $options['configurationUrl'], 'Configuration.Method' => $options['configurationMethod'], 'Configuration.Filters' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['configurationFilters'], function ($e) {
            return $e;
        }), 'Configuration.Triggers' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['configurationTriggers'], function ($e) {
            return $e;
        }), 'Configuration.FlowSid' => $options['configurationFlowSid'], 'Configuration.RetryCount' => $options['configurationRetryCount'], 'Configuration.ReplayAfter' => $options['configurationReplayAfter'], 'Configuration.BufferMessages' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['configurationBufferMessages']), 'Configuration.BufferWindow' => $options['configurationBufferWindow']));
        $payload = $this->version->create('POST', $this->uri, array(), $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\WebhookInstance($this->version, $payload, $this->solution['sessionSid']);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\WebhookContext($this->version, $this->solution['sessionSid'], $sid);
    }
    /**
