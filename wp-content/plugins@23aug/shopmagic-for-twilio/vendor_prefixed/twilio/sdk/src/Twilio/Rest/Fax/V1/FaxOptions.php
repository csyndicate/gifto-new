...
abstract class FaxOptions
{
     ...
     */
    public static function read($from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedOnOrBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\ReadFaxOptions($from, $to, $dateCreatedOnOrBefore, $dateCreatedAfter);
    }
    /**
     ...
     */
    public static function create($quality = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, $storeMedia = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\CreateFaxOptions($quality, $statusCallback, $from, $sipAuthUsername, $sipAuthPassword, $storeMedia, $ttl);
    }
    /**
     * @param string $status The new status of the resource
     * @return UpdateFaxOptions Options builder
     */
    public static function update($status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\UpdateFaxOptions($status);
    }
}
class ReadFaxOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $from Retrieve only those faxes sent from this phone number
     * @param string $to Retrieve only those faxes sent to this phone number
     ...
     *                                    date
     */
    public function __construct($from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $to = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedOnOrBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateFaxOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $quality The quality of this fax
     * @param string $statusCallback The URL we should call to send status
     ...
     * @param int $ttl How long in minutes to try to send the fax
     */
    public function __construct($quality = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipAuthUsername = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipAuthPassword = \ShopMagicTwilioVendor\Twilio\Values::NONE, $storeMedia = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateFaxOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $status The new status of the resource
     */
    public function __construct($status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
