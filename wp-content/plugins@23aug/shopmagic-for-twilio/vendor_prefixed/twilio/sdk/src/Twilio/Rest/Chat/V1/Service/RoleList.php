...
class RoleList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('FriendlyName' => $friendlyName, 'Type' => $type, 'Permission' => \ShopMagicTwilioVendor\Twilio\Serialize::map($permission, function ($e) {
            return $e;
        })));
