...
abstract class TriggerOptions
{
     ...
     */
    public static function update($callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function create($callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function read($recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, $usageCategory = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateTriggerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $friendlyName A string to describe the resource
     */
    public function __construct($callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateTriggerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                          the trigger
     */
    public function __construct($callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['callbackMethod'] = $callbackMethod;
        $this->options['friendlyName'] = $friendlyName;
...
class ReadTriggerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $usageCategory The usage category of the UsageTriggers to read
     */
    public function __construct($recurring = \ShopMagicTwilioVendor\Twilio\Values::NONE, $triggerBy = \ShopMagicTwilioVendor\Twilio\Values::NONE, $usageCategory = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['recurring'] = $recurring;
        $this->options['triggerBy'] = $triggerBy;
