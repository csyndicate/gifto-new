...
abstract class EventOptions
{
     ...
     */
    public static function read($endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $eventType = \ShopMagicTwilioVendor\Twilio\Values::NONE, $minutes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reservationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadEventOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $sid The unique string that identifies the resource
     */
    public function __construct($endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $eventType = \ShopMagicTwilioVendor\Twilio\Values::NONE, $minutes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reservationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
