...
class WebhookContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\WebhookInstance($this->version, $payload);
    }
    /**
    ...
    public function update($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Method' => $options['method'], 'Filters' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['filters'], function ($e) {
            return $e;
