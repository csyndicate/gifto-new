...
class ItemAssignmentList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $bundleSid)
    {
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('ObjectSid' => $objectSid));
