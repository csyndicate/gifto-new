...
class FlowContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function update($status, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Status' => $status, 'FriendlyName' => $options['friendlyName'], 'Definition' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($options['definition']), 'CommitMessage' => $options['commitMessage']));
