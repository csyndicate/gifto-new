...
class AvailablePhoneNumberCountryInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, $accountSid, $countryCode = null)
    {
        parent::__construct($version);
        // Marshaled Properties
        $this->properties = array('countryCode' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'country_code'), 'country' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'country'), 'uri' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'uri'), 'beta' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'beta'), 'subresourceUris' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'subresource_uris'));
        $this->solution = array('accountSid' => $accountSid, 'countryCode' => $countryCode ?: $this->properties['countryCode']);
    }
    /**
