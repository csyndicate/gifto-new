...
abstract class DomainOptions
{
     ...
     */
    public static function create($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\CreateDomainOptions($friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl, $voiceFallbackMethod, $voiceStatusCallbackUrl, $voiceStatusCallbackMethod, $sipRegistration);
    }
    /**
     * @param string $friendlyName A string to describe the resource
     ...
     */
    public static function update($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::NONE, $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Sip\UpdateDomainOptions($friendlyName, $voiceFallbackMethod, $voiceFallbackUrl, $voiceMethod, $voiceStatusCallbackMethod, $voiceStatusCallbackUrl, $voiceUrl, $sipRegistration, $domainName);
    }
}
class CreateDomainOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $sipRegistration Whether SIP registration is allowed
     */
    public function __construct($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateDomainOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $domainName The unique address on Twilio to route SIP traffic
     */
    public function __construct($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceStatusCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sipRegistration = \ShopMagicTwilioVendor\Twilio\Values::NONE, $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
        $this->options['voiceFallbackMethod'] = $voiceFallbackMethod;
        $this->options['voiceFallbackUrl'] = $voiceFallbackUrl;
