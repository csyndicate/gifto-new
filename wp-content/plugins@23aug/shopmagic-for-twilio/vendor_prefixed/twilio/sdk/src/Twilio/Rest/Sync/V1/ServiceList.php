...
class ServiceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('FriendlyName' => $options['friendlyName'], 'WebhookUrl' => $options['webhookUrl'], 'ReachabilityWebhooksEnabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['reachabilityWebhooksEnabled']), 'AclEnabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['aclEnabled']), 'ReachabilityDebouncingEnabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['reachabilityDebouncingEnabled']), 'ReachabilityDebouncingWindow' => $options['reachabilityDebouncingWindow'], 'WebhooksFromRestEnabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['webhooksFromRestEnabled'])));
