...
abstract class RecordingOptions
{
     ...
     */
    public static function read($dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $conferenceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\ReadRecordingOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter, $callSid, $conferenceSid);
    }
}
class ReadRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $conferenceSid Read by unique Conference SID for the recording
     */
    public function __construct($dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $conferenceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
