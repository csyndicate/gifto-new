...
abstract class SessionOptions
{
     ...
     */
    public static function create($uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateExpiry = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $participants = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($dateExpiry = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateSessionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                            session
     */
    public function __construct($uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateExpiry = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $participants = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateSessionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $status The new status of the resource
     */
    public function __construct($dateExpiry = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['dateExpiry'] = $dateExpiry;
        $this->options['ttl'] = $ttl;
        $this->options['status'] = $status;
