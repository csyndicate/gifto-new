...
abstract class WorkerOptions
{
     ...
     */
    public static function read($activityName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $activitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $available = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $targetWorkersExpression = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadWorkerOptions($activityName, $activitySid, $available, $friendlyName, $targetWorkersExpression, $taskQueueName, $taskQueueSid);
    }
    /**
     ...
     */
    public static function create($activitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($activitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $rejectPendingReservations = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\UpdateWorkerOptions($activitySid, $attributes, $friendlyName, $rejectPendingReservations);
    }
}
class ReadWorkerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                             read are eligible for
     */
    public function __construct($activityName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $activitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $available = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $targetWorkersExpression = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateWorkerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $attributes A valid JSON string that describes the new Worker
     */
    public function __construct($activitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['activitySid'] = $activitySid;
...
class UpdateWorkerOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $rejectPendingReservations Whether to reject pending reservations
     */
    public function __construct($activitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $rejectPendingReservations = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['activitySid'] = $activitySid;
        $this->options['attributes'] = $attributes;
        $this->options['friendlyName'] = $friendlyName;
