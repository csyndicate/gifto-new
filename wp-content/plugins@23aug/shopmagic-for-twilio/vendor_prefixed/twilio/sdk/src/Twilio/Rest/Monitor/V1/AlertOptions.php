...
abstract class AlertOptions
{
     ...
     */
    public static function read($logLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, $startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\ReadAlertOptions($logLevel, $startDate, $endDate);
    }
}
class ReadAlertOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $logLevel Only show alerts for this log-level
     * @param \DateTime $startDate Only include alerts that occurred on or after
     ...
     *                           this date and time
     */
    public function __construct($logLevel = \ShopMagicTwilioVendor\Twilio\Values::NONE, $startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
