...
abstract class TrunkOptions
{
     ...
     */
    public static function create($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $disasterRecoveryUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $disasterRecoveryMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recording = \ShopMagicTwilioVendor\Twilio\Values::NONE, $secure = \ShopMagicTwilioVendor\Twilio\Values::NONE, $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\CreateTrunkOptions($friendlyName, $domainName, $disasterRecoveryUrl, $disasterRecoveryMethod, $recording, $secure, $cnamLookupEnabled);
    }
    /**
     * @param string $friendlyName A string to describe the resource
     * @param string $domainName The unique address you reserve on Twilio to which
     ...
     */
    public static function update($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $disasterRecoveryUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $disasterRecoveryMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recording = \ShopMagicTwilioVendor\Twilio\Values::NONE, $secure = \ShopMagicTwilioVendor\Twilio\Values::NONE, $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\UpdateTrunkOptions($friendlyName, $domainName, $disasterRecoveryUrl, $disasterRecoveryMethod, $recording, $secure, $cnamLookupEnabled);
    }
}
class CreateTrunkOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                be enabled for the trunk
     */
    public function __construct($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $domainName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $disasterRecoveryUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $disasterRecoveryMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recording = \ShopMagicTwilioVendor\Twilio\Values::NONE, $secure = \ShopMagicTwilioVendor\Twilio\Values::NONE, $cnamLookupEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
