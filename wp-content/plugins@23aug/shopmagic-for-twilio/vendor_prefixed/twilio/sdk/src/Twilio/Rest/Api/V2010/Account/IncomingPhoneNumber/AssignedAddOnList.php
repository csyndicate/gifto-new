...
class AssignedAddOnList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $accountSid, $resourceSid)
    {
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('InstalledAddOnSid' => $installedAddOnSid));
