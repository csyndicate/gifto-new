...
class SessionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($messagingServiceSid, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('MessagingServiceSid' => $messagingServiceSid, 'FriendlyName' => $options['friendlyName'], 'Attributes' => $options['attributes'], 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreated']), 'DateUpdated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateUpdated']), 'CreatedBy' => $options['createdBy']));
        $payload = $this->version->create('POST', $this->uri, array(), $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\SessionInstance($this->version, $payload);
    }
    /**
    ...
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\SessionPage($this->version, $response, $this->solution);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\SessionContext($this->version, $sid);
    }
    /**
