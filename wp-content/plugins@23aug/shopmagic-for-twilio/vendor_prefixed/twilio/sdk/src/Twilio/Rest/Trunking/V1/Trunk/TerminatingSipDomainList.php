...
class TerminatingSipDomainList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    /**
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('SipDomainSid' => $sipDomainSid));
        $payload = $this->version->create('POST', $this->uri, array(), $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\TerminatingSipDomainInstance($this->version, $payload, $this->solution['trunkSid']);
    }
    /**
    ...
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\TerminatingSipDomainPage($this->version, $response, $this->solution);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Trunking\V1\Trunk\TerminatingSipDomainContext($this->version, $this->solution['trunkSid'], $sid);
    }
    /**
