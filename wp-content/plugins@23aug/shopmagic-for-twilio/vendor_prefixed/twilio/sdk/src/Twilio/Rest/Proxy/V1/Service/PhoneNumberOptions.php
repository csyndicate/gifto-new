...
abstract class PhoneNumberOptions
{
     ...
     */
    public static function create($sid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, $isReserved = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($isReserved = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreatePhoneNumberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $isReserved Whether the new phone number should be reserved
     */
    public function __construct($sid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $phoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, $isReserved = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdatePhoneNumberOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $isReserved Whether the new phone number should be reserved
     */
    public function __construct($isReserved = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['isReserved'] = $isReserved;
    }
    /**
