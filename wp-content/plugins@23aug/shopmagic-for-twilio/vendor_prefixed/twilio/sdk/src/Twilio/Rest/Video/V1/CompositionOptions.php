...
abstract class CompositionOptions
{
     ...
     */
    public static function read($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $roomSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function create($videoLayout = \ShopMagicTwilioVendor\Twilio\Values::NONE, $audioSources = \ShopMagicTwilioVendor\Twilio\Values::NONE, $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::NONE, $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadCompositionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $roomSid Read only Composition resources with this Room SID
     */
    public function __construct($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $roomSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateCompositionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                   media in the composition
     */
    public function __construct($videoLayout = \ShopMagicTwilioVendor\Twilio\Values::NONE, $audioSources = \ShopMagicTwilioVendor\Twilio\Values::NONE, $audioSourcesExcluded = \ShopMagicTwilioVendor\Twilio\Values::NONE, $resolution = \ShopMagicTwilioVendor\Twilio\Values::NONE, $format = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
