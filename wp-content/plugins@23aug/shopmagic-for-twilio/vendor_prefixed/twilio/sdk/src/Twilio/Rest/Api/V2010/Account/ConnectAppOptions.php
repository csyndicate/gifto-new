...
abstract class ConnectAppOptions
{
     ...
     */
    public static function update($authorizeRedirectUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $companyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $deauthorizeCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $deauthorizeCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $description = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $homepageUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $permissions = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateConnectAppOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                            request
     */
    public function __construct($authorizeRedirectUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $companyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $deauthorizeCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $deauthorizeCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $description = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $homepageUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $permissions = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
