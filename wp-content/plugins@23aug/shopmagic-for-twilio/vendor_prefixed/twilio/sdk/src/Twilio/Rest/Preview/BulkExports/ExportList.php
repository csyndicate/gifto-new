...
use ShopMagicTwilioVendor\Twilio\Rest\Preview\BulkExports\Export\JobList;
...
class ExportList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    {
        if (!$this->_jobs) {
            $this->_jobs = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\BulkExports\Export\JobList($this->version);
        }
        return $this->_jobs;
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\BulkExports\ExportContext($this->version, $resourceType);
    }
    /**
