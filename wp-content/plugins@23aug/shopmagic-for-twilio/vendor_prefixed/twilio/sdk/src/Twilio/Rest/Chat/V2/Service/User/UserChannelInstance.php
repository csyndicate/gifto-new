...
class UserChannelInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\User\UserChannelContext($this->version, $this->solution['serviceSid'], $this->solution['userSid'], $this->solution['channelSid']);
        }
        return $this->context;
    }
    /**
