...
class StepContextInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, $flowSid, $engagementSid, $stepSid)
    {
        parent::__construct($version);
        // Marshaled Properties
        $this->properties = array('accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'context' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'context'), 'engagementSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'engagement_sid'), 'flowSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'flow_sid'), 'stepSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'step_sid'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url'));
