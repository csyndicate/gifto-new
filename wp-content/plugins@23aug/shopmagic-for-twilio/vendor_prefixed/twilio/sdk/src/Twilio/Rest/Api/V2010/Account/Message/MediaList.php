...
class MediaList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function page($options = array(), $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('DateCreated<' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreatedBefore']), 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreated']), 'DateCreated>' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreatedAfter']), 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
