...
class CapabilityToken
{
    ...
    protected $required = array("required" => \true);
    ...
    public function addPolicyDeconstructed($url, $method, $queryFilter = array(), $postFilter = array(), $allow = \true)
    {
    ...
    {
        $payload = array('version' => $this->version, 'friendly_name' => $this->friendlyName, 'iss' => $this->accountSid, 'exp' => \time() + $ttl, 'account_sid' => $this->accountSid, 'channel' => $this->channelId, 'workspace_sid' => $this->workspaceSid);
