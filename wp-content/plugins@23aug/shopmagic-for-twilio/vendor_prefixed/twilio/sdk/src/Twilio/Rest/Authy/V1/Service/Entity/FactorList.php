...
class FactorList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Binding' => $binding, 'FriendlyName' => $friendlyName, 'FactorType' => $factorType));
        $payload = $this->version->create('POST', $this->uri, array(), $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\Entity\FactorInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['identity']);
    }
    /**
    ...
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\Entity\FactorPage($this->version, $response, $this->solution);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\Entity\FactorContext($this->version, $this->solution['serviceSid'], $this->solution['identity'], $sid);
    }
    /**
