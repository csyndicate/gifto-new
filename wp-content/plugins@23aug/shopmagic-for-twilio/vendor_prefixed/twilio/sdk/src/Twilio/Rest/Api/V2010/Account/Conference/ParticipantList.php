...
class ParticipantList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $accountSid, $conferenceSid)
    {
    ...
    public function create($from, $to, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('From' => $from, 'To' => $to, 'StatusCallback' => $options['statusCallback'], 'StatusCallbackMethod' => $options['statusCallbackMethod'], 'StatusCallbackEvent' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['statusCallbackEvent'], function ($e) {
            return $e;
            ...
            return $e;
        }), 'Coaching' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['coaching']), 'CallSidToCoach' => $options['callSidToCoach']));
