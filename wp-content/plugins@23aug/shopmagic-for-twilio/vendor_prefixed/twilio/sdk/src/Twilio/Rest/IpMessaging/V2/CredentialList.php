...
class CredentialList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($type, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Type' => $type, 'FriendlyName' => $options['friendlyName'], 'Certificate' => $options['certificate'], 'PrivateKey' => $options['privateKey'], 'Sandbox' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['sandbox']), 'ApiKey' => $options['apiKey'], 'Secret' => $options['secret']));
