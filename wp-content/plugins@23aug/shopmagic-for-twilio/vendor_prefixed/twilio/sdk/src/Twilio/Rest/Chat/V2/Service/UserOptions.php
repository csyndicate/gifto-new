...
abstract class UserOptions
{
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\CreateUserOptions($roleSid, $attributes, $friendlyName);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V2\Service\UpdateUserOptions($roleSid, $attributes, $friendlyName);
    }
}
