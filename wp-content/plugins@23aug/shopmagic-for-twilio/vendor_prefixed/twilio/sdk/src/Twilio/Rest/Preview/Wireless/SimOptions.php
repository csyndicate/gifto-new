...
abstract class SimOptions
{
     ...
     */
    public static function read($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $iccid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ratePlan = \ShopMagicTwilioVendor\Twilio\Values::NONE, $eId = \ShopMagicTwilioVendor\Twilio\Values::NONE, $simRegistrationCode = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\ReadSimOptions($status, $iccid, $ratePlan, $eId, $simRegistrationCode);
    }
    /**
     ...
     */
    public static function update($uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ratePlan = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $commandsCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $commandsCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless\UpdateSimOptions($uniqueName, $callbackMethod, $callbackUrl, $friendlyName, $ratePlan, $status, $commandsCallbackMethod, $commandsCallbackUrl, $smsFallbackMethod, $smsFallbackUrl, $smsMethod, $smsUrl, $voiceFallbackMethod, $voiceFallbackUrl, $voiceMethod, $voiceUrl);
    }
}
class ReadSimOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $simRegistrationCode The sim_registration_code
     */
    public function __construct($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $iccid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ratePlan = \ShopMagicTwilioVendor\Twilio\Values::NONE, $eId = \ShopMagicTwilioVendor\Twilio\Values::NONE, $simRegistrationCode = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateSimOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $voiceUrl The voice_url
     */
    public function __construct($uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ratePlan = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $commandsCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $commandsCallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceFallbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
