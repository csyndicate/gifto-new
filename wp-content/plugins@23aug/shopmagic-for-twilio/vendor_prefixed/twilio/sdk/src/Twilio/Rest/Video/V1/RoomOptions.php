...
abstract class RoomOptions
{
     ...
     */
    public static function create($enableTurn = \ShopMagicTwilioVendor\Twilio\Values::NONE, $type = \ShopMagicTwilioVendor\Twilio\Values::NONE, $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordParticipantsOnConnect = \ShopMagicTwilioVendor\Twilio\Values::NONE, $videoCodecs = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mediaRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Video\V1\CreateRoomOptions($enableTurn, $type, $uniqueName, $statusCallback, $statusCallbackMethod, $maxParticipants, $recordParticipantsOnConnect, $videoCodecs, $mediaRegion);
    }
    /**
     ...
     */
    public static function read($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateRoomOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $mediaRegion The region for the media server in Group Rooms
     */
    public function __construct($enableTurn = \ShopMagicTwilioVendor\Twilio\Values::NONE, $type = \ShopMagicTwilioVendor\Twilio\Values::NONE, $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxParticipants = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordParticipantsOnConnect = \ShopMagicTwilioVendor\Twilio\Values::NONE, $videoCodecs = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mediaRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadRoomOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                     date, given as YYYY-MM-DD
     */
    public function __construct($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
