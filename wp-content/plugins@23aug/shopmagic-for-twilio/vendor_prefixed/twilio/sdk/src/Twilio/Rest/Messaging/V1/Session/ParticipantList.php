...
class ParticipantList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Identity' => $options['identity'], 'UserAddress' => $options['userAddress'], 'Attributes' => $options['attributes'], 'TwilioAddress' => $options['twilioAddress'], 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreated']), 'DateUpdated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateUpdated'])));
        $payload = $this->version->create('POST', $this->uri, array(), $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\ParticipantInstance($this->version, $payload, $this->solution['sessionSid']);
    }
    /**
    ...
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\ParticipantPage($this->version, $response, $this->solution);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\ParticipantContext($this->version, $this->solution['sessionSid'], $sid);
    }
    /**
