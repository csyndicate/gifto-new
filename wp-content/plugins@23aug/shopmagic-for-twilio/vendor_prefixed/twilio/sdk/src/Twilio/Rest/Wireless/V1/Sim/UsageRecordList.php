...
class UsageRecordList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function page($options = array(), $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('End' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['end']), 'Start' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['start']), 'Granularity' => $options['granularity'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
