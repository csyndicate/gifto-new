...
abstract class Version
{
    ...
    protected function exception($response, $header)
    {
        ...
        if (\is_array($content)) {
            ...
            return new \ShopMagicTwilioVendor\Twilio\Exceptions\RestException($message, $code, $response->getStatusCode());
        } else {
     ...
     */
    public function fetch($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null)
    {
     ...
     * @throws TwilioException
     */
    public function update($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null)
    {
        $response = $this->request($method, $uri, $params, $data, $headers, $username, $password, $timeout);
        if ($response->getStatusCode() < 200 || $response->getStatusCode() >= 300) {
     ...
     * @throws TwilioException
     */
    public function delete($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null)
    {
        $response = $this->request($method, $uri, $params, $data, $headers, $username, $password, $timeout);
        if ($response->getStatusCode() < 200 || $response->getStatusCode() >= 300) {
    ...
    {
        $pageLimit = \ShopMagicTwilioVendor\Twilio\Values::NONE;
        if ($limit) {
            if (\is_null($pageSize)) {
        ...
        return array('limit' => $limit ?: \ShopMagicTwilioVendor\Twilio\Values::NONE, 'pageSize' => $pageSize ?: \ShopMagicTwilioVendor\Twilio\Values::NONE, 'pageLimit' => $pageLimit);
    }
    public function page($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null)
    {
     ...
     * @throws TwilioException
     */
    public function create($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null)
    {
        $response = $this->request($method, $uri, $params, $data, $headers, $username, $password, $timeout);
        if ($response->getStatusCode() < 200 || $response->getStatusCode() >= 300) {
