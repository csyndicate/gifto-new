...
abstract class TaskQueueOptions
{
     ...
     */
    public static function update($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $targetWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reservationActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxReservedWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function read($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $evaluateWorkerAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\ReadTaskQueueOptions($friendlyName, $evaluateWorkerAttributes, $workerSid);
    }
    /**
     * @param string $targetWorkers A string describing the Worker selection
     *                              criteria for any Tasks that enter the TaskQueue
     ...
     */
    public static function create($targetWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxReservedWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reservationActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateTaskQueueOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $taskOrder How Tasks will be assigned to Workers
     */
    public function __construct($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $targetWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reservationActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxReservedWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadTaskQueueOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                          to read
     */
    public function __construct($friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $evaluateWorkerAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workerSid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
...
class CreateTaskQueueOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                      Workers once a task is assigned to them
     */
    public function __construct($targetWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxReservedWorkers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskOrder = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reservationActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentActivitySid = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['targetWorkers'] = $targetWorkers;
        $this->options['maxReservedWorkers'] = $maxReservedWorkers;
        $this->options['taskOrder'] = $taskOrder;
