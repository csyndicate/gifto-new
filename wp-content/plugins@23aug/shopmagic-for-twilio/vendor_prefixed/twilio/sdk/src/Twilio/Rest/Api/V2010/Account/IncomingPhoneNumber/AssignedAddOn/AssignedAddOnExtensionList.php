...
class AssignedAddOnExtensionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $accountSid, $resourceSid, $assignedAddOnSid)
    {
        parent::__construct($version);
        // Path Solution
        $this->solution = array('accountSid' => $accountSid, 'resourceSid' => $resourceSid, 'assignedAddOnSid' => $assignedAddOnSid);
