...
class ServiceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($uniqueName, $friendlyName, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('UniqueName' => $uniqueName, 'FriendlyName' => $friendlyName, 'IncludeCredentials' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['includeCredentials'])));
