...
class ParticipantList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $conversationSid)
    {
    ...
    public function create($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Identity' => $options['identity'], 'MessagingBinding.Address' => $options['messagingBindingAddress'], 'MessagingBinding.ProxyAddress' => $options['messagingBindingProxyAddress'], 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreated']), 'DateUpdated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateUpdated']), 'Attributes' => $options['attributes'], 'MessagingBinding.ProjectedAddress' => $options['messagingBindingProjectedAddress']));
