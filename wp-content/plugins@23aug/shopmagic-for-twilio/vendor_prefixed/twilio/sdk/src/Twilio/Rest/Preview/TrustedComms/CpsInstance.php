 ...
 * @property string $url
 */
class CpsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload)
    {
        ...
        $this->properties = array('cpsUrl' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'cps_url'), 'phoneNumber' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'phone_number'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url'));
        $this->solution = array();
    }
    /**
    ...
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms\CpsContext($this->version);
        }
        return $this->context;
    }
    /**
