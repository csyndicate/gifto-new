...
class AddressList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($customerName, $street, $city, $region, $postalCode, $isoCountry, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('CustomerName' => $customerName, 'Street' => $street, 'City' => $city, 'Region' => $region, 'PostalCode' => $postalCode, 'IsoCountry' => $isoCountry, 'FriendlyName' => $options['friendlyName'], 'EmergencyEnabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['emergencyEnabled']), 'AutoCorrectAddress' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['autoCorrectAddress'])));
    ...
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('CustomerName' => $options['customerName'], 'FriendlyName' => $options['friendlyName'], 'IsoCountry' => $options['isoCountry'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
