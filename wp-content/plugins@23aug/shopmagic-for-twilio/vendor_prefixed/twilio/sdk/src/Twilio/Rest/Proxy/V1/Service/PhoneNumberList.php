...
class PhoneNumberList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Sid' => $options['sid'], 'PhoneNumber' => $options['phoneNumber'], 'IsReserved' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['isReserved'])));
