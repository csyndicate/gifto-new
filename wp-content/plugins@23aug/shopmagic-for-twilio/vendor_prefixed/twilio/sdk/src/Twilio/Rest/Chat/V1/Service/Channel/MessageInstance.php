...
class MessageInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\Channel\MessageContext($this->version, $this->solution['serviceSid'], $this->solution['channelSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
