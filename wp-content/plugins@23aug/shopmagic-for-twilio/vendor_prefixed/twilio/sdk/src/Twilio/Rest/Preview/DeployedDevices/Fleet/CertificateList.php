...
class CertificateList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($certificateData, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('CertificateData' => $certificateData, 'FriendlyName' => $options['friendlyName'], 'DeviceSid' => $options['deviceSid']));
    ...
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('DeviceSid' => $options['deviceSid'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
