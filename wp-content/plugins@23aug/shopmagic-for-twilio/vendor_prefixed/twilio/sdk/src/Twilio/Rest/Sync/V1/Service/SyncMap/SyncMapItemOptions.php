...
abstract class SyncMapItemOptions
{
     ...
     */
    public static function create($ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function read($order = \ShopMagicTwilioVendor\Twilio\Values::NONE, $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $bounds = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($data = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\SyncMap\UpdateSyncMapItemOptions($data, $ttl, $itemTtl, $collectionTtl);
    }
}
class CreateSyncMapItemOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                           Sync Map expires and is deleted
     */
    public function __construct($ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadSyncMapItemOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                       parameter
     */
    public function __construct($order = \ShopMagicTwilioVendor\Twilio\Values::NONE, $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $bounds = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateSyncMapItemOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                           Sync Map expires and is deleted
     */
    public function __construct($data = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $itemTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $collectionTtl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
