...
class CurlClient implements \ShopMagicTwilioVendor\Twilio\Http\Client
{
    ...
    public function options($method, $url, $params = array(), $data = array(), $headers = array(), $user = null, $password = null, $timeout = null)
    {
        ...
        $options = $this->curlOptions + array(\CURLOPT_URL => $url, \CURLOPT_HEADER => \true, \CURLOPT_RETURNTRANSFER => \true, \CURLOPT_INFILESIZE => Null, \CURLOPT_HTTPHEADER => array(), \CURLOPT_TIMEOUT => $timeout);
        foreach ($headers as $key => $value) {
