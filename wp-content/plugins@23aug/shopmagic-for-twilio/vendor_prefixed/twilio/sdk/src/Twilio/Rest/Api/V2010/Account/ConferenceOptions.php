...
abstract class ConferenceOptions
{
     ...
     */
    public static function read($dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $announceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $announceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadConferenceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $status The status of the resources to read
     */
    public function __construct($dateCreatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdatedBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdatedAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateConferenceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $announceMethod he HTTP method used to call announce_url
     */
    public function __construct($status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $announceUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $announceMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['status'] = $status;
