...
use ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\Fax\FaxMediaList;
 ...
 */
class FaxContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\FaxInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    {
        if (!$this->_media) {
            $this->_media = new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\Fax\FaxMediaList($this->version, $this->solution['sid']);
        }
        return $this->_media;
    }
    /**
