...
abstract class VerificationCheckOptions
{
     ...
     */
    public static function create($to = \ShopMagicTwilioVendor\Twilio\Values::NONE, $verificationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\CreateVerificationCheckOptions($to, $verificationSid, $amount, $payee);
    }
}
class CreateVerificationCheckOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $payee The payee of the associated PSD2 compliant transaction
     */
    public function __construct($to = \ShopMagicTwilioVendor\Twilio\Values::NONE, $verificationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['to'] = $to;
