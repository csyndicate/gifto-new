...
use ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\EntityList;
...
class ServiceContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\ServiceInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    {
        if (!$this->_entities) {
            $this->_entities = new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\EntityList($this->version, $this->solution['sid']);
        }
