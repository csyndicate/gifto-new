...
abstract class DocumentOptions
{
     ...
     */
    public static function create($uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $data = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($data = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Sync\V1\Service\UpdateDocumentOptions($data, $ttl);
    }
}
class CreateDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                 is deleted
     */
    public function __construct($uniqueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $data = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                 and is deleted
     */
    public function __construct($data = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ttl = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['data'] = $data;
        $this->options['ttl'] = $ttl;
    }
