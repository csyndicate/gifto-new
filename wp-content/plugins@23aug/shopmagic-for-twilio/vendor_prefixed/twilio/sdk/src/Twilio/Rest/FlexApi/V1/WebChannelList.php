...
class WebChannelList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($flexFlowSid, $identity, $customerFriendlyName, $chatFriendlyName, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('FlexFlowSid' => $flexFlowSid, 'Identity' => $identity, 'CustomerFriendlyName' => $customerFriendlyName, 'ChatFriendlyName' => $chatFriendlyName, 'ChatUniqueName' => $options['chatUniqueName'], 'PreEngagementData' => $options['preEngagementData']));
