...
class OriginationUrlList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Weight' => $weight, 'Priority' => $priority, 'Enabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($enabled), 'FriendlyName' => $friendlyName, 'SipUrl' => $sipUrl));
