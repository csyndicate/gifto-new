...
class RecordingList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('RecordingStatusCallbackEvent' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['recordingStatusCallbackEvent'], function ($e) {
            return $e;
        }), 'RecordingStatusCallback' => $options['recordingStatusCallback'], 'RecordingStatusCallbackMethod' => $options['recordingStatusCallbackMethod'], 'Trim' => $options['trim'], 'RecordingChannels' => $options['recordingChannels']));
    ...
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('DateCreated<' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateCreatedBefore']), 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateCreated']), 'DateCreated>' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateCreatedAfter']), 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
