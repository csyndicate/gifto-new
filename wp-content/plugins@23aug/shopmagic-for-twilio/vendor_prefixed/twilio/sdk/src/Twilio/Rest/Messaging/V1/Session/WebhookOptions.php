...
abstract class WebhookOptions
{
     ...
     */
    public static function create($configurationUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationFilters = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationTriggers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationRetryCount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationReplayAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationBufferMessages = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationBufferWindow = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\CreateWebhookOptions($configurationUrl, $configurationMethod, $configurationFilters, $configurationTriggers, $configurationFlowSid, $configurationRetryCount, $configurationReplayAfter, $configurationBufferMessages, $configurationBufferWindow);
    }
    /**
     * @param string $configurationUrl The absolute URL the webhook request should
     *                                 be sent to
     ...
     */
    public static function update($configurationUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationFilters = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationTriggers = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationFlowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationRetryCount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationBufferMessages = \ShopMagicTwilioVendor\Twilio\Values::NONE, $configurationBufferWindow = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\UpdateWebhookOptions($configurationUrl, $configurationMethod, $configurationFilters, $configurationTriggers, $configurationFlowSid, $configurationRetryCount, $configurationBufferMessages, $configurationBufferWindow);
    }
}
