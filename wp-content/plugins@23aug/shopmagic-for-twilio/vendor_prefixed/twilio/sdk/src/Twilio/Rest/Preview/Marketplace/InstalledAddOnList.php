...
class InstalledAddOnList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($availableAddOnSid, $acceptTermsOfService, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('AvailableAddOnSid' => $availableAddOnSid, 'AcceptTermsOfService' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($acceptTermsOfService), 'Configuration' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($options['configuration']), 'UniqueName' => $options['uniqueName']));
