...
abstract class MessageOptions
{
     ...
     */
    public static function create($from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mediaUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $applicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxPrice = \ShopMagicTwilioVendor\Twilio\Values::NONE, $provideFeedback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $validityPeriod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $forceDelivery = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contentRetention = \ShopMagicTwilioVendor\Twilio\Values::NONE, $addressRetention = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smartEncoded = \ShopMagicTwilioVendor\Twilio\Values::NONE, $persistentAction = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\CreateMessageOptions($from, $messagingServiceSid, $body, $mediaUrl, $statusCallback, $applicationSid, $maxPrice, $provideFeedback, $validityPeriod, $forceDelivery, $contentRetention, $addressRetention, $smartEncoded, $persistentAction);
    }
    /**
     ...
     */
    public static function read($to = \ShopMagicTwilioVendor\Twilio\Values::NONE, $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateSentBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateSent = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateSentAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateMessageOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $persistentAction Rich actions for Channels Messages.
     */
    public function __construct($from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingServiceSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $body = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mediaUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $statusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $applicationSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $maxPrice = \ShopMagicTwilioVendor\Twilio\Values::NONE, $provideFeedback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $validityPeriod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $forceDelivery = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contentRetention = \ShopMagicTwilioVendor\Twilio\Values::NONE, $addressRetention = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smartEncoded = \ShopMagicTwilioVendor\Twilio\Values::NONE, $persistentAction = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadMessageOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $dateSentAfter Filter by date sent
     */
    public function __construct($to = \ShopMagicTwilioVendor\Twilio\Values::NONE, $from = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateSentBefore = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateSent = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateSentAfter = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['to'] = $to;
        $this->options['from'] = $from;
