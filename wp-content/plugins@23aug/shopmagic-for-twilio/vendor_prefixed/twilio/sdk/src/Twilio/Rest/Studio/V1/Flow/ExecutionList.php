...
class ExecutionList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $flowSid)
    {
    ...
    public function page($options = array(), $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('DateCreatedFrom' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreatedFrom']), 'DateCreatedTo' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreatedTo']), 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
    ...
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('To' => $to, 'From' => $from, 'Parameters' => \ShopMagicTwilioVendor\Twilio\Serialize::jsonObject($options['parameters'])));
