 ...
 * /       /
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms\Business;

use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\ListResource;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms\Business\Insights\SuccessRateList;
 ...
 */
class InsightsList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    protected function getSuccessRate()
    {
        if (!$this->_successRate) {
            $this->_successRate = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms\Business\Insights\SuccessRateList($this->version, $this->solution['businessSid']);
        }
