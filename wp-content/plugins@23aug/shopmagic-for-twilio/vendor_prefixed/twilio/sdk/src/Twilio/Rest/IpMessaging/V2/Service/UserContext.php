...
class UserContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\UserInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getUserChannels()
    {
        if (!$this->_userChannels) {
            $this->_userChannels = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\User\UserChannelList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
    ...
    protected function getUserBindings()
    {
        if (!$this->_userBindings) {
            $this->_userBindings = new \ShopMagicTwilioVendor\Twilio\Rest\IpMessaging\V2\Service\User\UserBindingList($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
