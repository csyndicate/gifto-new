...
abstract class PaymentOptions
{
     ...
     */
    public static function create($bankAccountType = \ShopMagicTwilioVendor\Twilio\Values::NONE, $chargeAmount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $currency = \ShopMagicTwilioVendor\Twilio\Values::NONE, $description = \ShopMagicTwilioVendor\Twilio\Values::NONE, $input = \ShopMagicTwilioVendor\Twilio\Values::NONE, $minPostalCodeLength = \ShopMagicTwilioVendor\Twilio\Values::NONE, $parameter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $paymentConnector = \ShopMagicTwilioVendor\Twilio\Values::NONE, $paymentMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $postalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $securityCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $timeout = \ShopMagicTwilioVendor\Twilio\Values::NONE, $tokenType = \ShopMagicTwilioVendor\Twilio\Values::NONE, $validCardTypes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function update($capture = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreatePaymentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                               types separated by space.
     */
    public function __construct($bankAccountType = \ShopMagicTwilioVendor\Twilio\Values::NONE, $chargeAmount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $currency = \ShopMagicTwilioVendor\Twilio\Values::NONE, $description = \ShopMagicTwilioVendor\Twilio\Values::NONE, $input = \ShopMagicTwilioVendor\Twilio\Values::NONE, $minPostalCodeLength = \ShopMagicTwilioVendor\Twilio\Values::NONE, $parameter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $paymentConnector = \ShopMagicTwilioVendor\Twilio\Values::NONE, $paymentMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $postalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $securityCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $timeout = \ShopMagicTwilioVendor\Twilio\Values::NONE, $tokenType = \ShopMagicTwilioVendor\Twilio\Values::NONE, $validCardTypes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdatePaymentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $status Instruction to complete or cancel the transaction.
     */
    public function __construct($capture = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
