...
abstract class ParticipantOptions
{
     ...
     */
    public static function create($identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingBindingAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\CreateParticipantOptions($identity, $messagingBindingAddress, $messagingBindingProxyAddress, $dateCreated, $dateUpdated, $attributes, $messagingBindingProjectedAddress);
    }
    /**
     * @param \DateTime $dateCreated The date that this resource was created.
     * @param \DateTime $dateUpdated The date that this resource was last updated.
     ...
     */
    public static function update($dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Conversations\V1\Conversation\UpdateParticipantOptions($dateCreated, $dateUpdated, $attributes);
    }
}
class CreateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                                 Group MMS.
     */
    public function __construct($identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingBindingAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingBindingProxyAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $messagingBindingProjectedAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                           store any data you wish.
     */
    public function __construct($dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['dateCreated'] = $dateCreated;
        $this->options['dateUpdated'] = $dateUpdated;
        $this->options['attributes'] = $attributes;
