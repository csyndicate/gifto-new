...
class BindingList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($identity, $bindingType, $address, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Identity' => $identity, 'BindingType' => $bindingType, 'Address' => $address, 'Tag' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['tag'], function ($e) {
            return $e;
    ...
    {
        $options = new \ShopMagicTwilioVendor\Twilio\Values($options);
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('StartDate' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['startDate']), 'EndDate' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['endDate']), 'Identity' => \ShopMagicTwilioVendor\Twilio\Serialize::map($options['identity'], function ($e) {
            return $e;
