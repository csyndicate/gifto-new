...
class EntityList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    {
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Identity' => $identity));
        $payload = $this->version->create('POST', $this->uri, array(), $data);
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\EntityInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    /**
    ...
    public function page($pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\EntityPage($this->version, $response, $this->solution);
    }
    /**
    ...
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\EntityContext($this->version, $this->solution['serviceSid'], $identity);
    }
    /**
