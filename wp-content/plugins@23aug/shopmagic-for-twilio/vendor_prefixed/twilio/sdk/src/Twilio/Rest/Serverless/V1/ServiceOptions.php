...
abstract class ServiceOptions
{
     ...
     */
    public static function create($includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\CreateServiceOptions($includeCredentials);
    }
    /**
     * @param bool $includeCredentials Whether to inject Account credentials into a
     *                                 function invocation context
     ...
     */
    public static function update($includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Serverless\V1\UpdateServiceOptions($includeCredentials, $friendlyName);
    }
}
class CreateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                 function invocation context
     */
    public function __construct($includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateServiceOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $friendlyName A string to describe the Service resource
     */
    public function __construct($includeCredentials = \ShopMagicTwilioVendor\Twilio\Values::NONE, $friendlyName = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['includeCredentials'] = $includeCredentials;
