...
class ConferenceList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function page($options = array(), $pageSize = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageToken = \ShopMagicTwilioVendor\Twilio\Values::NONE, $pageNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        ...
        $params = \ShopMagicTwilioVendor\Twilio\Values::of(array('DateCreated<' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateCreatedBefore']), 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateCreated']), 'DateCreated>' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateCreatedAfter']), 'DateUpdated<' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateUpdatedBefore']), 'DateUpdated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateUpdated']), 'DateUpdated>' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601Date($options['dateUpdatedAfter']), 'FriendlyName' => $options['friendlyName'], 'Status' => $options['status'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize));
