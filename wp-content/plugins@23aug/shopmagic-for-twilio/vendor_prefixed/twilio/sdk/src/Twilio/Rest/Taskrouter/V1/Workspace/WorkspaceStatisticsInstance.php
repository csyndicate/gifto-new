 ...
 * @property string $url
 */
class WorkspaceStatisticsInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    /**
    ...
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceStatisticsContext($this->version, $this->solution['workspaceSid']);
        }
        return $this->context;
    }
    /**
