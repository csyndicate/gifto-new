...
abstract class AuthorizationDocumentOptions
{
     ...
     */
    public static function update($hostedNumberOrderSids = \ShopMagicTwilioVendor\Twilio\Values::NONE, $addressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $email = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contactTitle = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contactPhoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function read($email = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function create($ccEmails = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateAuthorizationDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                   number.
     */
    public function __construct($hostedNumberOrderSids = \ShopMagicTwilioVendor\Twilio\Values::NONE, $addressSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $email = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ccEmails = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contactTitle = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contactPhoneNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadAuthorizationDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $status The Status of this AuthorizationDocument.
     */
    public function __construct($email = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['email'] = $email;
        $this->options['status'] = $status;
    }
...
class CreateAuthorizationDocumentOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $ccEmails A list of emails.
     */
    public function __construct($ccEmails = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['ccEmails'] = $ccEmails;
    }
    /**
