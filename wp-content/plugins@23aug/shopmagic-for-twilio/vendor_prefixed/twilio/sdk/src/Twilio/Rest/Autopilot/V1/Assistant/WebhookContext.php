...
class WebhookContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function update($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('UniqueName' => $options['uniqueName'], 'Events' => $options['events'], 'WebhookUrl' => $options['webhookUrl'], 'WebhookMethod' => $options['webhookMethod']));
