...
class ChallengeContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, $serviceSid, $identity, $factorSid, $sid)
    {
        parent::__construct($version);
        // Path Solution
        $this->solution = array('serviceSid' => $serviceSid, 'identity' => $identity, 'factorSid' => $factorSid, 'sid' => $sid);
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\Entity\Factor\ChallengeInstance($this->version, $payload, $this->solution['serviceSid'], $this->solution['identity'], $this->solution['factorSid'], $this->solution['sid']);
    }
    /**
