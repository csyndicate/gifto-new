...
abstract class ExecutionOptions
{
     ...
     */
    public static function read($dateCreatedFrom = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedTo = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\ReadExecutionOptions($dateCreatedFrom, $dateCreatedTo);
    }
    /**
     * @param array $parameters JSON data that will be added to the Flow's context
     * @return CreateExecutionOptions Options builder
     */
    public static function create($parameters = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\CreateExecutionOptions($parameters);
    }
}
class ReadExecutionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param \DateTime $dateCreatedFrom Only show Executions that started on or
     *                                   after this ISO 8601 date-time
     ...
     *                                 this ISO 8601 date-time
     */
    public function __construct($dateCreatedFrom = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreatedTo = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateExecutionOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param array $parameters JSON data that will be added to the Flow's context
     */
    public function __construct($parameters = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
