...
abstract class SuccessRateOptions
{
     ...
     */
    public static function fetch($brandSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $brandedChannelSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $phoneNumberSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $country = \ShopMagicTwilioVendor\Twilio\Values::NONE, $start = \ShopMagicTwilioVendor\Twilio\Values::NONE, $end = \ShopMagicTwilioVendor\Twilio\Values::NONE, $interval = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms\Business\Insights\FetchSuccessRateOptions($brandSid, $brandedChannelSid, $phoneNumberSid, $country, $start, $end, $interval);
    }
}
class FetchSuccessRateOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
    /**
     * @param string $brandSid Brand Sid.
     * @param string $brandedChannelSid Branded Channel Sid.
     ...
     * @param string $interval The Interval of this Success Rate.
     */
    public function __construct($brandSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $brandedChannelSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $phoneNumberSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $country = \ShopMagicTwilioVendor\Twilio\Values::NONE, $start = \ShopMagicTwilioVendor\Twilio\Values::NONE, $end = \ShopMagicTwilioVendor\Twilio\Values::NONE, $interval = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
