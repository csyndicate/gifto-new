...
class ExportConfigurationContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Preview\BulkExports\ExportConfigurationInstance($this->version, $payload, $this->solution['resourceType']);
    }
    /**
    ...
    public function update($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('Enabled' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['enabled']), 'WebhookUrl' => $options['webhookUrl'], 'WebhookMethod' => $options['webhookMethod']));
