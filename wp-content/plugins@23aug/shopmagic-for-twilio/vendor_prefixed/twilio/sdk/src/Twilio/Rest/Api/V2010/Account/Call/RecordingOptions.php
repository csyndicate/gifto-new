...
abstract class RecordingOptions
{
     ...
     */
    public static function create($recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Api\V2010\Account\Call\CreateRecordingOptions($recordingStatusCallbackEvent, $recordingStatusCallback, $recordingStatusCallbackMethod, $trim, $recordingChannels);
    }
    /**
     ...
     */
    public static function update($pauseBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                  recording will be configured with
     */
    public function __construct($recordingStatusCallbackEvent = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordingStatusCallback = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordingStatusCallbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $trim = \ShopMagicTwilioVendor\Twilio\Values::NONE, $recordingChannels = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateRecordingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                              period.
     */
    public function __construct($pauseBehavior = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
