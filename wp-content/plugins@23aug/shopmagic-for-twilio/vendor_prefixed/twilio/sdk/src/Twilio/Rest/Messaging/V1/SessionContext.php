...
use ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\MessageList;
use ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\ParticipantList;
use ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\WebhookList;
...
class SessionContext extends \ShopMagicTwilioVendor\Twilio\InstanceContext
{
    ...
    public function fetch()
    {
        ...
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\SessionInstance($this->version, $payload, $this->solution['sid']);
    }
    /**
    ...
    public function update($options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('FriendlyName' => $options['friendlyName'], 'Attributes' => $options['attributes'], 'DateCreated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateCreated']), 'DateUpdated' => \ShopMagicTwilioVendor\Twilio\Serialize::iso8601DateTime($options['dateUpdated']), 'CreatedBy' => $options['createdBy']));
    ...
    protected function getParticipants()
    {
        if (!$this->_participants) {
            $this->_participants = new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\ParticipantList($this->version, $this->solution['sid']);
        }
    ...
    {
        if (!$this->_messages) {
            $this->_messages = new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\MessageList($this->version, $this->solution['sid']);
        }
    ...
    {
        if (!$this->_webhooks) {
            $this->_webhooks = new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\WebhookList($this->version, $this->solution['sid']);
        }
