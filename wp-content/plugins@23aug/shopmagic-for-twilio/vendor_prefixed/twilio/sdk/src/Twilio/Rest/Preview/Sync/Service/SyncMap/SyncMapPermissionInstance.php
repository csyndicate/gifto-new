...
class SyncMapPermissionInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, $serviceSid, $mapSid, $identity = null)
    {
        parent::__construct($version);
        // Marshaled Properties
        $this->properties = array('accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'serviceSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'service_sid'), 'mapSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'map_sid'), 'identity' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'identity'), 'read' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'read'), 'write' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'write'), 'manage' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'manage'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url'));
        $this->solution = array('serviceSid' => $serviceSid, 'mapSid' => $mapSid, 'identity' => $identity ?: $this->properties['identity']);
    }
    /**
