...
class UserBindingInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, $serviceSid, $userSid, $sid = null)
    {
        ...
        $this->solution = array('serviceSid' => $serviceSid, 'userSid' => $userSid, 'sid' => $sid ?: $this->properties['sid']);
    }
    /**
