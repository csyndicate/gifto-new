...
class ExecutionContextInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\Twilio\Version $version, array $payload, $flowSid, $executionSid)
    {
        parent::__construct($version);
        // Marshaled Properties
        $this->properties = array('accountSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'account_sid'), 'context' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'context'), 'flowSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'flow_sid'), 'executionSid' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'execution_sid'), 'url' => \ShopMagicTwilioVendor\Twilio\Values::array_get($payload, 'url'));
    ...
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Studio\V1\Flow\Execution\ExecutionContextContext($this->version, $this->solution['flowSid'], $this->solution['executionSid']);
        }
        return $this->context;
    }
    /**
