...
class UserInstance extends \ShopMagicTwilioVendor\Twilio\InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new \ShopMagicTwilioVendor\Twilio\Rest\Chat\V1\Service\UserContext($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
