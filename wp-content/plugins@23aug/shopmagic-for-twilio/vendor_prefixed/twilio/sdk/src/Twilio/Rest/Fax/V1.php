 ...
 * /       /
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Fax;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\FaxList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    {
        if (!$this->_faxes) {
            $this->_faxes = new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1\FaxList($this);
        }
        return $this->_faxes;
    }
    /**
