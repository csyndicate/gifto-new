...
use ShopMagicTwilioVendor\Twilio\Rest\Fax\V1;
/**
 ...
 */
class Fax extends \ShopMagicTwilioVendor\Twilio\Domain
{
    protected $_v1 = null;
    /**
    ...
    {
        if (!$this->_v1) {
            $this->_v1 = new \ShopMagicTwilioVendor\Twilio\Rest\Fax\V1($this);
        }
        return $this->_v1;
    }
    /**
