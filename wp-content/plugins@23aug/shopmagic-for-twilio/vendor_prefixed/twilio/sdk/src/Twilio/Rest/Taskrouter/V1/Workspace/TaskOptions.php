...
abstract class TaskOptions
{
     ...
     */
    public static function update($attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reason = \ShopMagicTwilioVendor\Twilio\Values::NONE, $priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\UpdateTaskOptions($attributes, $assignmentStatus, $reason, $priority, $taskChannel);
    }
    /**
     ...
     */
    public static function read($priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $evaluateTaskAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ordering = \ShopMagicTwilioVendor\Twilio\Values::NONE, $hasAddons = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function create($timeout = \ShopMagicTwilioVendor\Twilio\Values::NONE, $priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Taskrouter\V1\Workspace\CreateTaskOptions($timeout, $priority, $taskChannel, $workflowSid, $attributes);
    }
}
class UpdateTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                            TaskChannel with the task to update
     */
    public function __construct($attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, $reason = \ShopMagicTwilioVendor\Twilio\Values::NONE, $priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $hasAddons Whether to read Tasks with addons
     */
    public function __construct($priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, $assignmentStatus = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskQueueName = \ShopMagicTwilioVendor\Twilio\Values::NONE, $evaluateTaskAttributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $ordering = \ShopMagicTwilioVendor\Twilio\Values::NONE, $hasAddons = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['priority'] = $priority;
        $this->options['assignmentStatus'] = $assignmentStatus;
...
class CreateTaskOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                           attributes of the task
     */
    public function __construct($timeout = \ShopMagicTwilioVendor\Twilio\Values::NONE, $priority = \ShopMagicTwilioVendor\Twilio\Values::NONE, $taskChannel = \ShopMagicTwilioVendor\Twilio\Values::NONE, $workflowSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
