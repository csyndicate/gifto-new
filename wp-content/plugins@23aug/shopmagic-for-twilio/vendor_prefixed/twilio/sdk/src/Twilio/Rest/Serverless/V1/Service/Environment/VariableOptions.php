...
abstract class VariableOptions
{
     ...
     */
    public static function update($key = \ShopMagicTwilioVendor\Twilio\Values::NONE, $value = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateVariableOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $value A string that contains the actual value of the variable
     */
    public function __construct($key = \ShopMagicTwilioVendor\Twilio\Values::NONE, $value = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
