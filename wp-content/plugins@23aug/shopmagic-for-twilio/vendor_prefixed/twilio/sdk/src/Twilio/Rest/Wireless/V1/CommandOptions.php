...
abstract class CommandOptions
{
     ...
     */
    public static function read($sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE, $transport = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function create($sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $commandMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $includeSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $deliveryReceiptRequested = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $transport Only return Commands with this transport value
     */
    public function __construct($sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, $status = \ShopMagicTwilioVendor\Twilio\Values::NONE, $direction = \ShopMagicTwilioVendor\Twilio\Values::NONE, $transport = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateCommandOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                                       from the recipient
     */
    public function __construct($sim = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackMethod = \ShopMagicTwilioVendor\Twilio\Values::NONE, $callbackUrl = \ShopMagicTwilioVendor\Twilio\Values::NONE, $commandMode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $includeSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $deliveryReceiptRequested = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['sim'] = $sim;
