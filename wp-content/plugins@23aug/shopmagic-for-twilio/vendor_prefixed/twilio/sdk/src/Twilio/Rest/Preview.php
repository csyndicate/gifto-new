...
use ShopMagicTwilioVendor\Twilio\Rest\Preview\BulkExports as PreviewBulkExports;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\DeployedDevices as PreviewDeployedDevices;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\HostedNumbers as PreviewHostedNumbers;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\Marketplace as PreviewMarketplace;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\Sync as PreviewSync;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms as PreviewTrustedComms;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\Understand as PreviewUnderstand;
use ShopMagicTwilioVendor\Twilio\Rest\Preview\Wireless as PreviewWireless;
/**
 ...
 */
class Preview extends \ShopMagicTwilioVendor\Twilio\Domain
{
    ...
    protected function getBulkExports()
    {
        if (!$this->_bulkExports) {
            $this->_bulkExports = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\BulkExports($this);
        }
    ...
    protected function getTrustedComms()
    {
        if (!$this->_trustedComms) {
            $this->_trustedComms = new \ShopMagicTwilioVendor\Twilio\Rest\Preview\TrustedComms($this);
        }
