...
class TaskChannelList extends \ShopMagicTwilioVendor\Twilio\ListResource
{
    ...
    public function create($friendlyName, $uniqueName, $options = array())
    {
        ...
        $data = \ShopMagicTwilioVendor\Twilio\Values::of(array('FriendlyName' => $friendlyName, 'UniqueName' => $uniqueName, 'ChannelOptimizedRouting' => \ShopMagicTwilioVendor\Twilio\Serialize::booleanToString($options['channelOptimizedRouting'])));
