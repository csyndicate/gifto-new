...
abstract class ParticipantOptions
{
     ...
     */
    public static function create($identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, $userAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $twilioAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\CreateParticipantOptions($identity, $userAddress, $attributes, $twilioAddress, $dateCreated, $dateUpdated);
    }
    /**
     * @param string $attributes A JSON string that stores application-specific data
     * @param \DateTime $dateCreated The ISO 8601 date and time in GMT when the
     ...
     */
    public static function update($attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Messaging\V1\Session\UpdateParticipantOptions($attributes, $dateCreated, $dateUpdated);
    }
}
class CreateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                               resource was updated
     */
    public function __construct($identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, $userAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $twilioAddress = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateParticipantOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                               resource was updated
     */
    public function __construct($attributes = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateCreated = \ShopMagicTwilioVendor\Twilio\Values::NONE, $dateUpdated = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        $this->options['attributes'] = $attributes;
        $this->options['dateCreated'] = $dateCreated;
        $this->options['dateUpdated'] = $dateUpdated;
