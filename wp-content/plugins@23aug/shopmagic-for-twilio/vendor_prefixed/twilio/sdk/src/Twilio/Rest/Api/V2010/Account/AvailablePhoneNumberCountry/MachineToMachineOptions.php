...
abstract class MachineToMachineOptions
{
     ...
     */
    public static function read($areaCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contains = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mmsEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE, $excludeAllAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::NONE, $excludeLocalAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::NONE, $excludeForeignAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::NONE, $beta = \ShopMagicTwilioVendor\Twilio\Values::NONE, $nearNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, $nearLatLong = \ShopMagicTwilioVendor\Twilio\Values::NONE, $distance = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inPostalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inRateCenter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inLata = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inLocality = \ShopMagicTwilioVendor\Twilio\Values::NONE, $faxEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadMachineToMachineOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param bool $faxEnabled Whether the phone numbers can receive faxes
     */
    public function __construct($areaCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $contains = \ShopMagicTwilioVendor\Twilio\Values::NONE, $smsEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE, $mmsEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE, $voiceEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE, $excludeAllAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::NONE, $excludeLocalAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::NONE, $excludeForeignAddressRequired = \ShopMagicTwilioVendor\Twilio\Values::NONE, $beta = \ShopMagicTwilioVendor\Twilio\Values::NONE, $nearNumber = \ShopMagicTwilioVendor\Twilio\Values::NONE, $nearLatLong = \ShopMagicTwilioVendor\Twilio\Values::NONE, $distance = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inPostalCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inRegion = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inRateCenter = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inLata = \ShopMagicTwilioVendor\Twilio\Values::NONE, $inLocality = \ShopMagicTwilioVendor\Twilio\Values::NONE, $faxEnabled = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
