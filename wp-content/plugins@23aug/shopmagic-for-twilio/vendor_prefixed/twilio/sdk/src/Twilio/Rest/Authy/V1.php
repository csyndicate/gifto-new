 ...
 * /       /
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Authy;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\FormList;
use ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\ServiceList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    {
        if (!$this->_forms) {
            $this->_forms = new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\FormList($this);
        }
        return $this->_forms;
    }
    /**
    ...
    {
        if (!$this->_services) {
            $this->_services = new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\ServiceList($this);
        }
