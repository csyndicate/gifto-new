 ...
 * /       /
 */
namespace ShopMagicTwilioVendor\Twilio\Rest\Monitor;

use ShopMagicTwilioVendor\Twilio\Domain;
use ShopMagicTwilioVendor\Twilio\Exceptions\TwilioException;
use ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\AlertList;
use ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\EventList;
...
class V1 extends \ShopMagicTwilioVendor\Twilio\Version
{
    ...
    {
        if (!$this->_alerts) {
            $this->_alerts = new \ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\AlertList($this);
        }
        return $this->_alerts;
    }
    /**
    ...
    {
        if (!$this->_events) {
            $this->_events = new \ShopMagicTwilioVendor\Twilio\Rest\Monitor\V1\EventList($this);
        }
        return $this->_events;
    }
    /**
