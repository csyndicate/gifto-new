...
class Client
{
     ...
     */
    public function __construct($username = null, $password = null, $accountSid = null, $region = null, \ShopMagicTwilioVendor\Twilio\Http\Client $httpClient = null, $environment = null)
    {
    ...
    public function request($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null)
    {
        ...
        $headers['User-Agent'] = 'twilio-php/' . \ShopMagicTwilioVendor\Twilio\VersionInfo::string() . ' (PHP ' . \phpversion() . ')';
        ...
        return $this->getHttpClient()->request($method, $uri, $params, $data, $headers, $username, $password, $timeout);
    }
    /**
     ...
     */
    public function setHttpClient(\ShopMagicTwilioVendor\Twilio\Http\Client $httpClient)
    {
        $this->httpClient = $httpClient;
    }
    /**
    ...
    {
        if (!$this->_authy) {
            $this->_authy = new \ShopMagicTwilioVendor\Twilio\Rest\Authy($this);
        }
        return $this->_authy;
    }
    /**
    ...
    {
        if (!$this->_fax) {
            $this->_fax = new \ShopMagicTwilioVendor\Twilio\Rest\Fax($this);
        }
        return $this->_fax;
    }
    /**
