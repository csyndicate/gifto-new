...
abstract class BindingOptions
{
     ...
     */
    public static function create($tag = \ShopMagicTwilioVendor\Twilio\Values::NONE, $notificationProtocolVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE, $credentialSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $endpoint = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
     ...
     */
    public static function read($startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, $tag = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class CreateBindingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $endpoint Deprecated
     */
    public function __construct($tag = \ShopMagicTwilioVendor\Twilio\Values::NONE, $notificationProtocolVersion = \ShopMagicTwilioVendor\Twilio\Values::NONE, $credentialSid = \ShopMagicTwilioVendor\Twilio\Values::NONE, $endpoint = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class ReadBindingOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $tag Only list Bindings that have all of the specified Tags
     */
    public function __construct($startDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $endDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $identity = \ShopMagicTwilioVendor\Twilio\Values::NONE, $tag = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
