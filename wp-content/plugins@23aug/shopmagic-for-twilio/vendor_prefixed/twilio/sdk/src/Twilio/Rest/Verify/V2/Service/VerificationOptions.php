...
abstract class VerificationOptions
{
     ...
     */
    public static function create($customMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, $locale = \ShopMagicTwilioVendor\Twilio\Values::NONE, $customCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE, $rateLimits = \ShopMagicTwilioVendor\Twilio\Values::NONE, $channelConfiguration = \ShopMagicTwilioVendor\Twilio\Values::NONE, $appHash = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Verify\V2\Service\CreateVerificationOptions($customMessage, $sendDigits, $locale, $customCode, $amount, $payee, $rateLimits, $channelConfiguration, $appHash);
    }
}
class CreateVerificationOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $appHash App Hash to be included at the end of an SMS.
     */
    public function __construct($customMessage = \ShopMagicTwilioVendor\Twilio\Values::NONE, $sendDigits = \ShopMagicTwilioVendor\Twilio\Values::NONE, $locale = \ShopMagicTwilioVendor\Twilio\Values::NONE, $customCode = \ShopMagicTwilioVendor\Twilio\Values::NONE, $amount = \ShopMagicTwilioVendor\Twilio\Values::NONE, $payee = \ShopMagicTwilioVendor\Twilio\Values::NONE, $rateLimits = \ShopMagicTwilioVendor\Twilio\Values::NONE, $channelConfiguration = \ShopMagicTwilioVendor\Twilio\Values::NONE, $appHash = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
