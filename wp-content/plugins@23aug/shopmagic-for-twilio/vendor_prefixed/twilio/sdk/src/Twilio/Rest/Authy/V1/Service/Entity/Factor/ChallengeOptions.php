...
abstract class ChallengeOptions
{
     ...
     */
    public static function create($expirationDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $details = \ShopMagicTwilioVendor\Twilio\Values::NONE, $hiddenDetails = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\Entity\Factor\CreateChallengeOptions($expirationDate, $details, $hiddenDetails);
    }
    /**
     * @param string $authPayload Optional payload to verify the Challenge
     * @return UpdateChallengeOptions Options builder
     */
    public static function update($authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
        return new \ShopMagicTwilioVendor\Twilio\Rest\Authy\V1\Service\Entity\Factor\UpdateChallengeOptions($authPayload);
    }
}
class CreateChallengeOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     *                              Challenge
     */
    public function __construct($expirationDate = \ShopMagicTwilioVendor\Twilio\Values::NONE, $details = \ShopMagicTwilioVendor\Twilio\Values::NONE, $hiddenDetails = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
...
class UpdateChallengeOptions extends \ShopMagicTwilioVendor\Twilio\Options
{
     ...
     * @param string $authPayload Optional payload to verify the Challenge
     */
    public function __construct($authPayload = \ShopMagicTwilioVendor\Twilio\Values::NONE)
    {
