...
class AjaxHandler implements \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            \update_option(\ShopMagicTwilioVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName, \ShopMagicTwilioVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
