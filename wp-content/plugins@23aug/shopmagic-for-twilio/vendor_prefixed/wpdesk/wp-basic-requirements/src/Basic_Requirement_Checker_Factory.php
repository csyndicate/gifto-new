...
class WPDesk_Basic_Requirement_Checker_Factory
{
    ...
    {
        $requirements_checker = new \ShopMagicTwilioVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp']);
