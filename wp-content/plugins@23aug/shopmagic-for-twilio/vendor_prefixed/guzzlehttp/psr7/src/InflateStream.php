...
final class InflateStream implements \Psr\Http\Message\StreamInterface
{
    ...
    {
        $resource = \ShopMagicTwilioVendor\GuzzleHttp\Psr7\StreamWrapper::getResource($stream);
        ...
        $this->stream = $stream->isSeekable() ? new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\Stream($resource) : new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\NoSeekStream(new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\Stream($resource));
    }
}
