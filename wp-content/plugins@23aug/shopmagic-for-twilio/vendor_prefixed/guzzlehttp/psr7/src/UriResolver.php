...
final class UriResolver
{
    ...
    public static function resolve(\Psr\Http\Message\UriInterface $base, \Psr\Http\Message\UriInterface $rel) : \Psr\Http\Message\UriInterface
    {
        ...
        return new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\Uri(\ShopMagicTwilioVendor\GuzzleHttp\Psr7\Uri::composeComponents($base->getScheme(), $targetAuthority, $targetPath, $targetQuery, $rel->getFragment()));
    }
    /**
    ...
    public static function relativize(\Psr\Http\Message\UriInterface $base, \Psr\Http\Message\UriInterface $target) : \Psr\Http\Message\UriInterface
    {
        ...
        if (\ShopMagicTwilioVendor\GuzzleHttp\Psr7\Uri::isRelativePathReference($target)) {
    ...
    private static function getRelativePath(\Psr\Http\Message\UriInterface $base, \Psr\Http\Message\UriInterface $target) : string
    {
