 ...
 */
class ServerRequest extends \ShopMagicTwilioVendor\GuzzleHttp\Psr7\Request implements \Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var array
     */
    ...
    private static function createUploadedFileFromSpec(array $value)
    {
        ...
        return new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\UploadedFile($value['tmp_name'], (int) $value['size'], (int) $value['error'], $value['name'], $value['type']);
    }
    /**
    ...
    public static function fromGlobals() : \Psr\Http\Message\ServerRequestInterface
    {
        ...
        $body = new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\CachingStream(new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\LazyOpenStream('php://input', 'r+'));
        $protocol = isset($_SERVER['SERVER_PROTOCOL']) ? \str_replace('HTTP/', '', $_SERVER['SERVER_PROTOCOL']) : '1.1';
        $serverRequest = new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\ServerRequest($method, $uri, $headers, $body, $protocol, $_SERVER);
    ...
    {
        $uri = new \ShopMagicTwilioVendor\GuzzleHttp\Psr7\Uri('');
