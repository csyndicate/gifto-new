...
For WooCommerce plugin Products Filter Professional – flexible, easy and robust professional filter for products in the WooCommerce store

== Description ==

**HUSKY - Products Filter Professional for WooCommerce** (former name is WOOF) is product search plugin for WooCommerce that allows your site customers filter products by categories, attributes, products tags, products custom taxonomies and price.
...
Demo site 2: [Smart Designer](https://demo-sd.products-filter.com/)
Demo site 3: [demo10k.products-filter.com](https://demo10k.products-filter.com/)
Demo site 4: [turbo.products-filter.com](https://turbo.products-filter.com/)
...
&#9989;&nbsp;PHP 7.2.x - 8.x full compatibility
