...
if ( ! class_exists( 'WPCleverWoosb' ) && class_exists( 'WC_Product' ) ) {
	class WPCleverWoosb {
		...
		function action_links( $links, $file ) {
			...
			if ( ! isset( $plugin ) ) {
				$plugin = plugin_basename( WOOSB_DIR . '/' . basename( WOOSB_FILE ) );
			}
                        ...
                        <div class="<?php echo esc_attr( apply_filters( 'woosb_item_class', $item_class, $_product, $product, $order ) ); ?>"
                            ...
                            <div class="woosb-title">
								...
								if ( $_product->is_type( 'variable' ) ) {
									if ( ( get_option( '_woosb_variations_selector', 'default' ) === 'wpc_radio' || get_option( '_woosb_variations_selector', 'default' ) === 'woovr' ) && class_exists( 'WPClever_Woovr' ) ) {
