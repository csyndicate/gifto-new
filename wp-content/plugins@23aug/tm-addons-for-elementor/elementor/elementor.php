...
class Elementor {
	...
	public function enqueue_editor_scripts() {
		wp_register_script( 'tm-addons-elementor-select2', TM_ADDONS_URL . 'assets/js/libs/select2.js', array( 'jquery' ), '4.1.0', true );

		wp_enqueue_script( 'tm-addons-elementor-editor', TM_ADDONS_URL . 'assets/js/elementor/editor.js',
			array(
				'jquery',
				'tm-addons-elementor-select2',
			), null, true
		);

		wp_enqueue_script( 'tm-addons-elementor-modules', TM_ADDONS_URL . 'assets/js/elementor/modules.js',
			array(
				'jquery',
			), null, true
		);

		wp_enqueue_script( 'tm-addons-elementor-template-library', TM_ADDONS_URL . 'assets/js/elementor/template-library.js',
			array(
				'jquery',
			), null, true
		);
