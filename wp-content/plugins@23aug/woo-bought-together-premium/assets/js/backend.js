...
(function($) {
  ...
  $(document).on('click touch', '#woobt_search_settings_update', function(e) {
    ...
    var data = {
      ...
      limit: $('input[name="_woobt_search_limit"]').val(),
      sku: $('select[name="_woobt_search_sku"]').val(),
      id: $('select[name="_woobt_search_id"]').val(),
      exact: $('select[name="_woobt_search_exact"]').val(),
      sentence: $('select[name="_woobt_search_sentence"]').val(),
      same: $('select[name="_woobt_search_same"]').val(),
      types: $('select[name="_woobt_search_types[]"]').val(),
    };
  ...
  $(document).on('change', 'select[name="_woobt_atc_button"]', function() {
    woobt_button();
  });
  ...
  function woobt_button() {
    if ($('select[name="_woobt_atc_button"]').val() == 'separate') {
      $('select[name="_woobt_show_this_item"]').
          val('yes').
          trigger('change').
          prop('disabled', 'disabled');
    } else {
      $('select[name="_woobt_show_this_item"]').prop('disabled', false);
    }
  }
