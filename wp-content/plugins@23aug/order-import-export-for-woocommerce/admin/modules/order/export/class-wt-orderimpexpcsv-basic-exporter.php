...
class Wt_Import_Export_For_Woo_Basic_Order_Bulk_Export {
    ...
    public static $is_wc_paypal_active ;
	...
	if (self::$wpo_wcpdf):
        ...
        if (self::$is_wc_paypal_active):
            $ppcp_paypal_fees = get_post_meta($order_data['order_id'], '_ppcp_paypal_fees', true);
