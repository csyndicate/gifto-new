...
var SIWCAdmin;!function(e){!function(e){var n=function(){function e(){}return e.updateImage=function(n,t){return jQuery.post(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.update_image_action,id:n,tags:JSON.stringify(t),nonce:mabel_script_vars.sinonce}).then(function(e){return e})},e.addImage=function(n,t,i){return jQuery.post(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.add_image_action,tags:JSON.stringify(i),image:n,thumb:t,nonce:mabel_script_vars.sinonce}).then(function(e){return e})},e.deleteImage=function(n){return jQuery.get(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.delete_image_action,imageId:n,nonce:mabel_script_vars.sinonce}).then(function(e){return e})},e.getImages=function(n){return jQuery.get(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_images_action,page:n,nonce:mabel_script_vars.sinonce}).then(function(e){return e})},e.getImage=function(n){return jQuery.get(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_image_action,id:n,nonce:mabel_script_vars.sinonce}).then(function(e){return e})},e.get_image_action="mb-siwc-get-image",e.get_images_action="mb-siwc-get-images",e.delete_image_action="mb-siwc-delete-image",e.add_image_action="mb-siwc-add-image",e.update_image_action="mb-siwc-update-image",e}();e.Images=n}(e.Api||(e.Api={}))}(SIWCAdmin||(SIWCAdmin={}));
