	...
	private static function get_export_boxes_config( $kb_config ) {
		...
		return [
			...
			[
				'plugin'       => 'epie',
				'icon'         => 'epkbfa epkbfa-upload',
				'title'        => esc_html__( 'Articles Import and Export - Export as CSV', 'echo-knowledge-base' ),
			...
			[
				'plugin'       => 'epie',
				'icon'         => 'epkbfa epkbfa-upload',
				'title'        => esc_html__( 'Articles Import and Export - Export as XML', 'echo-knowledge-base' ),
				'title_class'  => 'epkb-kbnh__feature-name--pro',
		...
		foreach ( self::get_import_boxes_config() as $box ) {
			...
			if ( $box['plugin'] == 'epie' ) {
				if ( EPKB_Utilities::is_export_import_enabled() ) {
					...
					$box['upgrade_link'] = EPKB_Core_Utilities::get_plugin_sales_page( $box['plugin'] );
					$box['corner_label'] = esc_html__( 'Up To 3 Sites', 'echo-knowledge-base' );
				}
			} else {
				$box['active_status'] = true;
			}
	...
	private static function get_import_boxes_config() {
		...
		return [
			...
			[
				'plugin'       => 'epie',
				'icon'         => 'epkbfa epkbfa-download',
				'title'        => esc_html__( 'Articles Import and Export - Import as CSV', 'echo-knowledge-base' ),
				'title_class'  => 'epkb-kbnh__feature-name--pro',
			...
			[
				'plugin'       => 'epie',
				'icon'         => 'epkbfa epkbfa-download',
				'title'        => esc_html__( 'Articles Import and Export - Import as XML', 'echo-knowledge-base' ),
				'title_class'  => 'epkb-kbnh__feature-name--pro',
	...
	private static function get_other_boxes( $kb_config ) {
		...
		$boxes_config[] = array(
			...
			'html'  => EPKB_HTML_Elements::checkbox_toggle( [
				...
				'textLoc'       => 'left',
				'checked'       => EPKB_Core_Utilities::is_kb_flag( 'preload_fonts' ),
