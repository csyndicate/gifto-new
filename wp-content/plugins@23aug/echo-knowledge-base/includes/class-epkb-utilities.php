...
class EPKB_Utilities {
	...
	public static function ajax_verify_nonce_and_capability_or_error_die( $capability = false ) {
		...
		if ( $capability === false || current_user_can( 'manage_options' ) ) {
			return;
		}

		// ensure user has correct permission
		if ( ! current_user_can( $capability ) ) {
			EPKB_Utilities::ajax_show_error_die( __( 'You do not have permission to edit this knowledge base', 'echo-knowledge-base' ) . ' (E02)' );
		}
	}
