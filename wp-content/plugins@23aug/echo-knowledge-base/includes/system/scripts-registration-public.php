	...
	// CASE: KB Main Page
		...
		if ( isset( $_GET[$search_query_param] ) ) {
			...
			switch ( $kb_config['kb_main_page_layout'] ) {
				...
				case 'Grid': $current_css_file_slug = 'mp-frontend-grid-layout'; break;
				case 'Sidebar': $current_css_file_slug = 'mp-frontend-sidebar-layout'; break;
				case 'Basic':
...
function epkb_frontend_kb_theme_styles_now( $kb_config, $css_file_slug ) {
	...
	$is_kb_main_page = in_array( $css_file_slug, [ 'mp-frontend-basic-layout', 'mp-frontend-tab-layout', 'mp-frontend-category-layout', 'mp-frontend-grid-layout', 'mp-frontend-sidebar-layout' ] );
