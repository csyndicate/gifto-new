...
class EPKB_Templates {
	...
	public function __construct() {
		...
		if ( EPKB_Utilities::is_block_theme() ) {
			...
			// FUTURE TODO: check this after each wp core update, bug exists in Appearance > Themes > Customize when KB is homepage
	...
	public static function block_template_loader( $query_result, $query, $template_type ) {
		...
		$outside_kb_slugs = [ 'single', 'page', '404', 'index', 'archive' ];
