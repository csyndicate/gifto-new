...
class EPKB_KB_Handler {
	...
	private static function find_current_kb_id() {
		...
		// try to find KB ID from Cookies
		$eckb_cookie_kb_id = empty( $_COOKIE['eckb_kb_id'] ) ? '' : $_COOKIE['eckb_kb_id'];
		if ( ! empty( $eckb_cookie_kb_id ) && EPKB_Utilities::is_positive_int( $eckb_cookie_kb_id ) ) {
