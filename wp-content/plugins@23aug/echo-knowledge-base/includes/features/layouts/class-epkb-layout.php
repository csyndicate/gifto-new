...
abstract class EPKB_Layout {
	 ...
	 */
	public function single_article_link( $title , $article_id, $link_other='', $prefix='', $seq_no='', $is_sidebar = false ) {
		...
		// only for sidebar block, ignore other layouts
		$style3 = $is_sidebar ?  $this->get_inline_style( 'typography:: sidebar_section_body_typography' ) : '';
		...
		<a href="<?php echo esc_url( $link ); ?>" <?php echo $link_other; ?>>
			<span <?php echo $class1 . ' ' . $style1; ?> >
				<span class="eckb-article-title__icon ep_font_icon_document" <?php echo $style2; ?> aria-hidden="true"></span>
				<span class="eckb-article-title__text" <?php echo $style3; ?>><?php echo esc_html( $title ); ?></span>
			</span>
		</a> <?php
	}
