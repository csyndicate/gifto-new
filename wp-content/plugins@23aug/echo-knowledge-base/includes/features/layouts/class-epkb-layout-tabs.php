...
class EPKB_Layout_Tabs extends EPKB_Layout {
	...
	public function generate_kb_main_page() {
		...
		<div id="epkb-main-page-container" role="main" aria-labelledby="Knowledge Base" class="<?php echo esc_attr( $main_container_class ); ?> <?php echo method_exists( 'EPKB_Utilities', 'get_active_theme_classes' ) ? EPKB_Utilities::get_active_theme_classes( 'mp' ) : ''; ?>">
