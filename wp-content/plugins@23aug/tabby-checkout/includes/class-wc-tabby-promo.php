...
";
    ...
    if (static::is_tabby_promo_enabled()) {
?>
   <div id="tabbyPromo" style="margin-bottom: 20px" data-tabby-price="<?php echo esc_attr(static::getPrice()); ?>" data-tabby-currency="<?php echo esc_attr(static::getCurrency()); ?>"></div>
<?php
    }
}
    ...
    public static function isCreditCardInstallmentsActiveByPrice() {
        $type_price = get_option('tabby_checkout_promo_type_price', -1);
