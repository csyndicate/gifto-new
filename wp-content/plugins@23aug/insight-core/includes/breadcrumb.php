...
class InsightCore_Breadcrumb {
				...
				foreach ( $post_type_taxonomies as $tax_slug => $taxonomy ) {
					...
					if ( ! empty( $post_terms ) && ! is_wp_error( $post_terms ) ) {
						...
						$breadcrumb_arr[] = array(
							...
							'link'  => get_term_link( $post_term, $tax_slug ),
						);
						break;
					}
				}
	 ...
	 * @param $post_term
	 * @param $post_terms
	 * @param $primary_post_term_id Primary term selected by Rank Math plugin.
	 *
	 * @return mixed
	 */
