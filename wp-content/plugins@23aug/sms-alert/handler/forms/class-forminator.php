...
class SA_Forminator extends FormInterface
{
    ...
    {
        add_filter('forminator_custom_form_submit_field_data', array( $this, 'forminator_form_response_message' ), 10, 2);
        add_action('forminator_after_form_render', array( $this, 'add_smsalert_shortcode' ), 10, 5);
    }
     ...
     * @return void     
     * */     
    public function add_smsalert_shortcode($id, $form_type, $post_id, $form_fields, $form_settings)
    {
        ...
        if ('on' === $form_enable && 'on' === $otp_enable && '' !== $phone_field ) {
            ...
            echo do_shortcode('[sa_verify phone_selector="' . esc_attr($phone_field) . '" submit_selector= ".'.$unique_class.' .forminator-button-submit" ]');
        }        
    }     
     ...
     * @return void
     */
    public function forminator_form_response_message($datas,$form_id)
    {
        ...
        if ('on' === $form_enable && 'on' === $buyer_sms_notify) {
            ...
            do_action('sa_send_sms', $mobile, self::parse_sms_content($buyer_sms_content, $datas));
        }
     ...
     * @return array
     */
    public static function get_forminator_variables(  $id = null )
    {
    ...
    {
        $wpam_statuses = self::get_forminator_forms();
