...
class JetForm extends FormInterface
{
    ...
    public function handleForm()
    {
        add_action(
            ...
            array( $this, 'jetform_submission_complete' ), 10, 2
        );        
    }
     ...
     * @return void
     */
    public function jetform_submission_complete($form_data, $entry_id )
    {
        global $form_id;          
        ...
        if ('on' === $form_enable && 'on' === $buyer_sms_notify ) {
            ...
            $msg = self::parse_sms_content($buyer_sms_content, $form_data);
     ...
     * @return array
     */
    public static function get_jetform_variables( $form_id = null )
    {
        $variables = array();        
    ...
    {
        $wpam_statuses = self::get_jetform_forms();
