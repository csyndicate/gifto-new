=== WP SMS: Texting - SMS Notification for WordPress, WooCommerce addon & Twilio Integration   ===
Contributors: mohsinoffline, spartac
Donate link: https://wpsms.io/
Tags: twilio, sms, text message, WordPress SMS, Text Message, Send SMS,SMS plugin,SMS,WP Twilio,SMS notification,SMS Plugin Wordpress,Woocommerce SMS,SMS Reminder
...
WPSMS: A Powerfull SMS Plugin for WordPress.
WPSMS helps to integrate SMS capability to your WordPress website using the most advanced Twilio API. 
