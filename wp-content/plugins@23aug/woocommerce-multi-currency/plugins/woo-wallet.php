...
class WOOMULTI_CURRENCY_Plugin_Woo_Wallet {
	...
	public function __construct() {
		...
		if ( $this->settings->get_enable() && is_plugin_active( 'woo-wallet/woo-wallet.php' ) ) {
...
//			add_filter( 'wmc_ignore_auto_select_currency', array(
//				$this,
//				'ignore_auto_select_currency'
//			) );
		}
	}
